...
Hexadecimal [16-Bits]
   ...
   083B                       5         .ds MAX_ENTITIES * sizeof_e
                             ...
                             50 ;;      HL, A, IX
                             51 ;;
   0971                      52 man_entity_destroy::
   0971 D5            [11]   53 	push de
                             54 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             55 ;;	DESTROY POINTER VECTOR COMPONENTS - OPTIMIZE
                             56 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;	
   0972 DD 7E 02      [19]   57 	ld a, e_cmps(ix)
   0975 E6 10         [ 7]   58 	and #e_cmp_ai
   0977 28 05         [12]   59 	jr z, _noAID
                             60 
   0979                      61 	_AId:
   0979 3E 02         [ 7]   62 	ld a, #e_cmpID_AI
   097B CD B3 06      [17]   63 	call man_components_removePtr
                             64 
   097E                      65 	_noAID:
   097E DD 7E 02      [19]   66 	ld a, e_cmps(ix)
   0981 E6 80         [ 7]   67 	and #e_cmp_collisionable
   0983 28 05         [12]   68 	jr z, _noCollisionableD
                             69 
   0985                      70 	_Collisionabled:
   0985 3E 04         [ 7]   71 	ld a, #e_cmpID_Collisionable
   0987 CD B3 06      [17]   72 	call man_components_removePtr
                             73 
   098A                      74 	_noCollisionableD:
                             75 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             76 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             77 
   098A D1            [10]   78 	pop de
                             79 
...
Hexadecimal [16-Bits]
   ...
   098B 2A 39 08      [16]   80 	ld hl, (_entity_free_list)					;;	\	The free list will now start at the end pointer of
   098E DD 22 39 08   [20]   81 	ld (_entity_free_list), ix					;;	|	the deleted entity and contain a pointers to its old
   0992 DD 75 00      [19]   82 	ld e_ptr(ix), l				    			;;	|	position.
   0995 DD 74 01      [19]   83 	ld e_ptr+1(ix), h							;;	/
                             84 
   0998 21 36 08      [10]   85 	ld hl, #_entity_num
   099B 35            [11]   86 	dec (hl)
                             87 
   099C 7B            [ 4]   88 	ld a, e										;;	\	If DE points to null, it means it is the las entity
   099D B2            [ 4]   89 	or d										;;	|	and _entity_list will point to the next entity
   099E 28 06         [12]   90 	jr z, #__is_the_last_entity					;;	/	in the list.
                             91 
   09A0                      92 __it_is_not_the_last_entity:					;;	\	If it is not the las entity, the entity
   09A0 6B            [ 4]   93 	ld l, e										;;	|	that linked it will point to the pointer that
   09A1 62            [ 4]   94 	ld h, d										;;	|	it contained.
   09A2 71            [ 7]   95 	ld (hl), c									;;	|
   09A3 23            [ 6]   96 	inc hl										;;	|
   09A4 70            [ 7]   97 	ld (hl), b									;;	/
                             98 
   09A5 C9            [10]   99 	ret
                            100 
   09A6                     101 __is_the_last_entity:
   09A6 ED 43 37 08   [20]  102 	ld (_entity_list), bc
                            103 
   09AA C9            [10]  104 	ret
                            105 
                            106 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            112 ;;       HL, BC, DE
                            113 ;;	   
   09AB                     114 man_entity_new::
   09AB 21 36 08      [10]  115 	ld hl, #_entity_num
   09AE 34            [11]  116 	inc (hl)
                            117 
   09AF 2A 39 08      [16]  118 	ld hl, (_entity_free_list)	;; HL = Pointer to free space.
                            119 
   09B2 E5            [11]  120 	push hl
                            121 
   09B3 5E            [ 7]  122 	ld e, (hl)							;;	\	Extract from HL the pointer to the next
   09B4 23            [ 6]  123 	inc hl								;;	|	free element.
   09B5 56            [ 7]  124 	ld d, (hl)							;;  |	Free space will now start on that element.
   09B6 ED 53 39 08   [20]  125 	ld (_entity_free_list), de			;;	/
                            126 
   09BA 2A 37 08      [16]  127 	ld hl, (_entity_list)				;;	HL = Pointer to the first item in the list.
                            128 
   09BD 4D            [ 4]  129 	ld c, l								;;	BC = HL
   09BE 44            [ 4]  130 	ld b, h
                            131 
   09BF E1            [10]  132 	pop hl
                            133 
   09C0 5D            [ 4]  134 	ld e, l								;;	\	Save the pointer where the new entity will be positioned in DE increasing two
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 111.
Hexadecimal [16-Bits]



   09C1 54            [ 4]  135 	ld d, h								;;	/	so as not to delete the pointer to the next entity.
                            136 
   09C2 22 37 08      [16]  137 	ld (_entity_list), hl				;;	\	Assign to _entity_list the pointer of the new position that will host an entity.
   09C5 71            [ 7]  138 	ld (hl), c							;;	|	If it's the first entity that is created, DE will contain a pointer to null, otherwise,
   09C6 23            [ 6]  139 	inc hl								;;	|	the pointer to the next entity.
   09C7 70            [ 7]  140 	ld (hl), b							;;	/
                            141 
   09C8 01 1D 00      [10]  142 	ld bc, #sizeof_e - 2
                            143 
   09CB C9            [10]  144 	ret
                            145 
                            146 ;;==============================================================================================================================
                            ...
                            157 ;;       A, HL, DE, BC
                            158 ;;
   09CC                     159 man_entity_init::
   09CC CD 6E 06      [17]  160 	call man_components_init
                            161 	
   09CF AF            [ 4]  162 	xor a
   09D0 32 36 08      [13]  163 	ld (_entity_num), a
                            164 
   09D3 21 00 00      [10]  165 	ld hl, #nullptr
   09D6 22 37 08      [16]  166 	ld (_entity_list), hl
                            167 
   09D9 21 3B 08      [10]  168 	ld hl, #_entity_array
   09DC 22 39 08      [16]  169 	ld (_entity_free_list), hl		;;	List of free entities.
                            170 	
   09DF E5            [11]  171 	push hl
                            172 
   09E0 36 00         [10]  173 	ld 	(hl), #0							;;	\	Initialize the components of the list
   09E2 54            [ 4]  174 	ld 	d, h								;; 	|	elements to zero.
   09E3 5D            [ 4]  175 	ld	e, l								;; 	|
   09E4 13            [ 6]  176 	inc de									;; 	|
   09E5 01 35 01      [10]  177 	ld bc, #MAX_ENTITIES * sizeof_e - 1		;; 	|
   09E8 ED B0         [21]  178 	ldir									;; 	/
                            179 
                            180 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            181 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
                            ...
                            196 ;;       A, HL, DE
                            197 ;;
   09EA                     198 man_entity_init_linked_list::
   09EA 3E 09         [ 7]  199 	ld a, #MAX_ENTITIES - 1		;;	\	The entity counter is only necessary until the penultimate, 
   09EC 32 FD 09      [13]  200 	ld (_ent_counter), a		;;	/	since the las one haas to have a null value.
                            201 
   09EF 01 1F 00      [10]  202 	ld bc, #sizeof_e
                            203 
   09F2 E1            [10]  204 	pop hl
                            205 
   09F3 5D            [ 4]  206 	ld e, l
   09F4 54            [ 4]  207 	ld d, h	
                            208 
   09F5                     209 __init_loop:
   09F5 09            [11]  210 	add hl, bc				;;	Save in HL the pointer to the next free space.
                            211 
   09F6 EB            [ 4]  212 	ex de, hl				;;	DE = HL, HL = DE
                            213 
   09F7 73            [ 7]  214 	ld (hl), e				;;	\	Copy the address to the next free space
   09F8 23            [ 6]  215 	inc hl					;;	|	in the first two bytes of the previous element
   09F9 72            [ 7]  216 	ld (hl), d				;;	/	the address to the next free space.
                            217 
   09FA 6B            [ 4]  218 	ld l, e					;; L = E
   09FB 62            [ 4]  219 	ld h, d					;; H = D
                            220 
                     01C7   221 	_ent_counter = . + 1
   09FC 3E 00         [ 7]  222 	ld a, #0
   09FE 3D            [ 4]  223 	dec a
   09FF C8            [11]  224 	ret z
                            225 
   0A00 32 FD 09      [13]  226 	ld (_ent_counter), a
                            227 
   0A03 18 F0         [12]  228 jr __init_loop
                            229 
                            230 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            236 ;;       A
                            237 ;;
   0A05                     238 man_entity_set4destruction::
   0A05 DD 7E 03      [19]  239 	ld a, e_type(ix)
   0A08 E6 01         [ 7]  240 	and #e_type_player
   0A0A 28 01         [12]  241 	jr z, _not_player
...
Hexadecimal [16-Bits]
   ...
   0A0C C9            [10]  245 	ret
   0A0D                     246 _not_player:
   0A0D 3E 20         [ 7]  247 	ld a, #e_type_dead
   0A0F DD 77 03      [19]  248 	ld e_type(ix), a
   0A12 C9            [10]  249 	ret
                            250 
                            251 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            256 ;;       DE, BC, A, IX
                            257 ;;	   
   0A13                     258 man_entity_update::
                            259 
   0A13 CD 7A 0A      [17]  260 	call man_entity_getEntityArrayIX
   0A16 11 00 00      [10]  261 	ld de, #nullptr						;; 	Initialize DE with a pointer to null to know if the entity to delete will be the first in the linked list.
                            262 
   0A19                     263 _loop:
                            264 
   0A19 DD 4E 00      [19]  265 	ld c, e_ptr(ix) 					;;	\	Save in BC the pointer to the next entity.
   0A1C DD 46 01      [19]  266     ld b, e_ptr+1(ix)					;;	/
                            267 	
   01E9                     268 	ld__a_ixl							;;	\	Ends when finding a null point, the end of the list.
   0A1F DD 7D                 1    .dw #0x7DDD  ;; Opcode for ld a, ixl
   01EB                     269 	or__ixh								;;	|
   0A21 DD B4                 1    .dw #0xB4DD  ;; Opcode for or ixh
   0A23 C8            [11]  270 	ret	z								;;	/
                            271 
   0A24 DD 7E 03      [19]  272 	ld a, e_type(ix)					;;	\ 	It is checked if the entity is marked to die.
   0A27 E6 20         [ 7]  273 	and #e_type_dead					;; 	|
   0A29 20 06         [12]  274 	jr nz, #__marked_for_death			;;	/
                            275 
   0A2B                     276 __unmarked:
   01F5                     277 	ld__e_ixl							;;	\	If the entity is not marked, its pointer is saved.
   0A2B DD 5D                 1    .dw #0x5DDD  ;; Opcode for ld e, ixl
   01F7                     278     ld__d_ixh							;;	|
   0A2D DD 54                 1    .dw #0x54DD  ;; Opcode for ld d, ixh
   0A2F 18 03         [12]  279 	jr #__check_next_entity				;;	/
                            280 
   0A31                     281 __marked_for_death:						;;	The destructor is called to delete the marked entity.
   0A31 CD 71 09      [17]  282 	call man_entity_destroy
                            283 
   0A34                     284 __check_next_entity:
                            285 
   01FE                     286     ld__ixl_c
   0A34 DD 69                 1    .dw #0x69DD  ;; Opcode for ld ixl, c
   0200                     287     ld__ixh_b
   0A36 DD 60                 1    .dw #0x60DD  ;; Opcode for ld ixh, b
                            288 
   0A38 18 DF         [12]  289 	jr _loop
                            290 
                            291 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
                            ...
                            299 ;;       DE, BC, A
                            300 ;;	   
   0A3A                     301 man_entity_create::
   0A3A E5            [11]  302 	push hl
   0A3B CD AB 09      [17]  303 	call man_entity_new
                            304 
   0208                     305 	ld__ixh_d
   0A3E DD 62                 1    .dw #0x62DD  ;; Opcode for ld ixh, d
   020A                     306 	ld__ixl_e
   0A40 DD 6B                 1    .dw #0x6BDD  ;; Opcode for ld ixl, e
                            307 
   0A42 E1            [10]  308 	pop hl
                            309 
                            310 	;;	HL and DE are incremented so as not to overwrite the list pointers
                            311 	;; 	to the next entity.
   0A43 23            [ 6]  312 	inc hl	
   0A44 23            [ 6]  313 	inc hl
   0A45 13            [ 6]  314 	inc de
   0A46 13            [ 6]  315 	inc de
   0A47 ED B0         [21]  316 	ldir
                            317 
                            318 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            319 ;;	ASSIGN ENTITY TO VECTOR OF POINTERS	- OPTIMIZE
                            320 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;	
   0A49 DD 7E 02      [19]  321 	ld a, e_cmps(ix)
   0A4C E6 02         [ 7]  322 	and a, #e_cmp_render
   0A4E 28 05         [12]  323 	jr z, _noRender
   0A50                     324 	_Render:
   0A50 3E 00         [ 7]  325 	ld a, #e_cmpID_Render
   0A52 CD A0 06      [17]  326 	call man_components_add
                            327 
   0A55                     328 	_noRender:
   0A55 DD 7E 02      [19]  329 	ld a, e_cmps(ix)
   0A58 E6 10         [ 7]  330 	and #e_cmp_ai
   0A5A 28 05         [12]  331 	jr z, _noAI
                            332 
   0A5C                     333 	_AI:
   0A5C 3E 02         [ 7]  334 	ld a, #e_cmpID_AI
   0A5E CD A0 06      [17]  335 	call man_components_add
                            336 
   0A61                     337 	_noAI:
   0A61 DD 7E 02      [19]  338 	ld a, e_cmps(ix)
   0A64 E6 80         [ 7]  339 	and #e_cmp_collisionable
   0A66 28 05         [12]  340 	jr z, _noCollisionable
                            341 
   0A68                     342 	_Collisionable:
   0A68 3E 04         [ 7]  343 	ld a, #e_cmpID_Collisionable
   0A6A CD A0 06      [17]  344 	call man_components_add
                            345 
   0A6D                     346 	_noCollisionable:
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 115.
Hexadecimal [16-Bits]



   0A6D DD 7E 02      [19]  347 	ld a, e_cmps(ix)
   0A70 E6 04         [ 7]  348 	and #e_cmp_physics
   0A72 28 05         [12]  349 	jr z, _noPhysics
                            350 
   0A74                     351 	_Physics:
   0A74 3E 01         [ 7]  352 	ld a, #e_cmpID_Physics
   0A76 CD A0 06      [17]  353 	call man_components_add
   0A79                     354 	_noPhysics:
                            355 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            356 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;	
   0A79 C9            [10]  357 	ret
                            358 
                            359 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            360 ;;  ENTITY_MANAGER::GetEntityArrayIX
                            361 ;;      Returns the pointer to the entity array and the number of entities
                            362 ;;  INPUT:
                            363 ;;  MODIFY:
                            364 ;;       IX, A
                            365 ;;	   
   0A7A                     366 man_entity_getEntityArrayIX::
   0A7A DD 2A 37 08   [20]  367 	ld ix, (_entity_list)
   0A7E 3A 36 08      [13]  368 	ld a, (_entity_num)
   0A81 C9            [10]  369 	ret
                            370 
                            371 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            372 ;;	ENTITY_MANAGER::GetPlayerPositionIY
                            373 ;;		Returns a pointer to the player for input system
                            374 ;;	INPUT:
                            375 ;;	MODIFY:
                            376 ;;		HL
                            377 ;;	   
   0A82                     378 man_entity_getPlayerPosition::
   0A82 DD 21 3B 08   [14]  379 	ld ix, #_entity_array
   0A86 C9            [10]  380 	ret
                            381 
                            382 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            383 ;;	ENTITY_MANAGER::deleteEverythingExceptPlayer
                            384 ;;		Remove all entities except the player'.
                            385 ;;	INPUT:
                            386 ;;	MODIFY:
                            387 ;;		A
                            388 ;;	   
   0A87                     389 man_entity_deleteEverythingExceptPlayer::
   0A87 CD 7A 0A      [17]  390 	call man_entity_getEntityArrayIX
                            391 
   0A8A                     392 	__loop:
                            393 	;;	If the pointer to the next element in the list is null the entity is the player
                            394 	;; 	and the loop is terminated.
   0A8A DD 7E 00      [19]  395 	ld a, e_ptr(ix)
   0A8D 4F            [ 4]  396 	ld c, a
   0A8E DD 46 01      [19]  397 	ld b, e_ptr+1(ix)
   0A91 B1            [ 4]  398 	or c
   0A92 C8            [11]  399 	ret z
                            400 
                            401 	;;	The entity is marked for deletion.
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 116.
Hexadecimal [16-Bits]



   0A93 CD 05 0A      [17]  402 	call man_entity_set4destruction
                            403 
   0260                     404 	ld__ixl_c
   0A96 DD 69                 1    .dw #0x69DD  ;; Opcode for ld ixl, c
   0262                     405 	ld__ixh_b
   0A98 DD 60                 1    .dw #0x60DD  ;; Opcode for ld ixh, b
   0A9A 18 EE         [12]  406 	jr __loop
