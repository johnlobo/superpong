...
Hexadecimal [24-Bits]
                                     ...
                                     32 
      000000                         33 DefineComponentArrayStructure_Size _entity, MAX_ENTITIES, sizeof_e
      000834 00                       1     _entity_num:         .db 0
      000835 00 00                    2     _entity_list:        .dw nullptr
      000837 39 08                    3     _entity_free_list:   .dw _entity_array
      000839                          4     _entity_array::
      000839                          5         .ds MAX_ENTITIES * sizeof_e
                                     34 
                                     35 ;;==============================================================================================================================
                                     36 ;;==============================================================================================================================
                                     ...
                                     50 ;;      HL, A, IX
                                     51 ;;
      000979                         52 man_entity_destroy::
      000979 D5               [11]   53 	push de
                                     54 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                     55 ;;	DESTROY POINTER VECTOR COMPONENTS - OPTIMIZE
                                     56 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;	
      00097A DD 7E 02         [19]   57 	ld a, e_cmps(ix)
      00097D E6 10            [ 7]   58 	and #e_cmp_ai
      00097F 28 05            [12]   59 	jr z, _noAID
                                     60 
      000981                         61 	_AId:
      000981 3E 02            [ 7]   62 	ld a, #e_cmpID_AI
      000983 CD 0F 08         [17]   63 	call man_components_removePtr
                                     64 
      000986                         65 	_noAID:
      000986 DD 7E 02         [19]   66 	ld a, e_cmps(ix)
      000989 E6 80            [ 7]   67 	and #e_cmp_collisionable
      00098B 28 05            [12]   68 	jr z, _noCollisionableD
                                     69 
      00098D                         70 	_Collisionabled:
      00098D 3E 04            [ 7]   71 	ld a, #e_cmpID_Collisionable
      00098F CD 0F 08         [17]   72 	call man_components_removePtr
                                     73 
      000992                         74 	_noCollisionableD:
                                     75 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                     76 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                     77 
      000992 D1               [10]   78 	pop de
                                     79 
...
Hexadecimal [24-Bits]
      ...
      000993 2A 37 08         [16]   80 	ld hl, (_entity_free_list)					;;	\	The free list will now start at the end pointer of
      000996 DD 22 37 08      [20]   81 	ld (_entity_free_list), ix					;;	|	the deleted entity and contain a pointers to its old
      00099A DD 75 00         [19]   82 	ld e_ptr(ix), l				    			;;	|	position.
      00099D DD 74 01         [19]   83 	ld e_ptr+1(ix), h							;;	/
                                     84 
      0009A0 21 34 08         [10]   85 	ld hl, #_entity_num
      0009A3 35               [11]   86 	dec (hl)
                                     87 
      0009A4 7B               [ 4]   88 	ld a, e										;;	\	If DE points to null, it means it is the las entity
      0009A5 B2               [ 4]   89 	or d										;;	|	and _entity_list will point to the next entity
      0009A6 28 06            [12]   90 	jr z, #__is_the_last_entity					;;	/	in the list.
                                     91 
      0009A8                         92 __it_is_not_the_last_entity:					;;	\	If it is not the las entity, the entity
      0009A8 6B               [ 4]   93 	ld l, e										;;	|	that linked it will point to the pointer that
      0009A9 62               [ 4]   94 	ld h, d										;;	|	it contained.
      0009AA 71               [ 7]   95 	ld (hl), c									;;	|
      0009AB 23               [ 6]   96 	inc hl										;;	|
      0009AC 70               [ 7]   97 	ld (hl), b									;;	/
                                     98 
      0009AD C9               [10]   99 	ret
                                    100 
      0009AE                        101 __is_the_last_entity:
      0009AE ED 43 35 08      [20]  102 	ld (_entity_list), bc
                                    103 
      0009B2 C9               [10]  104 	ret
                                    105 
                                    106 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    ...
                                    112 ;;       HL, BC, DE
                                    113 ;;	   
      0009B3                        114 man_entity_new::
      0009B3 21 34 08         [10]  115 	ld hl, #_entity_num
      0009B6 34               [11]  116 	inc (hl)
                                    117 
      0009B7 2A 37 08         [16]  118 	ld hl, (_entity_free_list)	;; HL = Pointer to free space.
                                    119 
      0009BA E5               [11]  120 	push hl
                                    121 
      0009BB 5E               [ 7]  122 	ld e, (hl)							;;	\	Extract from HL the pointer to the next
      0009BC 23               [ 6]  123 	inc hl								;;	|	free element.
      0009BD 56               [ 7]  124 	ld d, (hl)							;;  |	Free space will now start on that element.
      0009BE ED 53 37 08      [20]  125 	ld (_entity_free_list), de			;;	/
                                    126 
      0009C2 2A 35 08         [16]  127 	ld hl, (_entity_list)				;;	HL = Pointer to the first item in the list.
                                    128 
      0009C5 4D               [ 4]  129 	ld c, l								;;	BC = HL
      0009C6 44               [ 4]  130 	ld b, h
                                    131 
      0009C7 E1               [10]  132 	pop hl
                                    133 
      0009C8 5D               [ 4]  134 	ld e, l								;;	\	Save the pointer where the new entity will be positioned in DE increasing two
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 112.
Hexadecimal [24-Bits]



      0009C9 54               [ 4]  135 	ld d, h								;;	/	so as not to delete the pointer to the next entity.
                                    136 
      0009CA 22 35 08         [16]  137 	ld (_entity_list), hl				;;	\	Assign to _entity_list the pointer of the new position that will host an entity.
      0009CD 71               [ 7]  138 	ld (hl), c							;;	|	If it's the first entity that is created, DE will contain a pointer to null, otherwise,
      0009CE 23               [ 6]  139 	inc hl								;;	|	the pointer to the next entity.
      0009CF 70               [ 7]  140 	ld (hl), b							;;	/
                                    141 
      0009D0 01 1E 00         [10]  142 	ld bc, #sizeof_e - 2
                                    143 
      0009D3 C9               [10]  144 	ret
                                    145 
                                    146 ;;==============================================================================================================================
                                    147 ;;==============================================================================================================================
                                    ...
                                    157 ;;       A, HL, DE, BC
                                    158 ;;
      0009D4                        159 man_entity_init::
      0009D4 CD CA 07         [17]  160 	call man_components_init
                                    161 	
      0009D7 AF               [ 4]  162 	xor a
      0009D8 32 34 08         [13]  163 	ld (_entity_num), a
                                    164 
      0009DB 21 00 00         [10]  165 	ld hl, #nullptr
      0009DE 22 35 08         [16]  166 	ld (_entity_list), hl
                                    167 
      0009E1 21 39 08         [10]  168 	ld hl, #_entity_array
      0009E4 22 37 08         [16]  169 	ld (_entity_free_list), hl		;;	List of free entities.
                                    170 	
      0009E7 E5               [11]  171 	push hl
                                    172 
      0009E8 36 00            [10]  173 	ld 	(hl), #0							;;	\	Initialize the components of the list
      0009EA 54               [ 4]  174 	ld 	d, h								;; 	|	elements to zero.
      0009EB 5D               [ 4]  175 	ld	e, l								;; 	|
      0009EC 13               [ 6]  176 	inc de									;; 	|
      0009ED 01 3F 01         [10]  177 	ld bc, #MAX_ENTITIES * sizeof_e - 1		;; 	|
      0009F0 ED B0            [21]  178 	ldir									;; 	/
                                    179 
                                    180 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    181 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [24-Bits]
                                    ...
                                    196 ;;       A, HL, DE
                                    197 ;;
      0009F2                        198 man_entity_init_linked_list::
      0009F2 3E 09            [ 7]  199 	ld a, #MAX_ENTITIES - 1		;;	\	The entity counter is only necessary until the penultimate, 
      0009F4 32 05 0A         [13]  200 	ld (_ent_counter), a		;;	/	since the las one haas to have a null value.
                                    201 
      0009F7 01 20 00         [10]  202 	ld bc, #sizeof_e
                                    203 
      0009FA E1               [10]  204 	pop hl
                                    205 
      0009FB 5D               [ 4]  206 	ld e, l
      0009FC 54               [ 4]  207 	ld d, h	
                                    208 
      0009FD                        209 __init_loop:
      0009FD 09               [11]  210 	add hl, bc				;;	Save in HL the pointer to the next free space.
                                    211 
      0009FE EB               [ 4]  212 	ex de, hl				;;	DE = HL, HL = DE
                                    213 
      0009FF 73               [ 7]  214 	ld (hl), e				;;	\	Copy the address to the next free space
      000A00 23               [ 6]  215 	inc hl					;;	|	in the first two bytes of the previous element
      000A01 72               [ 7]  216 	ld (hl), d				;;	/	the address to the next free space.
                                    217 
      000A02 6B               [ 4]  218 	ld l, e					;; L = E
      000A03 62               [ 4]  219 	ld h, d					;; H = D
                                    220 
                           0001D1   221 	_ent_counter = . + 1
      000A04 3E 00            [ 7]  222 	ld a, #0
      000A06 3D               [ 4]  223 	dec a
      000A07 C8               [11]  224 	ret z
                                    225 
      000A08 32 05 0A         [13]  226 	ld (_ent_counter), a
                                    227 
      000A0B 18 F0            [12]  228 jr __init_loop
                                    229 
                                    230 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    ...
                                    236 ;;       A
                                    237 ;;
      000A0D                        238 man_entity_set4destruction::
      000A0D DD 7E 03         [19]  239 	ld a, e_type(ix)
      000A10 E6 01            [ 7]  240 	and #e_type_player
      000A12 28 01            [12]  241 	jr z, _not_player
...
Hexadecimal [24-Bits]
      ...
      000A14 C9               [10]  245 	ret
      000A15                        246 _not_player:
      000A15 3E 20            [ 7]  247 	ld a, #e_type_dead
      000A17 DD 77 03         [19]  248 	ld e_type(ix), a
      000A1A C9               [10]  249 	ret
                                    250 
                                    251 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    ...
                                    256 ;;       DE, BC, A, IX
                                    257 ;;	   
      000A1B                        258 man_entity_update::
                                    259 
      000A1B CD 82 0A         [17]  260 	call man_entity_getEntityArrayIX
      000A1E 11 00 00         [10]  261 	ld de, #nullptr						;; 	Initialize DE with a pointer to null to know if the entity to delete will be the first in the linked list.
                                    262 
      000A21                        263 _loop:
                                    264 
      000A21 DD 4E 00         [19]  265 	ld c, e_ptr(ix) 					;;	\	Save in BC the pointer to the next entity.
      000A24 DD 46 01         [19]  266     ld b, e_ptr+1(ix)					;;	/
                                    267 	
      0001F3                        268 	ld__a_ixl							;;	\	Ends when finding a null point, the end of the list.
      000A27 DD 7D                    1    .dw #0x7DDD  ;; Opcode for ld a, ixl
      0001F5                        269 	or__ixh								;;	|
      000A29 DD B4                    1    .dw #0xB4DD  ;; Opcode for or ixh
      000A2B C8               [11]  270 	ret	z								;;	/
                                    271 
      000A2C DD 7E 03         [19]  272 	ld a, e_type(ix)					;;	\ 	It is checked if the entity is marked to die.
      000A2F E6 20            [ 7]  273 	and #e_type_dead					;; 	|
      000A31 20 06            [12]  274 	jr nz, #__marked_for_death			;;	/
                                    275 
      000A33                        276 __unmarked:
      0001FF                        277 	ld__e_ixl							;;	\	If the entity is not marked, its pointer is saved.
      000A33 DD 5D                    1    .dw #0x5DDD  ;; Opcode for ld e, ixl
      000201                        278     ld__d_ixh							;;	|
      000A35 DD 54                    1    .dw #0x54DD  ;; Opcode for ld d, ixh
      000A37 18 03            [12]  279 	jr #__check_next_entity				;;	/
                                    280 
      000A39                        281 __marked_for_death:						;;	The destructor is called to delete the marked entity.
      000A39 CD 79 09         [17]  282 	call man_entity_destroy
                                    283 
      000A3C                        284 __check_next_entity:
                                    285 
      000208                        286     ld__ixl_c
      000A3C DD 69                    1    .dw #0x69DD  ;; Opcode for ld ixl, c
      00020A                        287     ld__ixh_b
      000A3E DD 60                    1    .dw #0x60DD  ;; Opcode for ld ixh, b
                                    288 
      000A40 18 DF            [12]  289 	jr _loop
                                    290 
                                    291 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [24-Bits]
                                    ...
                                    299 ;;       DE, BC, A
                                    300 ;;	   
      000A42                        301 man_entity_create::
      000A42 E5               [11]  302 	push hl
      000A43 CD B3 09         [17]  303 	call man_entity_new
                                    304 
      000212                        305 	ld__ixh_d
      000A46 DD 62                    1    .dw #0x62DD  ;; Opcode for ld ixh, d
      000214                        306 	ld__ixl_e
      000A48 DD 6B                    1    .dw #0x6BDD  ;; Opcode for ld ixl, e
                                    307 
      000A4A E1               [10]  308 	pop hl
                                    309 
                                    310 	;;	HL and DE are incremented so as not to overwrite the list pointers
                                    311 	;; 	to the next entity.
      000A4B 23               [ 6]  312 	inc hl	
      000A4C 23               [ 6]  313 	inc hl
      000A4D 13               [ 6]  314 	inc de
      000A4E 13               [ 6]  315 	inc de
      000A4F ED B0            [21]  316 	ldir
                                    317 
                                    318 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    319 ;;	ASSIGN ENTITY TO VECTOR OF POINTERS	- OPTIMIZE
                                    320 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;	
      000A51 DD 7E 02         [19]  321 	ld a, e_cmps(ix)
      000A54 E6 02            [ 7]  322 	and a, #e_cmp_render
      000A56 28 05            [12]  323 	jr z, _noRender
      000A58                        324 	_Render:
      000A58 3E 00            [ 7]  325 	ld a, #e_cmpID_Render
      000A5A CD FC 07         [17]  326 	call man_components_add
                                    327 
      000A5D                        328 	_noRender:
      000A5D DD 7E 02         [19]  329 	ld a, e_cmps(ix)
      000A60 E6 10            [ 7]  330 	and #e_cmp_ai
      000A62 28 05            [12]  331 	jr z, _noAI
                                    332 
      000A64                        333 	_AI:
      000A64 3E 02            [ 7]  334 	ld a, #e_cmpID_AI
      000A66 CD FC 07         [17]  335 	call man_components_add
                                    336 
      000A69                        337 	_noAI:
      000A69 DD 7E 02         [19]  338 	ld a, e_cmps(ix)
      000A6C E6 80            [ 7]  339 	and #e_cmp_collisionable
      000A6E 28 05            [12]  340 	jr z, _noCollisionable
                                    341 
      000A70                        342 	_Collisionable:
      000A70 3E 04            [ 7]  343 	ld a, #e_cmpID_Collisionable
      000A72 CD FC 07         [17]  344 	call man_components_add
                                    345 
      000A75                        346 	_noCollisionable:
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 116.
Hexadecimal [24-Bits]



      000A75 DD 7E 02         [19]  347 	ld a, e_cmps(ix)
      000A78 E6 04            [ 7]  348 	and #e_cmp_physics
      000A7A 28 05            [12]  349 	jr z, _noPhysics
                                    350 
      000A7C                        351 	_Physics:
      000A7C 3E 01            [ 7]  352 	ld a, #e_cmpID_Physics
      000A7E CD FC 07         [17]  353 	call man_components_add
      000A81                        354 	_noPhysics:
                                    355 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    356 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;	
      000A81 C9               [10]  357 	ret
                                    358 
                                    359 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    ...
                                    364 ;;       IX, A
                                    365 ;;	   
      000A82                        366 man_entity_getEntityArrayIX::
      000A82 DD 2A 35 08      [20]  367 	ld ix, (_entity_list)
      000A86 3A 34 08         [13]  368 	ld a, (_entity_num)
      000A89 C9               [10]  369 	ret
                                    370 
                                    371 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    ...
                                    376 ;;		HL
                                    377 ;;	   
      000A8A                        378 man_entity_getPlayerPosition::
      000A8A DD 21 39 08      [14]  379 	ld ix, #_entity_array
      000A8E C9               [10]  380 	ret
                                    381 
                                    382 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    383 ;;	ENTITY_MANAGER::GetPlayerPositionIY
                                    384 ;;		Returns a pointer to the player for input system
                                    385 ;;	INPUT:
                                    386 ;;	MODIFY:
                                    387 ;;		HL
                                    388 ;;	   
      000A8F                        389 man_entity_getOponentPosition::
      00025B                        390 	cpctm_push hl, bc
                           000002     1    .narg v
                           000001     2    .if v
      000A8F E5               [11]    3    push hl
                           000001     4    .if v-1
      000A90 C5               [11]    5    push bc
                           000000     6    .if v-2
                                      7    push 
                                      8    .if v-3
                                      9    push 
...
Hexadecimal [24-Bits]
                           ...
                           000001    23    .else
                                     24    .mexit
      000A91 21 39 08         [10]  391 	ld hl, #_entity_array
      000A94 01 20 00         [10]  392 	ld bc, #sizeof_e
      000A97 09               [11]  393 	add hl, bc
      000A98 E5               [11]  394 	push hl
      000A99 FD E1            [14]  395 	pop iy
      000267                        396 	cpctm_pop bc, hl
                           000002     1    .narg v
                           000001     2    .if v
      000A9B C1               [10]    3    pop bc
                           000001     4    .if v-1
      000A9C E1               [10]    5    pop hl
                           000000     6    .if v-2
                                      7    pop 
                                      8    .if v-3
                                      9    pop 
                           ...
                           000001    23    .else
                                     24    .mexit
      000A9D C9               [10]  397 	ret
                                    398 
                                    399 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    400 ;;	ENTITY_MANAGER::deleteEverythingExceptPlayer
                                    401 ;;		Remove all entities except the player'.
                                    402 ;;	INPUT:
                                    403 ;;	MODIFY:
                                    404 ;;		A
                                    405 ;;	   
      000A9E                        406 man_entity_deleteEverythingExceptPlayer::
      000A9E CD 82 0A         [17]  407 	call man_entity_getEntityArrayIX
                                    408 
...
Hexadecimal [24-Bits]
      ...
      000AA1                        409 	__loop:
                                    410 	;;	If the pointer to the next element in the list is null the entity is the player
                                    411 	;; 	and the loop is terminated.
      000AA1 DD 7E 00         [19]  412 	ld a, e_ptr(ix)
      000AA4 4F               [ 4]  413 	ld c, a
      000AA5 DD 46 01         [19]  414 	ld b, e_ptr+1(ix)
      000AA8 B1               [ 4]  415 	or c
      000AA9 C8               [11]  416 	ret z
                                    417 
                                    418 	;;	The entity is marked for deletion.
      000AAA CD 0D 0A         [17]  419 	call man_entity_set4destruction
                                    420 
      000279                        421 	ld__ixl_c
      000AAD DD 69                    1    .dw #0x69DD  ;; Opcode for ld ixl, c
      00027B                        422 	ld__ixh_b
      000AAF DD 60                    1    .dw #0x60DD  ;; Opcode for ld ixh, b
      000AB1 18 EE            [12]  423 	jr __loop
