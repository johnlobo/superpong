...
Hexadecimal [16-Bits]
   ...
   098F 3E 04         [ 7]   71 	ld a, #e_cmpID_Collisionable
...
Hexadecimal [16-Bits]
   ...
   0A4D 23            [ 6]  312 	inc hl	
   0A4E 23            [ 6]  313 	inc hl
   0A4F 13            [ 6]  314 	inc de
   0A50 13            [ 6]  315 	inc de
   0A51 ED B0         [21]  316 	ldir
                            317 
                            318 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            319 ;;	ASSIGN ENTITY TO VECTOR OF POINTERS	- OPTIMIZE
                            320 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;	
   0A53 DD 7E 02      [19]  321 	ld a, e_cmps(ix)
   0A56 E6 02         [ 7]  322 	and a, #e_cmp_render
   0A58 28 05         [12]  323 	jr z, _noRender
   0A5A                     324 	_Render:
   0A5A 3E 00         [ 7]  325 	ld a, #e_cmpID_Render
   0A5C CD A0 06      [17]  326 	call man_components_add
                            327 
   0A5F                     328 	_noRender:
   0A5F DD 7E 02      [19]  329 	ld a, e_cmps(ix)
   0A62 E6 10         [ 7]  330 	and #e_cmp_ai
   0A64 28 05         [12]  331 	jr z, _noAI
                            332 
   0A66                     333 	_AI:
   0A66 3E 02         [ 7]  334 	ld a, #e_cmpID_AI
   0A68 CD A0 06      [17]  335 	call man_components_add
                            336 
   0A6B                     337 	_noAI:
   0A6B DD 7E 02      [19]  338 	ld a, e_cmps(ix)
   0A6E E6 80         [ 7]  339 	and #e_cmp_collisionable
   0A70 28 05         [12]  340 	jr z, _noCollisionable
                            341 
   0A72                     342 	_Collisionable:
   0A72 3E 04         [ 7]  343 	ld a, #e_cmpID_Collisionable
   0A74 CD A0 06      [17]  344 	call man_components_add
                            345 
   0A77                     346 	_noCollisionable:
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 116.
Hexadecimal [16-Bits]



   0A77 DD 7E 02      [19]  347 	ld a, e_cmps(ix)
   0A7A E6 04         [ 7]  348 	and #e_cmp_physics
   0A7C 28 05         [12]  349 	jr z, _noPhysics
                            350 
   0A7E                     351 	_Physics:
   0A7E 3E 01         [ 7]  352 	ld a, #e_cmpID_Physics
   0A80 CD A0 06      [17]  353 	call man_components_add
   0A83                     354 	_noPhysics:
                            355 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            356 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;	
   0A83 C9            [10]  357 	ret
                            ...
                            364 ;;       IX, A
                            365 ;;	   
   0A84                     366 man_entity_getEntityArrayIX::
   0A84 DD 2A 37 08   [20]  367 	ld ix, (_entity_list)
   0A88 3A 36 08      [13]  368 	ld a, (_entity_num)
   0A8B C9            [10]  369 	ret
                            370 
                            371 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            376 ;;		HL
                            377 ;;	   
   0A8C                     378 man_entity_getPlayerPosition::
   0A8C DD 21 3B 08   [14]  379 	ld ix, #_entity_array
   0A90 C9            [10]  380 	ret
                            381 
                            382 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            387 ;;		HL
                            388 ;;	   
   0A91                     389 man_entity_getOponentPosition::
   025B                     390 	cpctm_push hl, bc
                     0002     1    .narg v
                     0001     2    .if v
   0A91 E5            [11]    3    push hl
                     0001     4    .if v-1
   0A92 C5            [11]    5    push bc
                     0000     6    .if v-2
                              7    push 
                              8    .if v-3
                              9    push 
...
Hexadecimal [16-Bits]
                     ...
                     0001    23    .else
                             24    .mexit
   0A93 21 3B 08      [10]  391 	ld hl, #_entity_array
   0A96 01 20 00      [10]  392 	ld bc, #sizeof_e
   0A99 09            [11]  393 	add hl, bc
   0A9A E5            [11]  394 	push hl
   0A9B FD E1         [14]  395 	pop iy
   0267                     396 	cpctm_pop bc, hl
                     0002     1    .narg v
                     0001     2    .if v
   0A9D C1            [10]    3    pop bc
                     0001     4    .if v-1
   ...
   0A9F C9            [10]  397 	ret
                            ...
                            404 ;;		A
                            405 ;;	   
   0AA0                     406 man_entity_deleteEverythingExceptPlayer::
   0AA0 CD 84 0A      [17]  407 	call man_entity_getEntityArrayIX
                            408 
...
Hexadecimal [16-Bits]
   ...
   0AA3 DD 7E 00      [19]  412 	ld a, e_ptr(ix)
   0AA6 4F            [ 4]  413 	ld c, a
   0AA7 DD 46 01      [19]  414 	ld b, e_ptr+1(ix)
   0AAA B1            [ 4]  415 	or c
   0AAB C8            [11]  416 	ret z
                            417 
                            418 	;;	The entity is marked for deletion.
   0AAC CD 0F 0A      [17]  419 	call man_entity_set4destruction
                            420 
   0279                     421 	ld__ixl_c
   0AAF DD 69                 1    .dw #0x69DD  ;; Opcode for ld ixl, c
   027B                     422 	ld__ixh_b
   0AB1 DD 60                 1    .dw #0x60DD  ;; Opcode for ld ixh, b
   0AB3 18 EE         [12]  423 	jr __loop
