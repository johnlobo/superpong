...
Hexadecimal [16-Bits]
                             ...
                             21 
                             22 .module component_manager
                             23 
                             24 
   0000                      25 DefineComponentPointerTable _entities, e_cmpID_Num_Components, MAX_ENTITIES
                     0000     1     _c = 0
                              2     ;;  Array containing pointers to component pointer arrays.
   0000                       3     _entities_access_table::
                              4     .rept e_cmpID_Num_Components
                              5         DefineComponentPointerAccessTable _entities, \_c, MAX_ENTITIES, e_cmpID_Num_Components
                              6         _c = _c + 1
                              7     .endm
   0000                       1         DefineComponentPointerAccessTable _entities, \_c, MAX_ENTITIES, e_cmpID_Num_Components
   05EC F6 05                 1     _entities_components0_ptr_pend::    .dw . + 2*e_cmpID_Num_Components+ + 0*2*MAX_ENTITIES + 2*0
                     0001     2         _c = _c + 1
   0002                       1         DefineComponentPointerAccessTable _entities, \_c, MAX_ENTITIES, e_cmpID_Num_Components
   05EE 0E 06                 1     _entities_components1_ptr_pend::    .dw . + 2*e_cmpID_Num_Components+ + 1*2*MAX_ENTITIES + 2*1
                     0002     2         _c = _c + 1
   0004                       1         DefineComponentPointerAccessTable _entities, \_c, MAX_ENTITIES, e_cmpID_Num_Components
   05F0 26 06                 1     _entities_components2_ptr_pend::    .dw . + 2*e_cmpID_Num_Components+ + 2*2*MAX_ENTITIES + 2*2
                     0003     2         _c = _c + 1
   0006                       1         DefineComponentPointerAccessTable _entities, \_c, MAX_ENTITIES, e_cmpID_Num_Components
   05F2 3E 06                 1     _entities_components3_ptr_pend::    .dw . + 2*e_cmpID_Num_Components+ + 3*2*MAX_ENTITIES + 2*3
                     0004     2         _c = _c + 1
   0008                       1         DefineComponentPointerAccessTable _entities, \_c, MAX_ENTITIES, e_cmpID_Num_Components
   05F4 56 06                 1     _entities_components4_ptr_pend::    .dw . + 2*e_cmpID_Num_Components+ + 4*2*MAX_ENTITIES + 2*4
                     0005     2         _c = _c + 1
   ...
   05F6                      10     _entities_components::
                             11    .rept e_cmpID_Num_Components
                             12         DefineComponentArray MAX_ENTITIES
                             13         .dw 0x0000
                             14         .dw 0x0000
                             15     .endm
   000A                       1         DefineComponentArray MAX_ENTITIES
                              1     .rept MAX_ENTITIES
                              2         .dw 0x0000
                              3     .endm
   05F6 00 00                 1         .dw 0x0000
   05F8 00 00                 1         .dw 0x0000
   05FA 00 00                 1         .dw 0x0000
   05FC 00 00                 1         .dw 0x0000
   05FE 00 00                 1         .dw 0x0000
   0600 00 00                 1         .dw 0x0000
   0602 00 00                 1         .dw 0x0000
   0604 00 00                 1         .dw 0x0000
   0606 00 00                 1         .dw 0x0000
   0608 00 00                 1         .dw 0x0000
   060A 00 00                 2         .dw 0x0000
   060C 00 00                 3         .dw 0x0000
   0022                       1         DefineComponentArray MAX_ENTITIES
                              1     .rept MAX_ENTITIES
                              2         .dw 0x0000
                              3     .endm
...
Hexadecimal [16-Bits]
   ...
   060E 00 00                 1         .dw 0x0000
   0610 00 00                 1         .dw 0x0000
   0612 00 00                 1         .dw 0x0000
   0614 00 00                 1         .dw 0x0000
   0616 00 00                 1         .dw 0x0000
   0618 00 00                 1         .dw 0x0000
   061A 00 00                 1         .dw 0x0000
   061C 00 00                 1         .dw 0x0000
   061E 00 00                 1         .dw 0x0000
   0620 00 00                 1         .dw 0x0000
   0622 00 00                 2         .dw 0x0000
   0624 00 00                 3         .dw 0x0000
   003A                       1         DefineComponentArray MAX_ENTITIES
                              1     .rept MAX_ENTITIES
                              2         .dw 0x0000
                              3     .endm
   0626 00 00                 1         .dw 0x0000
   0628 00 00                 1         .dw 0x0000
   062A 00 00                 1         .dw 0x0000
   062C 00 00                 1         .dw 0x0000
   062E 00 00                 1         .dw 0x0000
   0630 00 00                 1         .dw 0x0000
   0632 00 00                 1         .dw 0x0000
   0634 00 00                 1         .dw 0x0000
   0636 00 00                 1         .dw 0x0000
   0638 00 00                 1         .dw 0x0000
   063A 00 00                 2         .dw 0x0000
   063C 00 00                 3         .dw 0x0000
   0052                       1         DefineComponentArray MAX_ENTITIES
                              1     .rept MAX_ENTITIES
                              2         .dw 0x0000
                              3     .endm
   063E 00 00                 1         .dw 0x0000
   0640 00 00                 1         .dw 0x0000
   0642 00 00                 1         .dw 0x0000
   0644 00 00                 1         .dw 0x0000
   0646 00 00                 1         .dw 0x0000
   0648 00 00                 1         .dw 0x0000
   064A 00 00                 1         .dw 0x0000
   064C 00 00                 1         .dw 0x0000
   064E 00 00                 1         .dw 0x0000
   0650 00 00                 1         .dw 0x0000
   0652 00 00                 2         .dw 0x0000
   0654 00 00                 3         .dw 0x0000
   006A                       1         DefineComponentArray MAX_ENTITIES
                              1     .rept MAX_ENTITIES
                              2         .dw 0x0000
                              3     .endm
   0656 00 00                 1         .dw 0x0000
   0658 00 00                 1         .dw 0x0000
   065A 00 00                 1         .dw 0x0000
   065C 00 00                 1         .dw 0x0000
   065E 00 00                 1         .dw 0x0000
   0660 00 00                 1         .dw 0x0000
   0662 00 00                 1         .dw 0x0000
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 109.
Hexadecimal [16-Bits]



   0664 00 00                 1         .dw 0x0000
   0666 00 00                 1         .dw 0x0000
   0668 00 00                 1         .dw 0x0000
   066A 00 00                 2         .dw 0x0000
   066C 00 00                 3         .dw 0x0000
                     0078    26 _components_size = . - _entities_components
                             27 
                             28 
                             29 ;;-----------------------------------------------------------------
                             30 ;;
                             31 ;; man_components_init
                             32 ;;
                             33 ;;  Input:  
                             34 ;;  Output: 
                             35 ;;  Destroyed: af, hl, de, bc
                             36 ;;
                             37 ;;  lronaldo code (https://www.youtube.com/watch?v=OEETYTu-viw&t=1774s)
                             38 ;;
   066E                      39 man_components_init::
                             40     ;; Set all values of the pointer array to nullpointer
                             41     ;; filling in the array with zeroes
   066E 21 F6 05      [10]   42     ld hl, # _entities_components        ;; hl points to the start of the components array
   0671 11 F7 05      [10]   43     ld de, # _entities_components + 1    ;; de points to hl + 1
   0674 36 00         [10]   44     ld (hl), #0                         ;; set the first byte of the array to 0
   0676 01 77 00      [10]   45     ld bc, #_components_size-1          ;; set bc to the bytes to be filled
   0679 ED B0         [21]   46     ldir
                             47 
                             48     ;; Set the values for all Pend pointers in all pointer vectors
   067B 06 05         [ 7]   49     ld b, #e_cmpID_Num_Components       ;; b = number of components
   067D                      50 _init_next_pend:
                             51     ;; Get in hl a pointer to the next component
   067D 78            [ 4]   52     ld a, b                             ;; a = b
   067E 3D            [ 4]   53     dec a
   067F CD 8C 06      [17]   54     call man_components_getComponentPtrHL
   0682 5D            [ 4]   55     ld e, l
   0683 54            [ 4]   56     ld d, h
   0684 13            [ 6]   57     inc de
   0685 13            [ 6]   58     inc de 
   0686 73            [ 7]   59     ld (hl), e
   0687 23            [ 6]   60     inc hl
   0688 72            [ 7]   61     ld (hl), d
   0689 10 F2         [13]   62 djnz _init_next_pend
                             63 
   068B C9            [10]   64 ret
                             65 
                             66 
                             67 ;;-----------------------------------------------------------------
                             68 ;;
                             69 ;; man_components_getComponentPtrHL
                             70 ;;
                             71 ;;  Input:  a: component id
                             72 ;;  Output: hl: pointer to the start of the component structure
                             73 ;;  Destroyed: af
                             74 ;;
                             75 ;;  lronaldo code (https://www.youtube.com/watch?v=OEETYTu-viw&t=1774s)
...
Hexadecimal [16-Bits]
                             ...
                             76 ;;
   068C                      77 man_components_getComponentPtrHL::
   068C 21 EC 05      [10]   78     ld hl, # _entities_access_table      ;; hl points to the Entity components table
   068F 87            [ 4]   79     add a                               ;; a = 2a
   00A4                      80     add_hl_a                            ;; hl = 2a
   00A4                       1    add_REGPAIR_a  h, l
                              1    ;; First Perform RH = E + A
   0690 85            [ 4]    2    add l    ;; [1] A' = RL + A 
   0691 6F            [ 4]    3    ld  l, a ;; [1] RL' = A' = RL + A. It might generate Carry that must be added to RH
                              4    
                              5    ;; Then Perform RH = RH + Carry 
   0692 8C            [ 4]    6    adc h    ;; [1] A'' = A' + RH + Carry = RL + A + RH + Carry
   0693 95            [ 4]    7    sub l    ;; [1] Remove RL'. A''' = A'' - RL' = RL + A + RH + Carry - (RL + A) = RH + Carry
   0694 67            [ 4]    8    ld  h, a ;; [1] Save into RH (RH' = A''' = RH + Carry)
                             81     ;; Get pointer to the component structure
   0695 7E            [ 7]   82     ld a, (hl)
   0696 23            [ 6]   83     inc hl
   0697 66            [ 7]   84     ld h, (hl)
   0698 6F            [ 4]   85     ld l, a
   0699 C9            [10]   86     ret
                             87 
                             88 ;;-----------------------------------------------------------------
                             89 ;;
                             90 ;; man_components_getArrayHL
                             91 ;;
                             92 ;;  Input:  a: component id
                             93 ;;  Output: hl: pointer to the start of the array of pointers for the selected component
                             94 ;;  Destroyed: af
                             95 ;;
                             96 ;;  lronaldo code (https://www.youtube.com/watch?v=OEETYTu-viw&t=1774s)
                             97 ;;
   069A                      98 man_components_getArrayHL::
   069A CD 8C 06      [17]   99     call man_components_getComponentPtrHL
   069D 23            [ 6]  100     inc hl
   069E 23            [ 6]  101     inc hl
   069F C9            [10]  102     ret
                            103 
                            104 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            105 ;;  COMPONENT_MANAGER::add
                            106 ;;      Adda a pointer to the entity in the corresponding array of components.
                            107 ;;  INPUT:
                            108 ;;      IX: Pointer to entity.
                            109 ;;  MODIFY:
                            110 ;;       A, HL
                            111 ;;  RETURNS:
                            112 ;;
                            ...
                            114 ;;
   06A0                     115 man_components_add::
                            116     ;;  Gets the pointer to the component's array.
   06A0 CD 8C 06      [17]  117 	call man_components_getComponentPtrHL
                            118 
                            119     ;;  DE = Pointer to the first free position of the array of pointers.
   06A3 5E            [ 7]  120     ld e, (hl)
   06A4 23            [ 6]  121     inc hl
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 111.
Hexadecimal [16-Bits]



   06A5 56            [ 7]  122     ld d, (hl)
   06A6 2B            [ 6]  123     dec hl
                            124 
                            125     ;;  Copy the pointer of the entity that handles that component to the
                            126     ;;  array of pointers.
   00BB                     127     ld__a_ixl
   06A7 DD 7D                 1    .dw #0x7DDD  ;; Opcode for ld a, ixl
   06A9 12            [ 7]  128     ld (de), a
   06AA 13            [ 6]  129     inc de
   00BF                     130     ld__a_ixh
   06AB DD 7C                 1    .dw #0x7CDD  ;; Opcode for ld a, ixh
   06AD 12            [ 7]  131     ld (de), a
   06AE 13            [ 6]  132     inc de
                            133 
                            134     ;;  (HL) = Next free position of the pointer array.
   06AF 73            [ 7]  135     ld (hl), e
   06B0 23            [ 6]  136     inc hl
   06B1 72            [ 7]  137     ld (hl), d
                            138 
   06B2 C9            [10]  139 	ret
                            140 
                            141 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            142 ;;  COMPONENT_MANAGER::removePtr
                            143 ;;      Remove the pointer from the destroyed entity replacing it with the
                            144 ;;      last pointer of the array.
                            145 ;;  INPUT:
                            146 ;;		IX: Entity pointer.
                            147 ;;		A:  Component ID.
                            148 ;;  MODIFY:
                            149 ;;      HL, DE, BC, A
                            150 ;;  RETURNS:
                            ...
                            154 ;;
   06B3                     155 man_components_removePtr::
                            156     ;;  HL = First pointer of the relevant component array.
   06B3 CD 8C 06      [17]  157 	call man_components_getComponentPtrHL
   06B6 E5            [11]  158     push hl
                            159     ;;  DE = Address insert new pointer.
   06B7 5E            [ 7]  160     ld e, (hl)
   06B8 23            [ 6]  161     inc hl
   06B9 56            [ 7]  162     ld d, (hl)
   06BA 23            [ 6]  163     inc hl      ;;  HL = Address to the first pointer of the array.
                            164 
   06BB                     165 	__loop:
   06BB 7E            [ 7]  166 	ld a, (hl)
   06BC 23            [ 6]  167 	inc hl
   00D1                     168     cp__ixl
   06BD DD BD                 1    .dw #0xBDDD  ;; Opcode for cp ixl
   06BF 20 FA         [12]  169     jr nz, __loop
                            170 
   06C1 7E            [ 7]  171 	ld a, (hl)
   06C2 23            [ 6]  172 	inc hl
   00D7                     173     cp__ixh
...
Hexadecimal [16-Bits]
   ...
   06C3 DD BC                 1    .dw #0xBCDD  ;; Opcode for cp ixh
   06C5 20 F4         [12]  174     jr nz, __loop
                            175 
   06C7                     176 __delete_pointer:
   ...
   06C7 1B            [ 6]  180     dec de
   06C8 1A            [ 7]  181     ld a, (de)
   06C9 2B            [ 6]  182     dec hl
   06CA 77            [ 7]  183     ld (hl), a
                            184 
   06CB 1B            [ 6]  185     dec de
   06CC 1A            [ 7]  186     ld a, (de)
   06CD 2B            [ 6]  187     dec hl
   06CE 77            [ 7]  188     ld (hl), a
                            189 
   06CF                     190 __last_array_pointer:
                            191     ;;  HL = Address containing the pointer to the next free address in the array.
   06CF E1            [10]  192     pop hl
                            193 
                            194     ;;  (HL) = New free position.
   06D0 73            [ 7]  195     ld (hl), e
   06D1 23            [ 6]  196     inc hl
   06D2 72            [ 7]  197     ld (hl), d
                            198 
   ...
   06D3 AF            [ 4]  201     xor a
   06D4 12            [ 7]  202     ld (de), a
   06D5 13            [ 6]  203     inc de
   06D6 12            [ 7]  204     ld (de), a
   06D7 C9            [10]  205 	ret
