...
Hexadecimal [24-Bits]
                                     ...
                                     23 
                                     24 
      000000                         25 DefineComponentPointerTable _entities, e_cmpID_Num_Components, MAX_ENTITIES
                           000000     1     _c = 0
                                      2     ;;  Array containing pointers to component pointer arrays.
      000000                          3     _entities_access_table::
      ...
      000748 52 07                    1     _entities_components0_ptr_pend::    .dw . + 2*e_cmpID_Num_Components+ + 0*2*MAX_ENTITIES + 2*0
                           000001     2         _c = _c + 1
      000002                          1         DefineComponentPointerAccessTable _entities, \_c, MAX_ENTITIES, e_cmpID_Num_Components
      00074A 6A 07                    1     _entities_components1_ptr_pend::    .dw . + 2*e_cmpID_Num_Components+ + 1*2*MAX_ENTITIES + 2*1
                           000002     2         _c = _c + 1
      000004                          1         DefineComponentPointerAccessTable _entities, \_c, MAX_ENTITIES, e_cmpID_Num_Components
      00074C 82 07                    1     _entities_components2_ptr_pend::    .dw . + 2*e_cmpID_Num_Components+ + 2*2*MAX_ENTITIES + 2*2
                           000003     2         _c = _c + 1
      000006                          1         DefineComponentPointerAccessTable _entities, \_c, MAX_ENTITIES, e_cmpID_Num_Components
      00074E 9A 07                    1     _entities_components3_ptr_pend::    .dw . + 2*e_cmpID_Num_Components+ + 3*2*MAX_ENTITIES + 2*3
                           000004     2         _c = _c + 1
      000008                          1         DefineComponentPointerAccessTable _entities, \_c, MAX_ENTITIES, e_cmpID_Num_Components
      000750 B2 07                    1     _entities_components4_ptr_pend::    .dw . + 2*e_cmpID_Num_Components+ + 4*2*MAX_ENTITIES + 2*4
                           000005     2         _c = _c + 1
      ...
      000752                         10     _entities_components::
                                     11    .rept e_cmpID_Num_Components
                                     12         DefineComponentArray MAX_ENTITIES
                                     13         .dw 0x0000
                                     14         .dw 0x0000
                                     15     .endm
      00000A                          1         DefineComponentArray MAX_ENTITIES
                                      1     .rept MAX_ENTITIES
                                      2         .dw 0x0000
                                      3     .endm
      000752 00 00                    1         .dw 0x0000
      000754 00 00                    1         .dw 0x0000
      000756 00 00                    1         .dw 0x0000
      000758 00 00                    1         .dw 0x0000
      00075A 00 00                    1         .dw 0x0000
      00075C 00 00                    1         .dw 0x0000
      00075E 00 00                    1         .dw 0x0000
      000760 00 00                    1         .dw 0x0000
      000762 00 00                    1         .dw 0x0000
      000764 00 00                    1         .dw 0x0000
      000766 00 00                    2         .dw 0x0000
      000768 00 00                    3         .dw 0x0000
...
Hexadecimal [24-Bits]
      ...
      00076A 00 00                    1         .dw 0x0000
      00076C 00 00                    1         .dw 0x0000
      00076E 00 00                    1         .dw 0x0000
      000770 00 00                    1         .dw 0x0000
      000772 00 00                    1         .dw 0x0000
      000774 00 00                    1         .dw 0x0000
      000776 00 00                    1         .dw 0x0000
      000778 00 00                    1         .dw 0x0000
      00077A 00 00                    1         .dw 0x0000
      00077C 00 00                    1         .dw 0x0000
      00077E 00 00                    2         .dw 0x0000
      000780 00 00                    3         .dw 0x0000
      00003A                          1         DefineComponentArray MAX_ENTITIES
                                      1     .rept MAX_ENTITIES
                                      2         .dw 0x0000
                                      3     .endm
      000782 00 00                    1         .dw 0x0000
      000784 00 00                    1         .dw 0x0000
      000786 00 00                    1         .dw 0x0000
      000788 00 00                    1         .dw 0x0000
      00078A 00 00                    1         .dw 0x0000
      00078C 00 00                    1         .dw 0x0000
      00078E 00 00                    1         .dw 0x0000
      000790 00 00                    1         .dw 0x0000
      000792 00 00                    1         .dw 0x0000
      000794 00 00                    1         .dw 0x0000
      000796 00 00                    2         .dw 0x0000
      000798 00 00                    3         .dw 0x0000
      000052                          1         DefineComponentArray MAX_ENTITIES
                                      1     .rept MAX_ENTITIES
                                      2         .dw 0x0000
                                      3     .endm
      00079A 00 00                    1         .dw 0x0000
      00079C 00 00                    1         .dw 0x0000
      00079E 00 00                    1         .dw 0x0000
      0007A0 00 00                    1         .dw 0x0000
      0007A2 00 00                    1         .dw 0x0000
      0007A4 00 00                    1         .dw 0x0000
      0007A6 00 00                    1         .dw 0x0000
      0007A8 00 00                    1         .dw 0x0000
      0007AA 00 00                    1         .dw 0x0000
      0007AC 00 00                    1         .dw 0x0000
      0007AE 00 00                    2         .dw 0x0000
      0007B0 00 00                    3         .dw 0x0000
      00006A                          1         DefineComponentArray MAX_ENTITIES
                                      1     .rept MAX_ENTITIES
                                      2         .dw 0x0000
                                      3     .endm
      0007B2 00 00                    1         .dw 0x0000
      0007B4 00 00                    1         .dw 0x0000
      0007B6 00 00                    1         .dw 0x0000
      0007B8 00 00                    1         .dw 0x0000
      0007BA 00 00                    1         .dw 0x0000
      0007BC 00 00                    1         .dw 0x0000
      0007BE 00 00                    1         .dw 0x0000
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 109.
Hexadecimal [24-Bits]



      0007C0 00 00                    1         .dw 0x0000
      0007C2 00 00                    1         .dw 0x0000
      0007C4 00 00                    1         .dw 0x0000
      0007C6 00 00                    2         .dw 0x0000
      0007C8 00 00                    3         .dw 0x0000
                           000078    26 _components_size = . - _entities_components
                                     ...
                                     38 ;;
      0007CA                         39 man_components_init::
                                     40     ;; Set all values of the pointer array to nullpointer
                                     41     ;; filling in the array with zeroes
      0007CA 21 52 07         [10]   42     ld hl, # _entities_components        ;; hl points to the start of the components array
      0007CD 11 53 07         [10]   43     ld de, # _entities_components + 1    ;; de points to hl + 1
      0007D0 36 00            [10]   44     ld (hl), #0                         ;; set the first byte of the array to 0
      0007D2 01 77 00         [10]   45     ld bc, #_components_size-1          ;; set bc to the bytes to be filled
      0007D5 ED B0            [21]   46     ldir
                                     47 
                                     48     ;; Set the values for all Pend pointers in all pointer vectors
      0007D7 06 05            [ 7]   49     ld b, #e_cmpID_Num_Components       ;; b = number of components
      0007D9                         50 _init_next_pend:
                                     51     ;; Get in hl a pointer to the next component
      0007D9 78               [ 4]   52     ld a, b                             ;; a = b
      0007DA 3D               [ 4]   53     dec a
      0007DB CD E8 07         [17]   54     call man_components_getComponentPtrHL
      0007DE 5D               [ 4]   55     ld e, l
      0007DF 54               [ 4]   56     ld d, h
      0007E0 13               [ 6]   57     inc de
      0007E1 13               [ 6]   58     inc de 
      0007E2 73               [ 7]   59     ld (hl), e
      0007E3 23               [ 6]   60     inc hl
      0007E4 72               [ 7]   61     ld (hl), d
      0007E5 10 F2            [13]   62 djnz _init_next_pend
                                     63 
      0007E7 C9               [10]   64 ret
                                     65 
                                     66 
...
Hexadecimal [24-Bits]
                                     ...
                                     76 ;;
      0007E8                         77 man_components_getComponentPtrHL::
      0007E8 21 48 07         [10]   78     ld hl, # _entities_access_table      ;; hl points to the Entity components table
      0007EB 87               [ 4]   79     add a                               ;; a = 2a
      0000A4                         80     add_hl_a                            ;; hl = 2a
      0000A4                          1    add_REGPAIR_a  h, l
                                      1    ;; First Perform RH = E + A
      0007EC 85               [ 4]    2    add l    ;; [1] A' = RL + A 
      0007ED 6F               [ 4]    3    ld  l, a ;; [1] RL' = A' = RL + A. It might generate Carry that must be added to RH
                                      4    
                                      5    ;; Then Perform RH = RH + Carry 
      0007EE 8C               [ 4]    6    adc h    ;; [1] A'' = A' + RH + Carry = RL + A + RH + Carry
      0007EF 95               [ 4]    7    sub l    ;; [1] Remove RL'. A''' = A'' - RL' = RL + A + RH + Carry - (RL + A) = RH + Carry
      0007F0 67               [ 4]    8    ld  h, a ;; [1] Save into RH (RH' = A''' = RH + Carry)
                                     81     ;; Get pointer to the component structure
      0007F1 7E               [ 7]   82     ld a, (hl)
      0007F2 23               [ 6]   83     inc hl
      0007F3 66               [ 7]   84     ld h, (hl)
      0007F4 6F               [ 4]   85     ld l, a
      0007F5 C9               [10]   86     ret
                                     87 
                                     88 ;;-----------------------------------------------------------------
                                     89 ;;
                                     ...
                                     97 ;;
      0007F6                         98 man_components_getArrayHL::
      0007F6 CD E8 07         [17]   99     call man_components_getComponentPtrHL
      0007F9 23               [ 6]  100     inc hl
      0007FA 23               [ 6]  101     inc hl
      0007FB C9               [10]  102     ret
                                    103 
                                    104 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    ...
                                    114 ;;
      0007FC                        115 man_components_add::
                                    116     ;;  Gets the pointer to the component's array.
      0007FC CD E8 07         [17]  117 	call man_components_getComponentPtrHL
                                    118 
                                    119     ;;  DE = Pointer to the first free position of the array of pointers.
      0007FF 5E               [ 7]  120     ld e, (hl)
      000800 23               [ 6]  121     inc hl
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 111.
Hexadecimal [24-Bits]



      000801 56               [ 7]  122     ld d, (hl)
      000802 2B               [ 6]  123     dec hl
                                    124 
                                    125     ;;  Copy the pointer of the entity that handles that component to the
                                    126     ;;  array of pointers.
      0000BB                        127     ld__a_ixl
      000803 DD 7D                    1    .dw #0x7DDD  ;; Opcode for ld a, ixl
      000805 12               [ 7]  128     ld (de), a
      000806 13               [ 6]  129     inc de
      0000BF                        130     ld__a_ixh
      000807 DD 7C                    1    .dw #0x7CDD  ;; Opcode for ld a, ixh
      000809 12               [ 7]  131     ld (de), a
      00080A 13               [ 6]  132     inc de
                                    133 
                                    134     ;;  (HL) = Next free position of the pointer array.
      00080B 73               [ 7]  135     ld (hl), e
      00080C 23               [ 6]  136     inc hl
      00080D 72               [ 7]  137     ld (hl), d
                                    138 
      00080E C9               [10]  139 	ret
                                    140 
                                    141 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    ...
                                    154 ;;
      00080F                        155 man_components_removePtr::
                                    156     ;;  HL = First pointer of the relevant component array.
      00080F CD E8 07         [17]  157 	call man_components_getComponentPtrHL
      000812 E5               [11]  158     push hl
                                    159     ;;  DE = Address insert new pointer.
      000813 5E               [ 7]  160     ld e, (hl)
      000814 23               [ 6]  161     inc hl
      000815 56               [ 7]  162     ld d, (hl)
      000816 23               [ 6]  163     inc hl      ;;  HL = Address to the first pointer of the array.
                                    164 
      000817                        165 	__loop:
      000817 7E               [ 7]  166 	ld a, (hl)
      000818 23               [ 6]  167 	inc hl
      0000D1                        168     cp__ixl
      000819 DD BD                    1    .dw #0xBDDD  ;; Opcode for cp ixl
      00081B 20 FA            [12]  169     jr nz, __loop
                                    170 
      00081D 7E               [ 7]  171 	ld a, (hl)
      00081E 23               [ 6]  172 	inc hl
      0000D7                        173     cp__ixh
...
Hexadecimal [24-Bits]
      ...
      00081F DD BC                    1    .dw #0xBCDD  ;; Opcode for cp ixh
      000821 20 F4            [12]  174     jr nz, __loop
                                    175 
      000823                        176 __delete_pointer:
      ...
      000823 1B               [ 6]  180     dec de
      000824 1A               [ 7]  181     ld a, (de)
      000825 2B               [ 6]  182     dec hl
      000826 77               [ 7]  183     ld (hl), a
                                    184 
      000827 1B               [ 6]  185     dec de
      000828 1A               [ 7]  186     ld a, (de)
      000829 2B               [ 6]  187     dec hl
      00082A 77               [ 7]  188     ld (hl), a
                                    189 
      00082B                        190 __last_array_pointer:
                                    191     ;;  HL = Address containing the pointer to the next free address in the array.
      00082B E1               [10]  192     pop hl
                                    193 
                                    194     ;;  (HL) = New free position.
      00082C 73               [ 7]  195     ld (hl), e
      00082D 23               [ 6]  196     inc hl
      00082E 72               [ 7]  197     ld (hl), d
                                    198 
      ...
      00082F AF               [ 4]  201     xor a
      000830 12               [ 7]  202     ld (de), a
      000831 13               [ 6]  203     inc de
      000832 12               [ 7]  204     ld (de), a
      000833 C9               [10]  205 	ret
