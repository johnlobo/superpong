...
Hexadecimal [16-Bits]
                             ...
                             26 ;;-----------------------------------------------------------------
                             27 ;;
                             28 ;; man_ball_reverse_hor_speed
                             29 ;;
                             30 ;;  Reverses the vertical speed of the ball
                             31 ;;  Input:  ix : pointer to the entity
                             32 ;;          iy: pointer to the colisionable
                             33 ;;  Output: 
                             34 ;;  Modified: AF, BC, HL
                             35 ;;
   0000                      36 man_ball_reverse_hor_speed::
   0836 FD E5         [15]   37     push iy
   ...
   084C C9            [10]   45     ret
                             ...
                             47 ;;-----------------------------------------------------------------
                             48 ;;
                             49 ;; man_ball_reverse_ver_speed
                             50 ;;
                             51 ;;  Reverses the vertical speed of the ball
                             52 ;;  Input:  ix : pointer to the entity
                             53 ;;          iy: pointer to the colisionable
                             54 ;;  Output: 
                             55 ;;  Modified: AF, BC, HL
                             56 ;;
   084D                      57 man_ball_reverse_ver_speed::
   084D FD E5         [15]   58     push iy
   ...
   0863 C9            [10]   66     ret
                             ...
                             68 ;;-----------------------------------------------------------------
                             69 ;;
                             70 ;; man_ball_increase_hor_speed
                             71 ;;
                             72 ;;  increase the horizonal speed of the ball
                             73 ;;  Input:  a : angle
                             74 ;;  Output: 
                             75 ;;  Modified: AF, BC, HL
                             76 ;;
   0864                      77 man_ball_increase_hor_speed::
   0864 FD 66 0F      [19]   78     ld h, e_vx(iy)
   0867 FD 6E 10      [19]   79     ld l, e_vx+1(iy)
...
Hexadecimal [16-Bits]
   ...
   0874 E5            [11]   84     push hl
   0875 B7            [ 4]   85     or a
   0876 ED 42         [15]   86     sbc hl, bc
   0878 E1            [10]   87     pop hl
   0879 38 03         [12]   88     jr c, _mbihs_restore_speed
   087B 21 00 01      [10]   89     ld hl, #MAX_HORIZONTAL_BALL_SPEED
   087E                      90 _mbihs_restore_speed:
   ...
   088E C9            [10]   98     ret
                            ...
                            100 ;;-----------------------------------------------------------------
                            101 ;;
                            102 ;; man_ball_set_ver_speed
                            103 ;;
                            104 ;;  sets the vertical speed of the ball
                            105 ;;  Input:  a : angle
                            106 ;;  Output: 
                            107 ;;  Modified: AF, BC, HL
                            108 ;;
   088F                     109 man_ball_set_ver_speed::
   088F FD E5         [15]  110     push iy
   0891 CD 12 0A      [17]  111     call man_entity_getBallPositionIY
                            112 
   0894 B7            [ 4]  113     or a                                ;; a=0??
   0895 20 0A         [12]  114     jr nz, mbsvs_1
   0897 FD 36 11 FF   [19]  115     ld e_vy(iy), #0xff
   089B FD 36 12 E0   [19]  116     ld e_vy+1(iy), #0xe0
   089F 18 32         [12]  117     jr mbsvs_exit
   08A1                     118 mbsvs_1:
   08A1 FE 01         [ 7]  119     cp #1
   08A3 20 0A         [12]  120     jr nz, mbsvs_2
   08A5 FD 36 11 FF   [19]  121     ld e_vy(iy), #0xff
   08A9 FD 36 12 F0   [19]  122     ld e_vy+1(iy), #0xf0
   08AD 18 24         [12]  123     jr mbsvs_exit
   08AF                     124 mbsvs_2:
   08AF FE 02         [ 7]  125     cp #2
   08B1 20 0A         [12]  126     jr nz, mbsvs_3
   08B3 FD 36 11 00   [19]  127     ld e_vy(iy), #0x00
   08B7 FD 36 12 00   [19]  128     ld e_vy+1(iy), #0x00
   08BB 18 16         [12]  129     jr mbsvs_exit
   08BD                     130 mbsvs_3:
   08BD FE 03         [ 7]  131     cp #3
   08BF 20 0A         [12]  132     jr nz, mbsvs_4
   08C1 FD 36 11 00   [19]  133     ld e_vy(iy), #0x00
   08C5 FD 36 12 16   [19]  134     ld e_vy+1(iy), #0x16
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 111.
Hexadecimal [16-Bits]



   08C9 18 08         [12]  135     jr mbsvs_exit
   08CB                     136 mbsvs_4:
   08CB FD 36 11 00   [19]  137     ld e_vy(iy), #0x00
   08CF FD 36 12 32   [19]  138     ld e_vy+1(iy), #0x32
   08D3                     139 mbsvs_exit:
   08D3 FD E1         [14]  140     pop iy
   08D5 C9            [10]  141     ret
                            142 
