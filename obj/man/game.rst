...
Hexadecimal [16-Bits]
                             ...
                             36 
   0000                      37 player1Tpl::
   0000                      38 DefineEntity e_cmp_default, #0000, e_type_player, 100, 80, 2, 20, 0, 0, #0000, #0000, #0000, 1, 0, #0000, 0
   2358 00 00                 1     .dw #0000
   235A 47                    2     .db e_cmp_default
   235B 01                    3     .db e_type_player
   235C 64 00                 4     .dw 100
   235E 50 00                 5     .dw 80
   2360 02                    6     .db 2
   2361 14                    7     .db 20
   ...
   2366 00 00                12     .dw 0
   2368 00 00                13     .dw 0
   236A 00 00                14     .dw #0000
   236C 00 00                15     .dw #0000
   236E 00 00                16     .dw #0000
   2370 01                   17     .db #1           ;; moved 1 default
   2371 01                   18     .db 1
   2372 00                   19     .db 0 ;; 0: right, 1:left
   2373 00                   20     .db #0           ;; dashing
   2374 00 00                21     .dw #0000
   2376 00                   22     .db 0
                             39 
   2377 01                   40 game_state:: .db MAIN_MENU   ;; Game state ----- 0: Game loop, 1: Main menu, 2: Map loading, 3: Pause menu, 4: Game over, 5: Victory
                             41 ;;
                             ...
                             54 ;;
   0A9C                      55 man_game_init::
                             56 
   0A9C CD CC 09      [17]   57     call man_entity_init
                             58     
...
Hexadecimal [16-Bits]
                             ...
                             59     ;; Create an entity in 100, 100
   0A9F 21 58 23      [10]   60     ld hl, #player1Tpl                   ;; Template of the entity to create
   0AA2 CD 3A 0A      [17]   61     call man_entity_create              ;; Create new entity
   0AA5 DD 36 0F FF   [19]   62     ld e_vx+1(ix), #0xff                ;; vx = 1
                             63 
   0AA9 CD C2 0A      [17]   64     call sys_physics_init               ;; initilize physics system
                             65     
   0AAC C9            [10]   66     ret
                             67 
                             68 ;;-----------------------------------------------------------------
                             ...
                             76 ;;
   0AAD                      77 man_game_update::
   0AAD CD BA 1D      [17]   78     call sys_input_player_update
   0AB0 CD 70 0B      [17]   79     call sys_physics_update
   0AB3 CD 55 0C      [17]   80     call sys_render_update
   0AB6 CD 6A 0C      [17]   81     call sys_render_debug_entity
                             82     ;;delay 
                             83     ;;ld b, #10
                             84     ;;call cpct_waitHalts_asm
   0AB9 C9            [10]   85     ret
                             86 
                             87 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             88 ;;  Gets the current state of the game loop
                             89 ;;  MODIFIES:
                             90 ;;      - A: Returns state
                             91 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   0ABA                      92 man_game_get_state::
   0ABA 3A 77 23      [13]   93     ld a, (game_state)
   0ABD C9            [10]   94     ret
                             95 
                             96 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             97 ;;  Sets the current state of the game loop
                             98 ;;  MODIFIES:
                             99 ;;      - A: Returns state
                            100 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   0ABE                     101 man_game_set_state::
   0ABE 32 77 23      [13]  102     ld (game_state), a
   0AC1 C9            [10]  103     ret
