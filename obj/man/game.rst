...
Hexadecimal [16-Bits]
   ...
   23D5 00 00                 1     .dw #0000
   23D7 47                    2     .db e_cmp_default
   23D8 01                    3     .db e_type_player
   23D9 0F                    4     .db 15
   23DA 0A 00                 5     .dw 10
   23DC 50 00                 6     .dw 80
   23DE 01                    7     .db 1
   ...
   23E4 00 00                13     .dw 0
   23E6 00 00                14     .dw 0
   23E8 00 00                15     .dw #0000
   23EA 00 00                16     .dw #0000
   23EC 00 00                17     .dw #0000
   23EE 01                   18     .db #1           ;; moved 1 default
   23EF 01                   19     .db 1
   23F0 00                   20     .db 0 ;; 0: right, 1:left
   23F1 00                   21     .db #0           ;; dashing
   23F2 00 00                22     .dw #0000
   23F4 00                   23     .db 0
                             39 
   23F5 01                   40 game_state:: .db MAIN_MENU   ;; Game state ----- 0: Game loop, 1: Main menu, 2: Map loading, 3: Pause menu, 4: Game over, 5: Victory
                             41 ;;
                             ...
                             54 ;;
   0AB5                      55 man_game_init::
                             56 
   0AB5 CD D6 09      [17]   57     call man_entity_init
...
Hexadecimal [16-Bits]
   ...
   0AB8 21 D5 23      [10]   60     ld hl, #player1Tpl                  ;; Template of the entity to create
   0ABB CD 44 0A      [17]   61     call man_entity_create              ;; Create new entity
                             62 
                             63     ;; Create an entity in 140, 100
   0ABE 21 D5 23      [10]   64     ld hl, #player1Tpl                  ;; Template of the entity to create
   0AC1 CD 44 0A      [17]   65     call man_entity_create              ;; Create new entity
   0AC4 DD 36 05 3C   [19]   66     ld e_x(ix), #60                     ;; x = 60
   0AC8 DD 36 04 01   [19]   67     ld e_color(ix), #1                  ;; color = pink 
                             68 
   0ACC CD 03 0B      [17]   69     call sys_physics_init               ;; initilize physics system
                             70     
   0ACF C9            [10]   71     ret
                             72 
                             73 ;;-----------------------------------------------------------------
                             ...
                             81 ;;
   0AD0                      82 man_game_update::
   0AD0 CD 0D 1E      [17]   83     call sys_input_player_update
                             84 
   0AD3 CD 8C 0A      [17]   85     call man_entity_getPlayerPosition
   0AD6 CD 91 0A      [17]   86     call man_entity_getOponentPosition
                             87 
                             88     ;; Copy player movements on Oponent
   0AD9 DD 7E 0F      [19]   89     ld a, e_vx(ix)
   0ADC FD 77 0F      [19]   90     ld e_vx(iy), a
   0ADF DD 7E 10      [19]   91     ld a, e_vx+1(ix)
   0AE2 FD 77 10      [19]   92     ld e_vx+1(iy), a
                             93 
   0AE5 DD 7E 11      [19]   94     ld a, e_vy(ix)
   0AE8 FD 77 11      [19]   95     ld e_vy(iy), a
   0AEB DD 7E 12      [19]   96     ld a, e_vy+1(ix)
   0AEE FD 77 12      [19]   97     ld e_vy+1(iy), a
                             98     ;; -----------------------------
   0AF1                      99 _exit_clone_input:
                            100 
   0AF1 CD B7 0B      [17]  101     call sys_physics_update
   0AF4 CD A3 0C      [17]  102     call sys_render_update
   0AF7 CD B8 0C      [17]  103     call sys_render_debug_entity
                            104     ;;delay 
                            105     ;;ld b, #10
...
Hexadecimal [16-Bits]
                            ...
                            113 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   0AFB                     114 man_game_get_state::
   0AFB 3A F5 23      [13]  115     ld a, (game_state)
   0AFE C9            [10]  116     ret
                            117 
                            118 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            121 ;;      - A: Returns state
                            122 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   0AFF                     123 man_game_set_state::
   0AFF 32 F5 23      [13]  124     ld (game_state), a
   0B02 C9            [10]  125     ret
