...
Hexadecimal [16-Bits]
                             ...
                             36 
   0000                      37 player1Tpl::
   0000                      38 DefineEntity e_cmp_default, #0000, e_type_player, 15, 10, 80, 1, 20, 0, 0, #0000, #0000, #0000, 1, 0, #0000, 0
   23F5 00 00                 1     .dw #0000
   23F7 47                    2     .db e_cmp_default
   23F8 01                    3     .db e_type_player
   23F9 0F                    4     .db 15
   23FA 0A 00                 5     .dw 10
   23FC 50 00                 6     .dw 80
   23FE 01                    7     .db 1
   ...
   2404 00 00                13     .dw 0
   2406 00 00                14     .dw 0
   2408 00 00                15     .dw #0000
   240A 00 00                16     .dw #0000
   240C 00 00                17     .dw #0000
   240E 01                   18     .db #1           ;; moved 1 default
   240F 01                   19     .db 1
   2410 00                   20     .db 0 ;; 0: right, 1:left
   2411 00                   21     .db #0           ;; dashing
   2412 00 00                22     .dw #0000
   2414 00                   23     .db 0
   2415                      39 ballTpl:: 
   0020                      40 DefineEntity e_cmp_default, #0000, e_type_ball, 15, 40, 80, 1, 2, 0, 0, #0000, #0000, #0000, 1, 0, #0000, 0
   2415 00 00                 1     .dw #0000
   2417 47                    2     .db e_cmp_default
   2418 02                    3     .db e_type_ball
   2419 0F                    4     .db 15
   241A 28 00                 5     .dw 40
   241C 50 00                 6     .dw 80
   241E 01                    7     .db 1
   ...
   2424 00 00                13     .dw 0
   2426 00 00                14     .dw 0
   2428 00 00                15     .dw #0000
   242A 00 00                16     .dw #0000
   242C 00 00                17     .dw #0000
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 116.
Hexadecimal [16-Bits]



   242E 01                   18     .db #1           ;; moved 1 default
   242F 01                   19     .db 1
   2430 00                   20     .db 0 ;; 0: right, 1:left
   2431 00                   21     .db #0           ;; dashing
   2432 00 00                22     .dw #0000
   2434 00                   23     .db 0
                             41 
                             42 
   2435 01                   43 game_state:: .db MAIN_MENU   ;; Game state ----- 0: Game loop, 1: Main menu, 2: Map loading, 3: Pause menu, 4: Game over, 5: Victory
                             44 ;;
                             ...
                             57 ;;
   0AB5                      58 man_game_init::
                             59 
   0AB5 CD D6 09      [17]   60     call man_entity_init
                             61     
                             62     ;; Create an entity in 100, 100
   0AB8 21 F5 23      [10]   63     ld hl, #player1Tpl                  ;; Template of the entity to create
   0ABB CD 44 0A      [17]   64     call man_entity_create              ;; Create new entity
                             65 
                             66     ;; Create an entity in 140, 100
   0ABE 21 F5 23      [10]   67     ld hl, #player1Tpl                  ;; Template of the entity to create
   0AC1 CD 44 0A      [17]   68     call man_entity_create              ;; Create new entity
   0AC4 DD 36 05 3C   [19]   69     ld e_x(ix), #60                     ;; x = 60
   0AC8 DD 36 04 01   [19]   70     ld e_color(ix), #1                  ;; color = pink 
                             71 
   0ACC CD 03 0B      [17]   72     call sys_physics_init               ;; initilize physics system
                             73     
   0ACF C9            [10]   74     ret
                             75 
                             76 ;;-----------------------------------------------------------------
                             ...
                             81 ;;  Input: 
                             82 ;;  Output: 
                             83 ;;  Modified: AF, BC, DE, HL
                             84 ;;
   0AD0                      85 man_game_update::
   0AD0 CD 2D 1E      [17]   86     call sys_input_player_update
                             87 
   0AD3 CD 8C 0A      [17]   88     call man_entity_getPlayerPosition
   0AD6 CD 91 0A      [17]   89     call man_entity_getOponentPosition
...
Hexadecimal [16-Bits]
                             ...
                             90 
                             91     ;; Copy player movements on Oponent
   0AD9 DD 7E 0F      [19]   92     ld a, e_vx(ix)
   0ADC FD 77 0F      [19]   93     ld e_vx(iy), a
   0ADF DD 7E 10      [19]   94     ld a, e_vx+1(ix)
   0AE2 FD 77 10      [19]   95     ld e_vx+1(iy), a
                             96 
   0AE5 DD 7E 11      [19]   97     ld a, e_vy(ix)
   0AE8 FD 77 11      [19]   98     ld e_vy(iy), a
   0AEB DD 7E 12      [19]   99     ld a, e_vy+1(ix)
   0AEE FD 77 12      [19]  100     ld e_vy+1(iy), a
                            101     ;; -----------------------------
   0AF1                     102 _exit_clone_input:
                            103 
   0AF1 CD B7 0B      [17]  104     call sys_physics_update
   0AF4 CD A3 0C      [17]  105     call sys_render_update
   0AF7 CD B8 0C      [17]  106     call sys_render_debug_entity
                            107     ;;delay 
                            108     ;;ld b, #10
                            109     ;;call cpct_waitHalts_asm
   0AFA C9            [10]  110     ret
                            111 
                            112 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            113 ;;  Gets the current state of the game loop
                            114 ;;  MODIFIES:
                            115 ;;      - A: Returns state
                            116 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   0AFB                     117 man_game_get_state::
   0AFB 3A 35 24      [13]  118     ld a, (game_state)
   0AFE C9            [10]  119     ret
                            120 
                            121 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            122 ;;  Sets the current state of the game loop
                            123 ;;  MODIFIES:
                            124 ;;      - A: Returns state
                            125 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   0AFF                     126 man_game_set_state::
   0AFF 32 35 24      [13]  127     ld (game_state), a
   0B02 C9            [10]  128     ret
