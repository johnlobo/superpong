...
Hexadecimal [16-Bits]
                             ...
                             40 
   0000                      41 player1Tpl::
                             42 ;;DefineEntity _cpms, _ptr, _type,           _color, _x, _y, _w, _h, _vxh, _vxl _vyh, _vyl, _sprite, _address, _p_address, _collsion_callback, ai_callback
   0000                      43 DefineEntity e_cmp_paddle, #0000, e_type_player, 15, 10, 80, 1, 30, 0x00, 0x00, 0x00, 0x00, 0x0000, 0x0000, 0x0000, sys_collision_paddle, 0x0000
   27EB 00 00                 1     .dw #0000
   27ED 47                    2     .db e_cmp_paddle
   27EE 01                    3     .db e_type_player
   27EF 0F                    4     .db 15
   27F0 0A 00                 5     .dw 10
   27F2 50 00                 6     .dw 80
   27F4 01                    7     .db 1
   ...
   27FC 00                   15     .db 0x00
   27FD 00                   16     .db 0x00
   27FE 00 00                17     .dw 0x0000
   2800 00 00                18     .dw 0x0000
   2802 00 00                19     .dw 0x0000
   2804 00                   20     .db #0
   2805 14 1F                21     .dw sys_collision_paddle
   2807 00                   22     .db #0
   2808 00 00                23     .dw 0x0000
   280A 01                   24     .db #1           ;; moved 1 default
                             44 
   280B                      45 oponentTpl::
                             46 ;;DefineEntity _cpms, _ptr, _type,           _color, _x, _y, _w, _h, _vxh, _vxl _vyh, _vyl, _sprite, _address, _p_address, _collsion_callback, ai_callback
   0020                      47 DefineEntity e_cmp_oponent_paddle, #0000, e_type_player, 1, 60, 80, 1, 30, 0x00, 0x00, 0x00, 0x00, 0x0000, 0x0000, 0x0000, sys_collision_paddle, sys_ai_paddle
   280B 00 00                 1     .dw #0000
   280D 57                    2     .db e_cmp_oponent_paddle
   280E 01                    3     .db e_type_player
   280F 01                    4     .db 1
   2810 3C 00                 5     .dw 60
   2812 50 00                 6     .dw 80
   2814 01                    7     .db 1
...
Hexadecimal [16-Bits]
   ...
   281C 00                   15     .db 0x00
   281D 00                   16     .db 0x00
   281E 00 00                17     .dw 0x0000
   2820 00 00                18     .dw 0x0000
   2822 00 00                19     .dw 0x0000
   2824 00                   20     .db #0
   2825 14 1F                21     .dw sys_collision_paddle
   2827 00                   22     .db #0
   2828 54 0F                23     .dw sys_ai_paddle
   282A 01                   24     .db #1           ;; moved 1 default
                             48 
   282B                      49 ballTpl:: 
                             50 ;;DefineEntity _cpms, _ptr, _type,       _color, _x, _y, _w, _h, _vxh, _vxl _vyh, _vyl, _sprite, _address, _p_address, _collsion_callback, ai_callback
   0040                      51 DefineEntity e_cpm_ball, #0000, e_type_ball, 2, 58, 80, 2, 4, 0xff, 0xf0, 0x00, 0x01, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000
   282B 00 00                 1     .dw #0000
   282D 87                    2     .db e_cpm_ball
   282E 02                    3     .db e_type_ball
   282F 02                    4     .db 2
   2830 3A 00                 5     .dw 58
   2832 50 00                 6     .dw 80
   2834 02                    7     .db 2
   ...
   283C 00                   15     .db 0x00
   283D 01                   16     .db 0x01
   283E 00 00                17     .dw 0x0000
   2840 00 00                18     .dw 0x0000
   2842 00 00                19     .dw 0x0000
   2844 00                   20     .db #0
   2845 00 00                21     .dw 0x0000
   2847 00                   22     .db #0
   2848 00 00                23     .dw 0x0000
   284A 01                   24     .db #1           ;; moved 1 default
                             52 
   284B                      53 wallUpTpl::
                             54 ;;DefineEntity _cpms, _ptr, _type,             _color, _x, _y, _w, _h, _vxh, _vxl _vyh, _vyl, _sprite, _address, _p_address, _collsion_callback, ai_callback
   0060                      55 DefineEntity e_cmp_border_wall, #0000, e_type_wall, 15, 8, 0, 64, 1, 0x00, 0x00, 0x00, 0x00, 0x0000, 0x0000, 0x0000, sys_collision_wall_up, 0x0000
   284B 00 00                 1     .dw #0000
   284D 43                    2     .db e_cmp_border_wall
   284E 04                    3     .db e_type_wall
   284F 0F                    4     .db 15
   2850 08 00                 5     .dw 8
   2852 00 00                 6     .dw 0
   2854 40                    7     .db 64
...
Hexadecimal [16-Bits]
   ...
   285C 00                   15     .db 0x00
   285D 00                   16     .db 0x00
   285E 00 00                17     .dw 0x0000
   2860 00 00                18     .dw 0x0000
   2862 00 00                19     .dw 0x0000
   2864 00                   20     .db #0
   2865 01 1F                21     .dw sys_collision_wall_up
   2867 00                   22     .db #0
   2868 00 00                23     .dw 0x0000
   286A 01                   24     .db #1           ;; moved 1 default
                             56 
                             57 
   286B 01                   58 game_state:: .db MAIN_MENU   ;; Game state ----- 0: Game loop, 1: Main menu, 2: Map loading, 3: Pause menu, 4: Game over, 5: Victory
                             59 ;;
                             60 ;; Start of _CODE area
                             61 ;; 
                             62 .area _CODE
                             63 
                             64 ;;-----------------------------------------------------------------
                             ...
                             69 ;;  Input: 
                             70 ;;  Output: 
                             71 ;;  Modified: AF, BC, DE, HL
                             72 ;;
   0A61                      73 man_game_init::
                             74 
   0A61 CD 31 09      [17]   75     call man_entity_init
                             76     
                             77     ;; Create a player entity in 100, 100
   0A64 21 EB 27      [10]   78     ld hl, #player1Tpl                      ;; Template of the entity to create
   0A67 CD 9F 09      [17]   79     call man_entity_create                  ;; Create new entity
                             80 
                             81     ;; Create an oponent entity in 140, 100
   0A6A 21 0B 28      [10]   82     ld hl, #oponentTpl                      ;; Template of the entity to create
   0A6D CD 9F 09      [17]   83     call man_entity_create                  ;; Create new entity
                             84 
                             85     ;; Create a ball entity
   0A70 21 2B 28      [10]   86     ld hl, #ballTpl                         ;; Template of the ball
   0A73 CD 9F 09      [17]   87     call man_entity_create                  ;; Create ball
                             88 
                             89     ;; Create a wall up collision entity
   0A76 21 4B 28      [10]   90     ld hl, #wallUpTpl                       ;; Template of the entity to create
   0A79 CD 9F 09      [17]   91     call man_entity_create                  ;; Create new entity
                             92 
                             93     ;; Create a wall down collision entity
   0A7C 21 4B 28      [10]   94     ld hl, #wallUpTpl                       ;; Template of the entity to create
   0A7F CD 9F 09      [17]   95     call man_entity_create                  ;; Create new entity
   0A82 DD 36 07 C7   [19]   96     ld e_y(ix), #199                        ;; down edge
                             97 
...
Hexadecimal [16-Bits]
   ...
   0A86 CD D0 1E      [17]   99     call sys_collision_init                 ;; initialize collision system
   0A89 CD 4B 0F      [17]  100     call sys_ai_init                        ;; initialize collision system
   0A8C CD DC 0A      [17]  101     call sys_physics_init                   ;; initialize physics system
                            102 
                            103 
   002E                     104     BREAKPOINT
   0A8F ED FF                 1   .db #0xed, #0xff
   0A91 01 64 00      [10]  105     ld bc, #100
   0A94 21 B4 00      [10]  106     ld hl, #180
   0A97 AF            [ 4]  107     xor a
   0A98 32 C2 0A      [13]  108     ld (row), a                         ;; init printing row
   0A9B                     109 _loop:
   0A9B C5            [11]  110     push bc                             ;; push index
   0A9C E5            [11]  111     push hl                             ;; push angle
   0A9D CD C7 0E      [17]  112     call sys_util_cosine
   0AA0 E5            [11]  113     push hl                             ;; push sine
                            114 
   0AA1 0E 00         [ 7]  115     ld c, #0
   0AA3 3A C2 0A      [13]  116     ld a, (row)
   0AA6 47            [ 4]  117     ld b, a
   0AA7 C6 08         [ 7]  118     add a, #8
   0AA9 32 C2 0A      [13]  119     ld (row), a
   004B                     120     ld_de_frontbuffer
   0AAC 3A 6E 28      [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
   0AAF 57            [ 4]    2    ld   d, a
   0AB0 1E 00         [ 7]    3    ld   e, #00
   0AB2 CD A7 25      [17]  121     call cpct_getScreenPtr_asm
   0AB5 EB            [ 4]  122     ex de, hl                           ;; move screen address to de
   0AB6 E1            [10]  123     pop hl                              ;; retrieve sine
   0AB7 CD EE 10      [17]  124     call sys_text_draw_small_number     ;; print sine
                            125 
   0ABA E1            [10]  126     pop hl
   0ABB 23            [ 6]  127     inc hl
                            128 
   0ABC C1            [10]  129     pop bc
   0ABD 0B            [ 6]  130     dec bc
   0ABE 78            [ 4]  131     ld a, b
   0ABF B1            [ 4]  132     or c
   0AC0 20 D9         [12]  133     jr nz, _loop
                            134 
   0AC2 00                  135     row: .db 00
                            136    
   0AC3 C9            [10]  137     ret
                            138 
                            139 ;;-----------------------------------------------------------------
                            ...
                            144 ;;  Input: 
                            145 ;;  Output: 
                            146 ;;  Modified: AF, BC, DE, HL
                            147 ;;
   0AC4                     148 man_game_update::
   0AC4 CD DE 20      [17]  149     call sys_input_player_update
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 123.
Hexadecimal [16-Bits]



   0AC7 CD 83 0F      [17]  150     call sys_ai_update
   0ACA CD DB 0B      [17]  151     call sys_physics_update
   0ACD CD AD 1F      [17]  152     call sys_collision_update
   0AD0 CD BD 0C      [17]  153     call sys_render_update
                            154     ;;;;delay 
                            155     ;;ld b, #6
                            156     ;;call cpct_waitHalts_asm
   0AD3 C9            [10]  157     ret
                            158 
                            159 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            160 ;;  Gets the current state of the game loop
                            161 ;;  MODIFIES:
                            162 ;;      - A: Returns state
                            163 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   0AD4                     164 man_game_get_state::
   0AD4 3A 6B 28      [13]  165     ld a, (game_state)
   0AD7 C9            [10]  166     ret
                            167 
                            168 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            169 ;;  Sets the current state of the game loop
                            170 ;;  MODIFIES:
                            171 ;;      - A: Returns state
                            172 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   0AD8                     173 man_game_set_state::
   0AD8 32 6B 28      [13]  174     ld (game_state), a
   0ADB C9            [10]  175     ret
