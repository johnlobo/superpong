...
Hexadecimal [24-Bits]
                                     ...
                                     28 ;; PUBLIC CONSTANTS
                                     29 ;;===============================================================================
                           000000    30 GAME_LOOP == 0
                           000001    31 MAIN_MENU == 1
                           000002    32 MAP_LOAD == 2
                           000003    33 PAUSE_MENU == 3
                           000004    34 GAME_OVER == 4
                           000005    35 VICTORY == 5
                                     36 
                                     37 ;;===============================================================================
                                     38 ;; PUBLIC METHODS
...
Hexadecimal [24-Bits]
                                     ...
                                     31 
                                     32 ;;
                                     33 ;; Start of _DATA area 
                                     34 ;;  SDCC requires at least _DATA and _CODE areas to be declared, but you may use
                                     35 ;;  any one of them for any purpose. Usually, compiler puts _DATA area contents
                                     36 ;;  right after _CODE area contents.
                                     37 ;;
                                     38 .area _DATA
                                     39 
      000000                         40 player1Tpl::
      ...
      000000                         42 DefineEntity e_cmp_paddle, #0000, e_type_player, 15, 10, 80, 1, 30, 0x00, 0x00, 0x00, 0x00, 0x0000, 0x0000, 0x0000, sys_collision_paddle, 0x0000
      002841 00 00                    1     .dw #0000
      002843 47                       2     .db e_cmp_paddle
      002844 01                       3     .db e_type_player
      002845 0F                       4     .db 15
      002846 0A 00                    5     .dw 10
      002848 50 00                    6     .dw 80
      00284A 01                       7     .db 1
      00284B 1E                       8     .db 30
      00284C 0B                       9     .db 10+1
      00284D 6E                      10     .db 80+30
      00284E 00                      11     .db #0
      00284F 00                      12     .db #0
      002850 00                      13     .db 0x00
      002851 00                      14     .db 0x00
      002852 00                      15     .db 0x00
      002853 00                      16     .db 0x00
      002854 00 00                   17     .dw 0x0000
      002856 00 00                   18     .dw 0x0000
      002858 00 00                   19     .dw 0x0000
      00285A 00                      20     .db #0
      00285B DA 0B                   21     .dw sys_collision_paddle
      00285D 00                      22     .db #0
      00285E 00 00                   23     .dw 0x0000
      002860 01                      24     .db #1           ;; moved 1 default
                                     43 
      002861                         44 oponentTpl::
      ...
      000020                         46 DefineEntity e_cmp_oponent_paddle, #0000, e_type_player, 1, 60, 80, 1, 30, 0x00, 0x00, 0x00, 0x00, 0x0000, 0x0000, 0x0000, sys_collision_paddle, sys_ai_paddle
      002861 00 00                    1     .dw #0000
      002863 57                       2     .db e_cmp_oponent_paddle
      002864 01                       3     .db e_type_player
      002865 01                       4     .db 1
      002866 3C 00                    5     .dw 60
      002868 50 00                    6     .dw 80
      00286A 01                       7     .db 1
      00286B 1E                       8     .db 30
      00286C 3D                       9     .db 60+1
      00286D 6E                      10     .db 80+30
      00286E 00                      11     .db #0
      00286F 00                      12     .db #0
      002870 00                      13     .db 0x00
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 119.
Hexadecimal [24-Bits]



      002871 00                      14     .db 0x00
      002872 00                      15     .db 0x00
      002873 00                      16     .db 0x00
      002874 00 00                   17     .dw 0x0000
      002876 00 00                   18     .dw 0x0000
      002878 00 00                   19     .dw 0x0000
      00287A 00                      20     .db #0
      00287B DA 0B                   21     .dw sys_collision_paddle
      00287D 00                      22     .db #0
      00287E 49 0B                   23     .dw sys_ai_paddle
      002880 01                      24     .db #1           ;; moved 1 default
                                     47 
      002881                         48 ballTpl:: 
      ...
      000040                         50 DefineEntity e_cpm_ball, #0000, e_type_ball, 2, 58, 80, 2, 4, 0xff, 0xf0, 0x00, 0x01, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000
      002881 00 00                    1     .dw #0000
      002883 87                       2     .db e_cpm_ball
      002884 02                       3     .db e_type_ball
      002885 02                       4     .db 2
      002886 3A 00                    5     .dw 58
      002888 50 00                    6     .dw 80
      00288A 02                       7     .db 2
      00288B 04                       8     .db 4
      00288C 3C                       9     .db 58+2
      00288D 54                      10     .db 80+4
      00288E 00                      11     .db #0
      00288F 00                      12     .db #0
      002890 FF                      13     .db 0xff
      002891 F0                      14     .db 0xf0
      002892 00                      15     .db 0x00
      002893 01                      16     .db 0x01
      002894 00 00                   17     .dw 0x0000
      002896 00 00                   18     .dw 0x0000
      002898 00 00                   19     .dw 0x0000
      00289A 00                      20     .db #0
      00289B 00 00                   21     .dw 0x0000
      00289D 00                      22     .db #0
      00289E 00 00                   23     .dw 0x0000
      0028A0 01                      24     .db #1           ;; moved 1 default
                                     51 
      0028A1                         52 wallUpTpl::
      ...
      000060                         54 DefineEntity e_cmp_border_wall, #0000, e_type_wall, 15, 8, 0, 64, 1, 0x00, 0x00, 0x00, 0x00, 0x0000, 0x0000, 0x0000, sys_collision_wall_up, 0x0000
      0028A1 00 00                    1     .dw #0000
      0028A3 43                       2     .db e_cmp_border_wall
      0028A4 04                       3     .db e_type_wall
      0028A5 0F                       4     .db 15
      0028A6 08 00                    5     .dw 8
      0028A8 00 00                    6     .dw 0
      0028AA 40                       7     .db 64
...
Hexadecimal [24-Bits]
      ...
      0028B0 00                      13     .db 0x00
      0028B1 00                      14     .db 0x00
      0028B2 00                      15     .db 0x00
      0028B3 00                      16     .db 0x00
      0028B4 00 00                   17     .dw 0x0000
      0028B6 00 00                   18     .dw 0x0000
      0028B8 00 00                   19     .dw 0x0000
      0028BA 00                      20     .db #0
      0028BB C7 0B                   21     .dw sys_collision_wall_up
      0028BD 00                      22     .db #0
      0028BE 00 00                   23     .dw 0x0000
      0028C0 01                      24     .db #1           ;; moved 1 default
                                     55 
                                     56 
      0028C1 01                      57 game_state:: .db MAIN_MENU   ;; Game state ----- 0: Game loop, 1: Main menu, 2: Map loading, 3: Pause menu, 4: Game over, 5: Victory
                                     58 ;;
                                     ...
                                     68 ;;  Input: 
                                     69 ;;  Output: 
                                     70 ;;  Modified: AF, BC, DE, HL
                                     71 ;;
      000A61                         72 man_game_init::
                                     73 
      000A61 CD 2F 09         [17]   74     call man_entity_init
                                     75     
                                     76     ;; Create a player entity in 100, 100
      000A64 21 41 28         [10]   77     ld hl, #player1Tpl                      ;; Template of the entity to create
      000A67 CD 9D 09         [17]   78     call man_entity_create                  ;; Create new entity
                                     79 
                                     80     ;; Create an oponent entity in 140, 100
      000A6A 21 61 28         [10]   81     ld hl, #oponentTpl                      ;; Template of the entity to create
      000A6D CD 9D 09         [17]   82     call man_entity_create                  ;; Create new entity
                                     83 
                                     84     ;; Create a ball entity
      000A70 21 81 28         [10]   85     ld hl, #ballTpl                         ;; Template of the ball
      000A73 CD 9D 09         [17]   86     call man_entity_create                  ;; Create ball
                                     87 
                                     88     ;; Create a wall up collision entity
      000A76 21 A1 28         [10]   89     ld hl, #wallUpTpl                       ;; Template of the entity to create
      000A79 CD 9D 09         [17]   90     call man_entity_create                  ;; Create new entity
                                     91 
                                     92     ;; Create a wall down collision entity
      000A7C 21 A1 28         [10]   93     ld hl, #wallUpTpl                       ;; Template of the entity to create
      000A7F CD 9D 09         [17]   94     call man_entity_create                  ;; Create new entity
      000A82 DD 36 07 C7      [19]   95     ld e_y(ix), #199                        ;; down edge
                                     96 
                                     97     ;; Initialize Systems
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 121.
Hexadecimal [24-Bits]



      000A86 CD 96 0B         [17]   98     call sys_collision_init                 ;; initialize collision system
      000A89 CD 40 0B         [17]   99     call sys_ai_init                        ;; initialize collision system
      000A8C CD EF 1A         [17]  100     call sys_physics_init                   ;; initialize physics system
                                    101 
                                    102 
      00002E                        103     BREAKPOINT
      000A8F ED FF                    1   .db #0xed, #0xff
      000A91 21 00 00         [10]  104     ld hl, #0
      000A94 CD 71 20         [17]  105     call sys_util_sine
      000A97 21 0F 00         [10]  106     ld hl, #15
      000A9A CD 71 20         [17]  107     call sys_util_sine
      000A9D 21 1E 00         [10]  108     ld hl, #30 
      000AA0 CD 71 20         [17]  109     call sys_util_sine
      000AA3 21 2D 00         [10]  110     ld hl, #45
      000AA6 CD 71 20         [17]  111     call sys_util_sine
      000AA9 21 3C 00         [10]  112     ld hl, #60
      000AAC CD 71 20         [17]  113     call sys_util_sine
      000AAF 21 4B 00         [10]  114     ld hl, #75 
      000AB2 CD 71 20         [17]  115     call sys_util_sine   
      000AB5 21 5A 00         [10]  116     ld hl, #90
      000AB8 CD 71 20         [17]  117     call sys_util_sine
      000ABB 21 69 00         [10]  118     ld hl, #105
      000ABE CD 71 20         [17]  119     call sys_util_sine
      000AC1 21 78 00         [10]  120     ld hl, #120
      000AC4 CD 71 20         [17]  121     call sys_util_sine
      000AC7 21 87 00         [10]  122     ld hl, #135
      000ACA CD 71 20         [17]  123     call sys_util_sine
      000ACD 21 96 00         [10]  124     ld hl, #150
      000AD0 CD 71 20         [17]  125     call sys_util_sine
      000AD3 21 A5 00         [10]  126     ld hl, #165
      000AD6 CD 71 20         [17]  127     call sys_util_sine
      000AD9 21 B4 00         [10]  128     ld hl, #180
      000ADC CD 71 20         [17]  129     call sys_util_sine
      000ADF 21 C3 00         [10]  130     ld hl, #195
      000AE2 CD 71 20         [17]  131     call sys_util_sine
      000AE5 21 D2 00         [10]  132     ld hl, #210
      000AE8 CD 71 20         [17]  133     call sys_util_sine
      000AEB 21 E1 00         [10]  134     ld hl, #225
      000AEE CD 71 20         [17]  135     call sys_util_sine
      000AF1 21 F0 00         [10]  136     ld hl, #240
      000AF4 CD 71 20         [17]  137     call sys_util_sine
      000AF7 21 FF 00         [10]  138     ld hl, #255
      000AFA CD 71 20         [17]  139     call sys_util_sine
      000AFD 21 0E 01         [10]  140     ld hl, #270
      000B00 CD 71 20         [17]  141     call sys_util_sine
      000B03 21 1D 01         [10]  142     ld hl, #285
      000B06 CD 71 20         [17]  143     call sys_util_sine
      000B09 21 2C 01         [10]  144     ld hl, #300
      000B0C CD 71 20         [17]  145     call sys_util_sine
      000B0F 21 3B 01         [10]  146     ld hl, #315
      000B12 CD 71 20         [17]  147     call sys_util_sine
      000B15 21 4A 01         [10]  148     ld hl, #330
      000B18 CD 71 20         [17]  149     call sys_util_sine
      000B1B 21 59 01         [10]  150     ld hl, #345
      000B1E CD 71 20         [17]  151     call sys_util_sine
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 122.
Hexadecimal [24-Bits]



      000B21 21 68 01         [10]  152     ld hl, #360
      000B24 CD 71 20         [17]  153     call sys_util_sine
      000B27 C9               [10]  154     ret
                                    155 
                                    156 ;;-----------------------------------------------------------------
                                    157 ;;
                                    158 ;; man_game_update
                                    ...
                                    161 ;;  Input: 
                                    162 ;;  Output: 
                                    163 ;;  Modified: AF, BC, DE, HL
                                    164 ;;
      000B28                        165 man_game_update::
      000B28 CD A4 0D         [17]  166     call sys_input_player_update
      000B2B CD 78 0B         [17]  167     call sys_ai_update
      000B2E CD EE 1B         [17]  168     call sys_physics_update
      000B31 CD 73 0C         [17]  169     call sys_collision_update
      000B34 CD D0 1C         [17]  170     call sys_render_update
                                    171     ;;;;delay 
                                    172     ;;ld b, #6
                                    173     ;;call cpct_waitHalts_asm
      000B37 C9               [10]  174     ret
                                    175 
                                    176 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    177 ;;  Gets the current state of the game loop
                                    178 ;;  MODIFIES:
                                    179 ;;      - A: Returns state
                                    180 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
      000B38                        181 man_game_get_state::
      000B38 3A C1 28         [13]  182     ld a, (game_state)
      000B3B C9               [10]  183     ret
                                    184 
                                    185 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    186 ;;  Sets the current state of the game loop
                                    187 ;;  MODIFIES:
                                    188 ;;      - A: Returns state
                                    189 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
      000B3C                        190 man_game_set_state::
      000B3C 32 C1 28         [13]  191     ld (game_state), a
      000B3F C9               [10]  192     ret
