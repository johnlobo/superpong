...
Hexadecimal [24-Bits]
                                     ...
                                     35 .area _DATA
                                     36 
      000000                         37 player1Tpl::
      000000                         38 DefineEntity e_cmp_default, #0000, e_type_player, 15, 10, 80, 1, 20, 0, 0, #0000, #0000, #0000, 1, 0, #0000, 0
      0023D5 00 00                    1     .dw #0000
      0023D7 47                       2     .db e_cmp_default
      0023D8 01                       3     .db e_type_player
      0023D9 0F                       4     .db 15
      0023DA 0A 00                    5     .dw 10
      0023DC 50 00                    6     .dw 80
      0023DE 01                       7     .db 1
      0023DF 14                       8     .db 20
      0023E0 0B                       9     .db 10+1
      0023E1 64                      10     .db 80+20
      0023E2 00                      11     .db #0
      0023E3 00                      12     .db #0
      0023E4 00 00                   13     .dw 0
      0023E6 00 00                   14     .dw 0
      0023E8 00 00                   15     .dw #0000
      0023EA 00 00                   16     .dw #0000
      0023EC 00 00                   17     .dw #0000
      0023EE 01                      18     .db #1           ;; moved 1 default
      0023EF 01                      19     .db 1
      0023F0 00                      20     .db 0 ;; 0: right, 1:left
      0023F1 00                      21     .db #0           ;; dashing
      0023F2 00 00                   22     .dw #0000
      0023F4 00                      23     .db 0
                                     39 
      0023F5 01                      40 game_state:: .db MAIN_MENU   ;; Game state ----- 0: Game loop, 1: Main menu, 2: Map loading, 3: Pause menu, 4: Game over, 5: Victory
                                     41 ;;
                                     ...
                                     54 ;;
      000AB5                         55 man_game_init::
                                     56 
      000AB5 CD D4 09         [17]   57     call man_entity_init
...
Hexadecimal [24-Bits]
      ...
      000AB8 21 D5 23         [10]   60     ld hl, #player1Tpl                  ;; Template of the entity to create
      000ABB CD 42 0A         [17]   61     call man_entity_create              ;; Create new entity
                                     62 
                                     63     ;; Create an entity in 140, 100
      000ABE 21 D5 23         [10]   64     ld hl, #player1Tpl                  ;; Template of the entity to create
      000AC1 CD 42 0A         [17]   65     call man_entity_create              ;; Create new entity
      000AC4 DD 36 05 3C      [19]   66     ld e_x(ix), #60                     ;; x = 60
      000AC8 DD 36 04 01      [19]   67     ld e_color(ix), #1                  ;; color = pink 
                                     68 
      000ACC CD 87 19         [17]   69     call sys_physics_init               ;; initilize physics system
                                     70     
      000ACF C9               [10]   71     ret
                                     72 
                                     73 ;;-----------------------------------------------------------------
                                     ...
                                     78 ;;  Input: 
                                     79 ;;  Output: 
                                     80 ;;  Modified: AF, BC, DE, HL
                                     81 ;;
      000AD0                         82 man_game_update::
      000AD0 CD 3C 0C         [17]   83     call sys_input_player_update
                                     84 
      000AD3 CD 8A 0A         [17]   85     call man_entity_getPlayerPosition
      000AD6 CD 8F 0A         [17]   86     call man_entity_getOponentPosition
                                     87 
                                     88     ;; Copy player movements on Oponent
      000AD9 DD 7E 0F         [19]   89     ld a, e_vx(ix)
      000ADC FD 77 0F         [19]   90     ld e_vx(iy), a
      000ADF DD 7E 10         [19]   91     ld a, e_vx+1(ix)
      000AE2 FD 77 10         [19]   92     ld e_vx+1(iy), a
                                     93 
      000AE5 DD 7E 11         [19]   94     ld a, e_vy(ix)
      000AE8 FD 77 11         [19]   95     ld e_vy(iy), a
      000AEB DD 7E 12         [19]   96     ld a, e_vy+1(ix)
      000AEE FD 77 12         [19]   97     ld e_vy+1(iy), a
                                     98     ;; -----------------------------
      000AF1                         99 _exit_clone_input:
                                    100 
      000AF1 CD 3B 1A         [17]  101     call sys_physics_update
      000AF4 CD 27 1B         [17]  102     call sys_render_update
      000AF7 CD 3C 1B         [17]  103     call sys_render_debug_entity
                                    104     ;;delay 
                                    105     ;;ld b, #10
                                    106     ;;call cpct_waitHalts_asm
      000AFA C9               [10]  107     ret
                                    108 
                                    109 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    110 ;;  Gets the current state of the game loop
                                    111 ;;  MODIFIES:
                                    112 ;;      - A: Returns state
...
Hexadecimal [24-Bits]
                                    ...
                                    113 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
      000AFB                        114 man_game_get_state::
      000AFB 3A F5 23         [13]  115     ld a, (game_state)
      000AFE C9               [10]  116     ret
                                    117 
                                    118 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    119 ;;  Sets the current state of the game loop
                                    120 ;;  MODIFIES:
                                    121 ;;      - A: Returns state
                                    122 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
      000AFF                        123 man_game_set_state::
      000AFF 32 F5 23         [13]  124     ld (game_state), a
      000B02 C9               [10]  125     ret
