...
Hexadecimal [16-Bits]
                             ...
                             41 ;; sys_physics_init
                             42 ;;
                             43 ;;  Initilizes render system
                             44 ;;  Input: 
                             45 ;;  Output: 
                             46 ;;  Modified: AF, BC, DE, HL
                             47 ;;
   0000                      48 sys_collision_init::
                             49     ;; set pointer array address 
   1CD4 3E 04         [ 7]   50     ld a, #e_cmpID_Collision
   1CD6 CD 9A 06      [17]   51     call man_components_getArrayHL
   1CD9 22 DF 1C      [16]   52     ld  (_ent_array_ptr), hl
   1CDC C9            [10]   53     ret
                             54 
                             55 ;;-----------------------------------------------------------------
                             56 ;;
                             57 ;; sys_collision_update_one_entity
                             58 ;;
                             59 ;;  Initilizes render system
                             60 ;;  Input: ix : pointer to the entity
                             61 ;;  Output: 
                             62 ;;  Modified: AF, BC, HL
                             63 ;;
   1CDD                      64 sys_collision_update_one_entity::
   1CDD C9            [10]   65     ret
                             66 
                             67 ;;-----------------------------------------------------------------
                             68 ;;
                             69 ;; sys_collision_update
                             70 ;;
                             71 ;;  Initilizes collision system
                             72 ;;  Input: 
                             73 ;;  Output: 
                             74 ;;  Modified: AF, BC, DE, HL
                             75 ;;
                             76 
...
Hexadecimal [16-Bits]
   ...
   1CDE                      77 sys_collision_update::
                             78 
                     000B    79 _ent_array_ptr = . + 1
   1CDE 21 00 00      [10]   80     ld  hl, #0x0000
                             81 
   1CE1                      82     _loop:
                             83     ;;  Select the pointer to the entity with collision and prepare the next position for the next iteration.
   1CE1 5E            [ 7]   84     ld e, (hl)
   1CE2 23            [ 6]   85     inc hl
   1CE3 56            [ 7]   86     ld d, (hl)
   1CE4 23            [ 6]   87     inc hl
                             88 
                             89     ;;  The entities are finished traversing when find a pointer to null.
   1CE5 7B            [ 4]   90     ld a, e
   1CE6 B2            [ 4]   91     or d
   1CE7 C8            [11]   92     ret z
                             93 
   1CE8 E5            [11]   94     push hl
                             95 
   0015                      96     ld__ixl_e
   1CE9 DD 6B                 1    .dw #0x6BDD  ;; Opcode for ld ixl, e
   0017                      97     ld__ixh_d
   1CEB DD 62                 1    .dw #0x62DD  ;; Opcode for ld ixh, d
                             98 
   1CED CD DD 1C      [17]   99     call sys_collision_update_one_entity
                            100 
   1CF0 E1            [10]  101 	pop hl
                            102 
   1CF1 18 EE         [12]  103     jr _loop
                            104 
   1CF3 C9            [10]  105     ret
