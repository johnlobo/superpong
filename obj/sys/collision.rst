...
Hexadecimal [16-Bits]
   ...
   1BCB 3E 04         [ 7]   52     ld a, #e_cmpID_Collision
   1BCD CD 9A 06      [17]   53     call man_components_getArrayHL
   1BD0 22 B6 1C      [16]   54     ld  (_ent_array_ptr), hl
   1BD3 C9            [10]   55     ret
                             56 
                             57 
                             58 ;;-----------------------------------------------------------------
   ...
   1BD4                      69 sys_collision_check_collider_colisionable_Y::
                             70     ;; y axis collision
                             71     ;; case 3
   1BD4 FD 7E 07      [19]   72     ld a, e_y(iy)                   ;; a = iy.y
   1BD7 47            [ 4]   73     ld b, a                         ;; b = a = iy.y
   1BD8 FD 86 0A      [19]   74     add e_h(iy)                     ;; a = iy.y + iy.y
   1BDB 3D            [ 4]   75     dec a                           ;; a = iy.y + iy.y - 1
   1BDC DD 4E 07      [19]   76     ld c, e_y(ix)                   ;; c = ix.y
   1BDF 91            [ 4]   77     sub c                           ;; a = iy.y + iy.y - 1 - ix.y
   1BE0 D8            [11]   78     ret c                           ;; return if no collision
...
Hexadecimal [16-Bits]
                             ...
                             79     ;; case 4
   1BE1 79            [ 4]   80     ld a, c                         ;; a = ix.y
   1BE2 DD 86 0A      [19]   81     add e_h(ix)                     ;; a = ix.y + ix.y
   1BE5 3D            [ 4]   82     dec a                           ;; a = ix.y + ix.y - 1
   1BE6 90            [ 4]   83     sub b                           ;; a = iy.y + ix.y - 1 - iy.y
   ...
   1BE8                      98 sys_collision_check_collider_colisionable_X::
                             99     ;; x axis collision
                            100     ;; case 1
   1BE8 FD 7E 05      [19]  101     ld a, e_x(iy)                   ;; a = iy.x
   1BEB 47            [ 4]  102     ld b, a                         ;; b = a = iy.x
   1BEC FD 86 09      [19]  103     add e_w(iy)                     ;; a = iy.x + iy.w
   1BEF 3D            [ 4]  104     dec a                           ;; a = iy.x + iy.w - 1
   1BF0 DD 4E 05      [19]  105     ld c, e_x(ix)                   ;; c = ix.x
   1BF3 91            [ 4]  106     sub c                           ;; a = iy.x + iy.w - 1 - ix.x
   1BF4 D8            [11]  107     ret c                           ;; return if no collision
                            108     ;; case 2
   1BF5 79            [ 4]  109     ld a, c                         ;; a = ix.x
   1BF6 DD 86 09      [19]  110     add e_w(ix)                     ;; a = ix.x + ix.w
   1BF9 3D            [ 4]  111     dec a                           ;; a = ix.x + ix.w - 1
   1BFA 90            [ 4]  112     sub b                           ;; a = iy.x + ix.w - 1 - iy.x
   1BFB C9            [10]  113     ret
                            114 
                            115 ;;-----------------------------------------------------------------
                            116 ;;
                            117 ;; sys_collision_paddle
                            118 ;;
                            119 ;;  Handles the collision with the paddle
                            120 ;;  Input:  ix : pointer to the entity
                            121 ;;          iy: pointer to the colisionable
                            122 ;;  Output: 
                            123 ;;  Modified: AF, BC, HL
                            124 ;;
   1BFC                     125 sys_collision_paddle::
                            126     ;; reposition colisionable after the collision
   1BFC DD 7E 19      [19]  127     ld a, e_collision_status(ix)
   1BFF E6 01         [ 7]  128     and #e_col_left
   1C01 20 05         [12]  129     jr nz, _left_collision
   1C03 FD 34 05      [23]  130     inc e_x(iy)                     ;;reposition ball to the right to avoid overlap
   1C06 18 03         [12]  131     jr _reverse_horizontal_speed
   1C08                     132 _left_collision:
   1C08 FD 35 05      [23]  133     dec e_x(iy)                     ;; reposition ball to the left to avoid overlap
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 111.
Hexadecimal [16-Bits]



                            134     ;; change speed because of the collision
   1C0B                     135 _reverse_horizontal_speed:
   1C0B FD 66 0F      [19]  136     ld h, e_vx(iy)
   1C0E FD 6E 10      [19]  137     ld l, e_vx+1(iy)
   1C11 CD 95 0C      [17]  138     call sys_util_negHL
   1C14 FD 74 0F      [19]  139     ld e_vx(iy), h
   1C17 FD 75 10      [19]  140     ld e_vx+1(iy), l
                            141     ;; change vertical speed
   1C1A DD 46 07      [19]  142     ld b, e_y(ix)
   1C1D FD 7E 07      [19]  143     ld a, e_y(iy)
   1C20 90            [ 4]  144     sub b
   1C21 FE 06         [ 7]  145     cp #6
   1C23 30 0A         [12]  146     jr nc, _greater_than_6
   1C25 FD 36 11 FF   [19]  147     ld e_vy(iy), #0xff
   1C29 FD 36 12 E0   [19]  148     ld e_vy+1(iy), #0xe0
   1C2D 18 3F         [12]  149     jr _scp_exit
   1C2F                     150 _greater_than_6:
   1C2F FE 0C         [ 7]  151     cp #12
   1C31 30 0A         [12]  152     jr nc, _greater_than_12
   1C33 FD 36 11 FF   [19]  153     ld e_vy(iy), #0xff
   1C37 FD 36 12 F0   [19]  154     ld e_vy+1(iy), #0xf0
   1C3B 18 31         [12]  155     jr _scp_exit
   1C3D                     156 _greater_than_12:
   1C3D FE 12         [ 7]  157     cp #18
   1C3F 30 17         [12]  158     jr nc, _greater_than_18
   1C41 FD 36 11 00   [19]  159     ld e_vy(iy), #0x00
   1C45 FD 36 12 16   [19]  160     ld e_vy+1(iy), #0x16
   1C49 FD 66 0F      [19]  161     ld h, e_vx(iy)
   1C4C FD 6E 0F      [19]  162     ld l, e_vx(iy)
   1C4F 29            [11]  163     add hl, hl
   1C50 FD 74 0F      [19]  164     ld e_vx(iy), h
   1C53 FD 75 0F      [19]  165     ld e_vx(iy), l
   1C56 18 16         [12]  166     jr _scp_exit
   1C58                     167 _greater_than_18:
   1C58 FE 18         [ 7]  168     cp #24
   1C5A 30 0A         [12]  169     jr nc, _greater_than_24
   1C5C FD 36 11 00   [19]  170     ld e_vy(iy), #0x00
   1C60 FD 36 12 32   [19]  171     ld e_vy+1(iy), #0x32
   1C64 18 08         [12]  172     jr _scp_exit
   1C66                     173 _greater_than_24:
   1C66 FD 36 11 00   [19]  174     ld e_vy(iy), #0x00
   1C6A FD 36 12 33   [19]  175     ld e_vy+1(iy), #0x33
   1C6E                     176 _scp_exit:
   1C6E FD 36 1C 01   [19]  177     ld e_moved(iy), #1
   1C72 C9            [10]  178     ret
                            179 
                            180 ;;-----------------------------------------------------------------
                            181 ;;
                            182 ;; sys_collision_update_one_entity
                            183 ;;
                            184 ;;  Initilizes render system
                            185 ;;  Input: ix : pointer to the entity
                            186 ;;  Output: 
                            187 ;;  Modified: AF, BC, HL
                            188 ;;
...
Hexadecimal [16-Bits]
   ...
   1C73                     189 sys_collision_collider_colisionable::
                            190 
   1C73 CD E8 1B      [17]  191     call sys_collision_check_collider_colisionable_X  ;; check if there is a horizontal collision
   1C76 D8            [11]  192     ret c
                            193     ;; calculate horizontal collision status
                            194 
   1C77 FD 7E 0F      [19]  195     ld a, e_vx(iy)
   1C7A CB 7F         [ 8]  196     bit 7, a
   1C7C 20 06         [12]  197     jr nz, _sccc_right
   1C7E DD 36 19 01   [19]  198     ld e_collision_status(ix), #e_col_left
   1C82 18 04         [12]  199     jr _sccc_vertical_check
   1C84                     200 _sccc_right:
   1C84 DD 36 19 02   [19]  201     ld e_collision_status(ix), #e_col_right
   1C88                     202 _sccc_vertical_check:
   1C88 CD D4 1B      [17]  203     call sys_collision_check_collider_colisionable_Y  ;; check if there is a collision
   1C8B D8            [11]  204     ret c
                            205     ;; calculate vertical collision status
   1C8C FD 7E 11      [19]  206     ld a, e_vy(iy)
   1C8F CB 7F         [ 8]  207     bit 7, a
   1C91 28 0A         [12]  208     jr z, _sccc_down
   1C93 DD 7E 19      [19]  209     ld a, e_collision_status(ix)
   1C96 F6 04         [ 7]  210     or #e_col_up
   1C98 DD 77 19      [19]  211     ld e_collision_status(ix), a
   1C9B 18 08         [12]  212     jr _sccc_exit
   1C9D                     213 _sccc_down:
   1C9D DD 7E 19      [19]  214     ld a, e_collision_status(ix)
   1CA0 F6 08         [ 7]  215     or #e_col_down
   1CA2 DD 77 19      [19]  216     ld e_collision_status(ix), a
   1CA5                     217 _sccc_exit:
   1CA5 DD 6E 1A      [19]  218     ld l, e_collision_callback(ix)
   1CA8 DD 66 1B      [19]  219     ld h, e_collision_callback+1(ix)
   1CAB E9            [ 4]  220     jp (hl)
                            221     ;;ret               ;; tail recursion
                            222 
                            223 
                            224 
                            225 ;;-----------------------------------------------------------------
                            226 ;;
                            227 ;; sys_collision_update_one_entity
                            228 ;;
                            229 ;;  Initilizes render system
                            230 ;;  Input: ix : pointer to the entity
                            231 ;;  Output: 
                            232 ;;  Modified: AF, BC, HL
                            233 ;;
   1CAC                     234 sys_collision_update_one_collider::
   1CAC 21 73 1C      [10]  235     ld hl, #sys_collision_collider_colisionable
   1CAF 06 80         [ 7]  236     ld b, #e_cmp_collisionable
   1CB1 CD 89 09      [17]  237     call man_entity_forall_matching_iy
   1CB4 C9            [10]  238     ret
                            239 
                            240 ;;-----------------------------------------------------------------
                            241 ;;
                            242 ;; sys_collision_update
                            243 ;;
...
Hexadecimal [16-Bits]
                            ...
                            244 ;;  Initilizes collision system
                            245 ;;  Input: 
                            246 ;;  Output: 
                            247 ;;  Modified: AF, BC, DE, HL
                            248 ;;
                            249 
   1CB5                     250 sys_collision_update::
                            251 
                     00EB   252 _ent_array_ptr = . + 1
   1CB5 21 00 00      [10]  253     ld  hl, #0x0000
                            254 
   1CB8                     255     _loop:
                            256     ;;  Select the pointer to the entity with collision and prepare the next position for the next iteration.
   1CB8 5E            [ 7]  257     ld e, (hl)
   1CB9 23            [ 6]  258     inc hl
   1CBA 56            [ 7]  259     ld d, (hl)
   1CBB 23            [ 6]  260     inc hl
                            261 
                            262     ;;  The entities are finished traversing when find a pointer to null.
   1CBC 7B            [ 4]  263     ld a, e
   1CBD B2            [ 4]  264     or d
   1CBE C8            [11]  265     ret z
                            266 
   1CBF E5            [11]  267     push hl
                            268 
   00F5                     269     ld__ixl_e
   1CC0 DD 6B                 1    .dw #0x6BDD  ;; Opcode for ld ixl, e
   00F7                     270     ld__ixh_d
   1CC2 DD 62                 1    .dw #0x62DD  ;; Opcode for ld ixh, d
                            271 
   1CC4 CD AC 1C      [17]  272     call sys_collision_update_one_collider
                            273 
   1CC7 E1            [10]  274 	pop hl
                            275 
   1CC8 18 EE         [12]  276     jr _loop
                            277 
   1CCA C9            [10]  278     ret
