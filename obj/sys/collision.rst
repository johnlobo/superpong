...
Hexadecimal [16-Bits]
   ...
   1DFE 3E 04         [ 7]   54     ld a, #e_cmpID_Collision
   1E00 CD 9A 06      [17]   55     call man_components_getArrayHL
   1E03 22 DC 1E      [16]   56     ld  (_ent_array_ptr), hl
   1E06 C9            [10]   57     ret
                             58 
                             59 
                             60 ;;-----------------------------------------------------------------
   ...
   1E07                      71 sys_collision_check_collider_colisionable_Y::
                             72     ;; y axis collision
                             73     ;; case 3
   1E07 FD 7E 07      [19]   74     ld a, e_y(iy)                   ;; a = iy.y
   1E0A 47            [ 4]   75     ld b, a                         ;; b = a = iy.y
   1E0B FD 86 0A      [19]   76     add e_h(iy)                     ;; a = iy.y + iy.y
   1E0E 3D            [ 4]   77     dec a                           ;; a = iy.y + iy.y - 1
   1E0F DD 4E 07      [19]   78     ld c, e_y(ix)                   ;; c = ix.y
   1E12 91            [ 4]   79     sub c                           ;; a = iy.y + iy.y - 1 - ix.y
   1E13 D8            [11]   80     ret c                           ;; return if no collision
...
Hexadecimal [16-Bits]
                             ...
                             81     ;; case 4
   1E14 79            [ 4]   82     ld a, c                         ;; a = ix.y
   1E15 DD 86 0A      [19]   83     add e_h(ix)                     ;; a = ix.y + ix.y
   1E18 3D            [ 4]   84     dec a                           ;; a = ix.y + ix.y - 1
   1E19 90            [ 4]   85     sub b                           ;; a = iy.y + ix.y - 1 - iy.y
   ...
   1E1B                     100 sys_collision_check_collider_colisionable_X::
                            101     ;; x axis collision
                            102     ;; case 1
   1E1B FD 7E 05      [19]  103     ld a, e_x(iy)                   ;; a = iy.x
   1E1E 47            [ 4]  104     ld b, a                         ;; b = a = iy.x
   1E1F FD 86 09      [19]  105     add e_w(iy)                     ;; a = iy.x + iy.w
   1E22 3D            [ 4]  106     dec a                           ;; a = iy.x + iy.w - 1
   1E23 DD 4E 05      [19]  107     ld c, e_x(ix)                   ;; c = ix.x
   1E26 91            [ 4]  108     sub c                           ;; a = iy.x + iy.w - 1 - ix.x
   1E27 D8            [11]  109     ret c                           ;; return if no collision
                            110     ;; case 2
   1E28 79            [ 4]  111     ld a, c                         ;; a = ix.x
   1E29 DD 86 09      [19]  112     add e_w(ix)                     ;; a = ix.x + ix.w
   1E2C 3D            [ 4]  113     dec a                           ;; a = ix.x + ix.w - 1
   1E2D 90            [ 4]  114     sub b                           ;; a = iy.x + ix.w - 1 - iy.x
   1E2E C9            [10]  115     ret
                            116 
                            117 
                            118 
                            ...
                            128 ;;
   1E2F                     129 sys_collision_wall_up::
                            130     ;; reposition colisionable after the collision
   1E2F DD 7E 19      [19]  131     ld a, e_collision_status(ix)
   1E32 E6 08         [ 7]  132     and #e_col_down
   1E34 20 05         [12]  133     jr nz, _scwu_down_collision
   1E36 FD 34 07      [23]  134     inc e_y(iy)                     ;;reposition ball to the right to avoid overlap
   1E39 18 03         [12]  135     jr _reverse_vertical_speed
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 113.
Hexadecimal [16-Bits]



   1E3B                     136 _scwu_down_collision:
   1E3B FD 35 07      [23]  137     dec e_y(iy)                     ;; reposition ball to the left to avoid overlap
   1E3E                     138 _reverse_vertical_speed:
                            139     ;; change speed because of the collision
   1E3E CD 4D 08      [17]  140     call man_ball_reverse_ver_speed
   1E41 C9            [10]  141     ret
                            142 
                            143 ;;-----------------------------------------------------------------
                            144 ;;
                            ...
                            152 ;;
   1E42                     153 sys_collision_paddle::
                            154     ;; reposition colisionable after the collision
   1E42 DD 7E 19      [19]  155     ld a, e_collision_status(ix)
   1E45 E6 01         [ 7]  156     and #e_col_left
   1E47 20 05         [12]  157     jr nz, _left_collision
   1E49 FD 34 05      [23]  158     inc e_x(iy)                         ;;reposition ball to the right to avoid overlap
   1E4C 18 03         [12]  159     jr _reverse_horizontal_speed
   1E4E                     160 _left_collision:
   1E4E FD 35 05      [23]  161     dec e_x(iy)                         ;; reposition ball to the left to avoid overlap
                            162     ;; change speed because of the collision
   1E51                     163 _reverse_horizontal_speed:
   1E51 CD 36 08      [17]  164     call man_ball_reverse_hor_speed     ;; Reverse horizontal ball speed
                            165     ;; change vertical speed
   1E54 DD 46 07      [19]  166     ld b, e_y(ix)
   1E57 FD 7E 07      [19]  167     ld a, e_y(iy)
   1E5A 90            [ 4]  168     sub b
   1E5B FE 06         [ 7]  169     cp #6
   1E5D 30 06         [12]  170     jr nc, _greater_than_6
   1E5F AF            [ 4]  171     xor a
   1E60 CD 8F 08      [17]  172     call man_ball_set_ver_speed
   1E63 18 2F         [12]  173     jr _scp_exit
   1E65                     174 _greater_than_6:
   1E65 FE 0E         [ 7]  175     cp #14
   1E67 30 07         [12]  176     jr nc, _greater_than_14
   1E69 3E 01         [ 7]  177     ld a, #1
   1E6B CD 8F 08      [17]  178     call man_ball_set_ver_speed
   1E6E 18 24         [12]  179     jr _scp_exit
   1E70                     180 _greater_than_14:
   1E70 FE 10         [ 7]  181     cp #16
   1E72 30 0A         [12]  182     jr nc, _greater_than_16
   1E74 3E 02         [ 7]  183     ld a, #2
   1E76 CD 8F 08      [17]  184     call man_ball_set_ver_speed
   1E79 CD 64 08      [17]  185     call man_ball_increase_hor_speed
   1E7C 18 16         [12]  186     jr _scp_exit
   1E7E                     187 _greater_than_16:
   1E7E FE 18         [ 7]  188     cp #24
   1E80 30 0A         [12]  189     jr nc, _greater_than_24
   1E82 FD 36 11 00   [19]  190     ld e_vy(iy), #0x00
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 114.
Hexadecimal [16-Bits]



   1E86 FD 36 12 32   [19]  191     ld e_vy+1(iy), #0x32
   1E8A 18 08         [12]  192     jr _scp_exit
   1E8C                     193 _greater_than_24:
   1E8C FD 36 11 00   [19]  194     ld e_vy(iy), #0x00
   1E90 FD 36 12 33   [19]  195     ld e_vy+1(iy), #0x33
   1E94                     196 _scp_exit:
   1E94 FD 36 1F 01   [19]  197     ld e_moved(iy), #1
   1E98 C9            [10]  198     ret
                            199 
                            200 ;;-----------------------------------------------------------------
                            201 ;;
                            ...
                            208 ;;
   1E99                     209 sys_collision_collider_colisionable::
                            210 
   1E99 CD 1B 1E      [17]  211     call sys_collision_check_collider_colisionable_X  ;; check if there is a horizontal collision
   1E9C D8            [11]  212     ret c
                            213     ;; calculate horizontal collision status
                            214 
   1E9D FD 7E 0F      [19]  215     ld a, e_vx(iy)
   1EA0 CB 7F         [ 8]  216     bit 7, a
   1EA2 20 06         [12]  217     jr nz, _sccc_right
   1EA4 DD 36 19 01   [19]  218     ld e_collision_status(ix), #e_col_left
   1EA8 18 04         [12]  219     jr _sccc_vertical_check
   1EAA                     220 _sccc_right:
   1EAA DD 36 19 02   [19]  221     ld e_collision_status(ix), #e_col_right
   1EAE                     222 _sccc_vertical_check:
   1EAE CD 07 1E      [17]  223     call sys_collision_check_collider_colisionable_Y  ;; check if there is a collision
   1EB1 D8            [11]  224     ret c
                            225     ;; calculate vertical collision status
   1EB2 FD 7E 11      [19]  226     ld a, e_vy(iy)
   1EB5 CB 7F         [ 8]  227     bit 7, a
   1EB7 28 0A         [12]  228     jr z, _sccc_down
   1EB9 DD 7E 19      [19]  229     ld a, e_collision_status(ix)
   1EBC F6 04         [ 7]  230     or #e_col_up
   1EBE DD 77 19      [19]  231     ld e_collision_status(ix), a
   1EC1 18 08         [12]  232     jr _sccc_exit
   1EC3                     233 _sccc_down:
   1EC3 DD 7E 19      [19]  234     ld a, e_collision_status(ix)
   1EC6 F6 08         [ 7]  235     or #e_col_down
   1EC8 DD 77 19      [19]  236     ld e_collision_status(ix), a
   1ECB                     237 _sccc_exit:
   1ECB DD 6E 1A      [19]  238     ld l, e_collision_callback(ix)
   1ECE DD 66 1B      [19]  239     ld h, e_collision_callback+1(ix)
   1ED1 E9            [ 4]  240     jp (hl)
...
Hexadecimal [16-Bits]
                            ...
                            253 ;;
   1ED2                     254 sys_collision_update_one_collider::
   1ED2 21 99 1E      [10]  255     ld hl, #sys_collision_collider_colisionable
   1ED5 06 80         [ 7]  256     ld b, #e_cmp_collisionable
   1ED7 CD 39 0A      [17]  257     call man_entity_forall_matching_iy
   1EDA C9            [10]  258     ret
                            259 
                            260 ;;-----------------------------------------------------------------
                            261 ;;
                            ...
                            268 ;;
                            269 
   1EDB                     270 sys_collision_update::
                            271 
                     00DE   272 _ent_array_ptr = . + 1
   1EDB 21 00 00      [10]  273     ld  hl, #0x0000
                            274 
   1EDE                     275     _loop:
                            276     ;;  Select the pointer to the entity with collision and prepare the next position for the next iteration.
   1EDE 5E            [ 7]  277     ld e, (hl)
   1EDF 23            [ 6]  278     inc hl
   1EE0 56            [ 7]  279     ld d, (hl)
   1EE1 23            [ 6]  280     inc hl
                            281 
                            282     ;;  The entities are finished traversing when find a pointer to null.
   1EE2 7B            [ 4]  283     ld a, e
   1EE3 B2            [ 4]  284     or d
   1EE4 C8            [11]  285     ret z
                            286 
   1EE5 E5            [11]  287     push hl
                            288 
   00E8                     289     ld__ixl_e
   1EE6 DD 6B                 1    .dw #0x6BDD  ;; Opcode for ld ixl, e
   00EA                     290     ld__ixh_d
   1EE8 DD 62                 1    .dw #0x62DD  ;; Opcode for ld ixh, d
                            291 
   1EEA CD D2 1E      [17]  292     call sys_collision_update_one_collider
                            293 
   1EED E1            [10]  294 	pop hl
                            295 
   1EEE 18 EE         [12]  296     jr _loop
                            297 
   1EF0 C9            [10]  298     ret
