...
Hexadecimal [24-Bits]
                                     ...
                                     33 
                                     34 
      000000                         35 sys_input_main_menu_actions::
      ...
      0023F6 00 00                   48     .dw 0
                                     49 
      0023F8                         50 sys_input_player_actions::
      0023F8 04 04 7E 0B             51     .dw Key_O,      sys_input_player_left
      0023FC 03 08 A7 0B             52     .dw Key_P,      sys_input_player_right
      002400 05 80 20 0C             53     .dw Key_Space,  sys_input_player_jump
      002404 08 08 CF 0B             54     .dw Key_Q,      sys_input_player_up
      002408 08 20 F8 0B             55     .dw Key_A,      sys_input_player_down
...
Hexadecimal [24-Bits]
      ...
      000B03                         79 sys_input_clean_buffer::
      000B03 CD 09 21         [17]   80     call cpct_isAnyKeyPressed_asm
      000B06 20 FB            [12]   81     jr nz, sys_input_clean_buffer
      000B08 C9               [10]   82     ret
                                     83 
                                     84 ;;-----------------------------------------------------------------
                                     85 ;;
                                     ...
                                     91 ;;  Modified: 
                                     92 ;;
      000B09                         93 sys_input_wait4anykey::
      000B09 21 00 00         [10]   94     ld hl, #0
      000B0C                         95 _siw_loop:
      000B0C E5               [11]   96     push hl
      000B0D CD 09 21         [17]   97     call cpct_isAnyKeyPressed_asm
      000B10 B7               [ 4]   98     or a
      000B11 E1               [10]   99     pop hl
      000B12 23               [ 6]  100     inc hl
      000B13 28 F7            [12]  101     jr z, _siw_loop
      000B15 E5               [11]  102     push hl
      000B16 CD 03 0B         [17]  103     call sys_input_clean_buffer
      000B19 E1               [10]  104     pop hl
      000B1A C9               [10]  105     ret
                                    106 
                                    107 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    108 ;; DESCRIPTION
                                    109 ;; Gets the ID of the FIRST key pressed found on the key
                                    110 ;; buffer
                                    111 ;; ----------------------------------------------------
                                    112 ;; PARAMS
                                    113 ;; ----------------------------------------------------
                                    114 ;; RETURNS
                                    115 ;; HL: Key pressed if anyone pressed. If not returns 0
                                    116 ;; ----------------------------------------------------
                                    117 ;; DESTROYS
                                    118 ;; AF, HL
                                    119 ;; ----------------------------------------------------
                                    120 ;;
                                    121 ;; Routine taken from Promotion from Bite Studios
                                    122 ;;
      000B1B                        123 sys_input_getKeyPressed::
      000B1B 21 53 20         [10]  124     ld hl, #_cpct_keyboardStatusBuffer
      000B1E AF               [ 4]  125     xor a                           ;; A = 0
                                    126 
      000B1F                        127 _kp_loop:
      000B1F FE 0A            [ 7]  128     cp #BUFFER_SIZE
      000B21 28 14            [12]  129     jr z, _kp_endLoop               ;; Check counter value. End if its 0
      000B23 32 33 0B         [13]  130     ld (_size_counter), a
                                    131 
      000B26 7E               [ 7]  132     ld a, (hl)                      ;; Load byte from the buffer
      000B27 EE FF            [ 7]  133     xor #ZERO_KEYS_ACTIVATED        ;; Inverts bytes
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 108.
Hexadecimal [24-Bits]



      000B29 28 06            [12]  134     jr z, _no_key_detected
      000B2B 67               [ 4]  135         ld h, a                     ;; H is the mask
      000B2C 3A 33 0B         [13]  136         ld a, (_size_counter)
      000B2F 6F               [ 4]  137         ld l, a                     ;; L is the offset
                                    138         ; ld (_current_key_pressed), hl
      000B30 C9               [10]  139         ret
      000B31                        140 _no_key_detected:
      000B31 23               [ 6]  141     inc hl
                           000030   142 _size_counter = .+1
      000B32 3E 00            [ 7]  143     ld a, #0x00                     ;; AUTOMODIFIABLE, A = counter
      000B34 3C               [ 4]  144     inc a
      000B35 18 E8            [12]  145     jr _kp_loop
      000B37                        146 _kp_endLoop:
      000B37 21 00 00         [10]  147     ld hl, #0x00                    ;; Return 0 if no key is pressed
      000B3A 3E 00            [ 7]  148     ld a, #0
      000B3C 32 40 0B         [13]  149     ld (_key_released), a
      000B3F C9               [10]  150     ret
                                    151 
      000B40                        152 _key_released:
      000B40 00                     153     .db #0
                                    154 
                                    155 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    156 ;; DESCRIPTION
                                    157 ;; Does not return the key pressed until one is pressed.
                                    158 ;; WARNING: This blocks the execution until done
                                    159 ;; ----------------------------------------------------
                                    160 ;; PARAMS
                                    161 ;; ----------------------------------------------------
                                    162 ;; RETURNS
                                    ...
                                    167 ;; ----------------------------------------------------
                                    168 ;;
                                    169 ;; Routine taken from Promotion from Bite Studios
                                    170 ;;
      000B41                        171 sys_input_waitKeyPressed::
      000B41 CD 1B 0B         [17]  172     call sys_input_getKeyPressed
      000B44 3A 40 0B         [13]  173     ld a, (_key_released)
      000B47 B7               [ 4]  174     or a
      000B48 20 F7            [12]  175     jr nz, sys_input_waitKeyPressed
      000B4A AF               [ 4]  176     xor a
      000B4B B4               [ 4]  177     or h
      000B4C B5               [ 4]  178     or l
      000B4D 28 F2            [12]  179     jr z, sys_input_waitKeyPressed
      000B4F 3E 01            [ 7]  180     ld a, #1
      000B51 32 40 0B         [13]  181     ld (_key_released), a
      000B54 C9               [10]  182     ret
                                    183 
                                    184 
                                    185 ;;-----------------------------------------------------------------
                                    186 ;;
...
Hexadecimal [24-Bits]
                                    ...
                                    189 ;;   Initializes input
                                    190 ;;  Input: 
                                    191 ;;  Output:
                                    192 ;;  Modified: 
                                    193 ;;
      000B55                        194 sys_input_init::
      000B55 C9               [10]  195     ret 
                                    196 
                                    197 ;;-----------------------------------------------------------------
                                    198 ;;
                                    199 ;;  sys_input_generic_update
                                    200 ;;
                                    201 ;;  Initializes input
                                    202 ;;  Input:  iy: array of key, actions to check
                                    203 ;;          ix: pointer to the strcut to be used in the actions
                                    204 ;;  Output:
                                    205 ;;  Modified: iy, bc
                                    206 ;;
      000B56                        207 sys_input_generic_update::
      000B56 18 05            [12]  208     jr first_key
      000B58                        209 keys_loop:
      000B58 01 04 00         [10]  210     ld bc, #4
      000B5B FD 09            [15]  211     add iy, bc
      000B5D                        212 first_key:
      000B5D FD 6E 00         [19]  213     ld l, 0(iy)                     ;; Lower part of the key pointer
      000B60 FD 66 01         [19]  214     ld h, 1(iy)                     ;; Lower part of the key pointer
                                    215     ;; Check if key is null
      000B63 7D               [ 4]  216     ld a, l
      000B64 B4               [ 4]  217     or h
      000B65 C8               [11]  218     ret z                           ;; Return if key is null
                                    219     ;; Check if key is pressed
      000B66 CD 78 1E         [17]  220     call cpct_isKeyPressed_asm      ;;
      000B69 28 ED            [12]  221     jr z, keys_loop
                                    222     ;; Key pressed execute action
      000B6B 21 58 0B         [10]  223     ld hl, #keys_loop               ;;
      000B6E E5               [11]  224     push hl                         ;; return addres from executed function
      000B6F FD 6E 02         [19]  225     ld l, 2(iy)                     ;;
      000B72 FD 66 03         [19]  226     ld h, 3(iy)                     ;; retrieve function address    
      000B75 E9               [ 4]  227     jp (hl)                         ;; jump to function
                                    228 
                                    229 
                                    230 ;;-----------------------------------------------------------------
                                    231 ;;
                                    232 ;; sys_input_add_card_update
                                    233 ;;
                                    234 ;;   Initializes input
                                    235 ;;  Input: 
                                    236 ;;  Output:
                                    237 ;;  Modified: iy, bc
                                    238 ;;
      000B76                        239 sys_input_main_menu_update::
      000B76 FD 21 F6 23      [14]  240     ld iy, #sys_input_main_menu_actions
      000B7A CD 56 0B         [17]  241     call sys_input_generic_update
      000B7D C9               [10]  242     ret
                                    243 
...
Hexadecimal [24-Bits]
                                    ...
                                    244 ;;-----------------------------------------------------------------
                                    245 ;;
                                    246 ;; sys_input_player_left
                                    247 ;;
                                    248 ;;   reduces hor the speed of the player 
                                    249 ;;
                                    250 ;;  Input: 
                                    251 ;;  Output:
                                    252 ;;  Modified: iy, bc
      000B7E                        253 sys_input_player_left::
      000B7E DD 66 0F         [19]  254     ld h, e_vx(ix)
      000B81 DD 6E 10         [19]  255     ld l, e_vx+1(ix)
      000B84 01 18 00         [10]  256     ld bc, #STEP_HORIZONTAL_SPEED           
      000B87 B7               [ 4]  257     or a
      000B88 ED 42            [15]  258     sbc hl, bc                          ;; add STEP SPEED to current SPEED
      000B8A 01 00 FF         [10]  259     ld bc, #MAX_HORIZONTAL_SPEED_NEG    ;; check if MAX HORIZONTAL SPEED has been reached
      000B8D B7               [ 4]  260     or a                                ;;
      000B8E 22 96 0B         [16]  261     ld (sipl_max_not_reached+1), hl     ;; save new vx value for later use
      000B91 ED 42            [15]  262     sbc hl, bc                          ;;
      000B93 38 0B            [12]  263     jr c, sipl_max_reached              ;;
      000B95                        264 sipl_max_not_reached:
      000B95 21 00 00         [10]  265     ld hl, #00000
      000B98 DD 74 0F         [19]  266     ld e_vx(ix), h
      000B9B DD 75 10         [19]  267     ld e_vx+1(ix), l
      000B9E 18 06            [12]  268     jr sipl_exit
      000BA0                        269 sipl_max_reached:                       ;; if max speed reached, vx set to max speed
      000BA0 DD 70 0F         [19]  270     ld e_vx(ix), b
      000BA3 DD 71 10         [19]  271     ld e_vx+1(ix), c
      000BA6                        272 sipl_exit:
      000BA6 C9               [10]  273     ret
                                    274 
                                    275 ;;-----------------------------------------------------------------
                                    276 ;;
                                    277 ;; sys_input_player_right
                                    278 ;;
                                    279 ;;   reduces hor the speed of the player 
                                    280 ;;
                                    281 ;;  Input: 
                                    282 ;;  Output:
                                    283 ;;  Modified: iy, bc
      000BA7                        284 sys_input_player_right::    
      000BA7 DD 66 0F         [19]  285     ld h, e_vx(ix)
      000BAA DD 6E 10         [19]  286     ld l, e_vx+1(ix)
      000BAD 01 18 00         [10]  287     ld bc, #STEP_HORIZONTAL_SPEED           
      000BB0 ED 4A            [15]  288     adc hl, bc                          ;; add STEP SPEED to current SPEED
      000BB2 01 00 01         [10]  289     ld bc, #MAX_HORIZONTAL_SPEED_POS    ;; check if MAX HORIZONTAL SPEED has been reached
      000BB5 B7               [ 4]  290     or a                                ;;
      000BB6 22 BE 0B         [16]  291     ld (sipr_max_not_reached+1), hl     ;; save new vx value for later use
      000BB9 ED 42            [15]  292     sbc hl, bc                          ;;
      000BBB 30 0B            [12]  293     jr nc, sipr_max_reached              ;;
      000BBD                        294 sipr_max_not_reached:
      000BBD 21 00 00         [10]  295     ld hl, #00000
      000BC0 DD 74 0F         [19]  296     ld e_vx(ix), h
      000BC3 DD 75 10         [19]  297     ld e_vx+1(ix), l
      000BC6 18 06            [12]  298     jr sipr_exit
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 111.
Hexadecimal [24-Bits]



      000BC8                        299 sipr_max_reached:                       ;; if max speed reached, vx set to max speed
      000BC8 DD 70 0F         [19]  300     ld e_vx(ix), b
      000BCB DD 71 10         [19]  301     ld e_vx+1(ix), c
      000BCE                        302 sipr_exit:
      000BCE C9               [10]  303     ret
                                    304 
                                    305 ;;-----------------------------------------------------------------
                                    306 ;;
                                    307 ;; sys_input_player_up
                                    308 ;;
                                    309 ;;   reduces ver the speed of the player 
                                    310 ;;
                                    311 ;;  Input: 
                                    312 ;;  Output:
                                    313 ;;  Modified: iy, bc
      000BCF                        314 sys_input_player_up::
      000BCF DD 66 11         [19]  315     ld h, e_vy(ix)
      000BD2 DD 6E 12         [19]  316     ld l, e_vy+1(ix)
      000BD5 01 30 00         [10]  317     ld bc, #STEP_VERTICAL_SPEED           
      000BD8 B7               [ 4]  318     or a
      000BD9 ED 42            [15]  319     sbc hl, bc                          ;; add STEP SPEED to current SPEED
      000BDB 01 00 FE         [10]  320     ld bc, #MAX_VERTICAL_SPEED_NEG      ;; check if MAX HORIZONTAL SPEED has been reached
      000BDE B7               [ 4]  321     or a                                ;;
      000BDF 22 E7 0B         [16]  322     ld (sipu_max_not_reached+1), hl     ;; save new vx value for later use
      000BE2 ED 42            [15]  323     sbc hl, bc                          ;;
      000BE4 38 0B            [12]  324     jr c, sipu_max_reached              ;;
      000BE6                        325 sipu_max_not_reached:
      000BE6 21 00 00         [10]  326     ld hl, #00000
      000BE9 DD 74 11         [19]  327     ld e_vy(ix), h
      000BEC DD 75 12         [19]  328     ld e_vy+1(ix), l
      000BEF 18 06            [12]  329     jr sipu_exit
      000BF1                        330 sipu_max_reached:                       ;; if max speed reached, vx set to max speed
      000BF1 DD 70 11         [19]  331     ld e_vy(ix), b
      000BF4 DD 71 12         [19]  332     ld e_vy+1(ix), c
      000BF7                        333 sipu_exit:
      000BF7 C9               [10]  334     ret
                                    335 
                                    336 ;;-----------------------------------------------------------------
                                    337 ;;
                                    338 ;; sys_input_player_down
                                    339 ;;
                                    340 ;;   reduces hor the speed of the player 
                                    341 ;;
                                    342 ;;  Input: 
                                    343 ;;  Output:
                                    344 ;;  Modified: iy, bc
      000BF8                        345 sys_input_player_down::    
      000BF8 DD 66 11         [19]  346     ld h, e_vy(ix)
      000BFB DD 6E 12         [19]  347     ld l, e_vy+1(ix)
      000BFE 01 30 00         [10]  348     ld bc, #STEP_VERTICAL_SPEED           
      000C01 ED 4A            [15]  349     adc hl, bc                          ;; add STEP SPEED to current SPEED
      000C03 01 00 02         [10]  350     ld bc, #MAX_VERTICAL_SPEED_POS      ;; check if MAX HORIZONTAL SPEED has been reached
      000C06 B7               [ 4]  351     or a                                ;;
      000C07 22 0F 0C         [16]  352     ld (sipd_max_not_reached+1), hl     ;; save new vx value for later use
      000C0A ED 42            [15]  353     sbc hl, bc                          ;;
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 112.
Hexadecimal [24-Bits]



      000C0C 30 0B            [12]  354     jr nc, sipd_max_reached              ;;
      000C0E                        355 sipd_max_not_reached:
      000C0E 21 00 00         [10]  356     ld hl, #nullptr
      000C11 DD 74 11         [19]  357     ld e_vy(ix), h
      000C14 DD 75 12         [19]  358     ld e_vy+1(ix), l
      000C17 18 06            [12]  359     jr sipd_exit
      000C19                        360 sipd_max_reached:                       ;; if max speed reached, vx set to max speed
      000C19 DD 70 11         [19]  361     ld e_vy(ix), b
      000C1C DD 71 12         [19]  362     ld e_vy+1(ix), c
      000C1F                        363 sipd_exit:
      000C1F C9               [10]  364     ret
                                    365 
                                    366 ;;-----------------------------------------------------------------
                                    367 ;;
                                    368 ;; sys_input_player_jump
                                    369 ;;
                                    370 ;;   reduces hor the speed of the player 
                                    371 ;;
                                    372 ;;  Input: 
                                    373 ;;  Output:
                                    374 ;;  Modified: iy, bc
      000C20                        375 sys_input_player_jump::
      000C20 DD 7E 1A         [19]  376     ld a, e_on_platform(ix)     ;; if not on platform don't jump
      000C23 B7               [ 4]  377     or a                        ;;
      000C24 C8               [11]  378     ret z                       ;;
                                    379 
      000C25 DD 66 11         [19]  380     ld h, e_vy(ix)              ;; Jump subtracts 2 to vy
      000C28 DD 6E 12         [19]  381     ld l, e_vy+1(ix)            ;;
      000C2B 01 00 03         [10]  382     ld bc, #0x0300              ;;
      000C2E B7               [ 4]  383     or a                        ;;
      000C2F ED 42            [15]  384     sbc hl, bc                  ;;
      000C31 DD 74 11         [19]  385     ld e_vy(ix), h              ;;
      000C34 DD 75 12         [19]  386     ld e_vy+1(ix), l            ;;
      000C37 DD 36 1A 00      [19]  387     ld e_on_platform(ix), #0    ;; after jumping we are not on platform
      000C3B C9               [10]  388     ret
                                    389 
                                    390 
                                    391 ;;-----------------------------------------------------------------
                                    392 ;;
                                    393 ;; sys_input_player_update
                                    394 ;;
                                    395 ;;   Updates player input
                                    396 ;;
                                    397 ;;  Input: 
                                    398 ;;  Output:
                                    399 ;;  Modified: iy, bc
      000C3C                        400 sys_input_player_update::
      000C3C DD E5            [15]  401     push ix                             ;; save ix information
      000C3E CD 8A 0A         [17]  402     call man_entity_getPlayerPosition   ;; move ix to the first entity which will be player operated
                                    403 
      000C41 FD 21 F8 23      [14]  404     ld iy, #sys_input_player_actions
      000C45 CD 56 0B         [17]  405     call sys_input_generic_update
      000C48 DD E1            [14]  406     pop ix                              ;; rerieve saved information in ix
      000C4A C9               [10]  407     ret
                                    408 
