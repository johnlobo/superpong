...
Hexadecimal [24-Bits]
                                     ...
                                     50 ;;
      000000                         51 sys_physics_init::
                                     52     ;; set pointer array address 
      001987 3E 01            [ 7]   53     ld a, #e_cmpID_Physics
      001989 CD F6 07         [17]   54     call man_components_getArrayHL
      00198C 22 3C 1A         [16]   55     ld  (_ent_array_ptr), hl
                                     56 
      00198F C9               [10]   57     ret
                                     58 
                                     59 ;;-----------------------------------------------------------------
                                     ...
                                     67 ;;
      001990                         68 sys_physics_apply_gravity::
      001990 01 24 00         [10]   69     ld bc, #GRAVITY
      001993 DD 66 11         [19]   70     ld h, e_vy(ix)
      001996 DD 6E 12         [19]   71     ld l, e_vy+1(ix)
      001999 ED 4A            [15]   72     adc hl, bc
      00199B DD 74 11         [19]   73     ld e_vy(ix), h              ;; restore updated vy
      00199E DD 75 12         [19]   74     ld e_vy+1(ix), l            ;; 
      0019A1 C9               [10]   75     ret 
                                     76 
...
Hexadecimal [24-Bits]
                                     ...
                                     85 ;;
      0019A2                         86 sys_physics_apply_friction_vx::
      0019A2 01 16 00         [10]   87     ld bc, #COF                 ;; Coeficient of friction
      0019A5 DD 66 0F         [19]   88     ld h, e_vx(ix)
      0019A8 DD 6E 10         [19]   89     ld l, e_vx+1(ix)
      0019AB CB 7C            [ 8]   90     bit 7, h                    ;; test if vx is positive or negative
      0019AD 20 0B            [12]   91     jr nz, _vx_negative         ;; if bit 7 is set, z is not set and vx is positive
                                     92                                 ;; so the COF should be substracted
      0019AF B7               [ 4]   93     or a                        ;; reset c
      0019B0 ED 42            [15]   94     sbc hl,bc                   ;; substract bc from hl
      0019B2 F2 C2 19         [10]   95     jp p, _vx_restore           ;;
      0019B5 26 00            [ 7]   96     ld h, #0                    ;; if vx has gone negative vx = 0
      0019B7 6C               [ 4]   97     ld l, h                     ;;
      0019B8 18 08            [12]   98     jr _vx_restore
      0019BA                         99 _vx_negative:
      0019BA ED 4A            [15]  100     adc hl, bc                  ;; add COF to vx
      0019BC FA C2 19         [10]  101     jp m, _vx_restore           ;;
      0019BF 26 00            [ 7]  102     ld h, #0                    ;; if vx has gone positive vx = 0
      0019C1 6C               [ 4]  103     ld l, h                     ;;
      0019C2                        104 _vx_restore:
      0019C2 DD 74 0F         [19]  105     ld e_vx(ix), h              ;; restore updated vx
      0019C5 DD 75 10         [19]  106     ld e_vx+1(ix), l            ;; restore updated vx
      0019C8 C9               [10]  107     ret
                                    108 
                                    109 ;;-----------------------------------------------------------------
                                    110 ;;
                                    ...
                                    117 ;;
      0019C9                        118 sys_physics_apply_friction_vy::
      0019C9 01 16 00         [10]  119     ld bc, #COF                 ;; Coeficient of friction
      0019CC DD 66 11         [19]  120     ld h, e_vy(ix)
      0019CF DD 6E 12         [19]  121     ld l, e_vy+1(ix)
      0019D2 CB 7C            [ 8]  122     bit 7, h                    ;; test if vx is positive or negative
      0019D4 20 0B            [12]  123     jr nz, _vy_negative         ;; if bit 7 is set, z is not set and vx is positive
                                    124                                 ;; so the COF should be substracted
      0019D6 B7               [ 4]  125     or a                        ;; reset c
      0019D7 ED 42            [15]  126     sbc hl,bc                   ;; substract bc from hl
      0019D9 F2 E9 19         [10]  127     jp p, _vy_restore           ;;
      0019DC 26 00            [ 7]  128     ld h, #0                    ;; if vx has gone negative vx = 0
      0019DE 6C               [ 4]  129     ld l, h                     ;;
      0019DF 18 08            [12]  130     jr _vy_restore
      0019E1                        131 _vy_negative:
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 109.
Hexadecimal [24-Bits]



      0019E1 ED 4A            [15]  132     adc hl, bc                  ;; add COF to vx
      0019E3 FA E9 19         [10]  133     jp m, _vy_restore           ;;
      0019E6 26 00            [ 7]  134     ld h, #0                    ;; if vx has gone positive vx = 0
      0019E8 6C               [ 4]  135     ld l, h                     ;;
      0019E9                        136 _vy_restore:
      0019E9 DD 74 11         [19]  137     ld e_vy(ix), h              ;; restore updated vx
      0019EC DD 75 12         [19]  138     ld e_vy+1(ix), l            ;; restore updated vx
      0019EF C9               [10]  139     ret
                                    140 
                                    141 ;;-----------------------------------------------------------------
                                    142 ;;
                                    ...
                                    149 ;;
      0019F0                        150 sys_physics_update_one_entity::
                                    151     ;; update x coord with vx
      0019F0 DD 7E 0F         [19]  152     ld a, e_vx(ix)              ;; check if the speed in x is 0
      0019F3 DD 4E 10         [19]  153     ld c, e_vx+1(ix)            ;;
      0019F6 B1               [ 4]  154     or c                        ;; check if vx == 0
      0019F7 28 19            [12]  155     jr z, spuoe_yCoord          ;; move to y coord if vx === 0
                                    156 
      0019F9 DD 46 0F         [19]  157     ld b, e_vx(ix)              ;; lower part of the vx speed c, so bc = vx
      0019FC DD 66 05         [19]  158     ld h, e_x(ix)               ;; get the x coord in hl
      0019FF DD 6E 06         [19]  159     ld l, e_x+1(ix)             ;; 
      001A02 7C               [ 4]  160     ld a, h                     ;; save h value in a
      001A03 ED 4A            [15]  161     adc hl, bc                  ;; add x+vx
      001A05 DD 74 05         [19]  162     ld e_x(ix), h               ;; update entity with new position
      001A08 DD 75 06         [19]  163     ld e_x+1(ix), l             ;;
                                    164     ;; check if screen coord has changed to update moved.
      001A0B BC               [ 4]  165     cp h                        ;; if h has changed (high value)moved = true
      001A0C 28 04            [12]  166     jr z, spuoe_yCoord          ;;
      001A0E DD 36 19 01      [19]  167     ld e_moved(ix), #1          ;; flag the entity as moved
                                    168     
      001A12                        169 spuoe_yCoord:
                                    170     ;; update y coord with vy
      001A12 DD 7E 11         [19]  171     ld a, e_vy(ix)              ;; check if the speed in y is 0
      001A15 DD 4E 12         [19]  172     ld c, e_vy+1(ix)            ;;
      001A18 B1               [ 4]  173     or c                        ;; check if vx == 0
      001A19 28 19            [12]  174     jr z, spuoe_exit            ;; move to ret coord if vx === 0
                                    175     
      001A1B DD 46 11         [19]  176     ld b, e_vy(ix)              ;; lower part of the vy speed c, so bc = vy
      001A1E DD 66 07         [19]  177     ld h, e_y(ix)               ;; get the y coord in hl
      001A21 DD 6E 08         [19]  178     ld l, e_y+1(ix)             ;; 
      001A24 7C               [ 4]  179     ld a, h                     ;; save h value in a
      001A25 ED 4A            [15]  180     adc hl, bc                  ;; add y+vy
      001A27 DD 74 07         [19]  181     ld e_y(ix), h               ;; update entity with new position
      001A2A DD 75 08         [19]  182     ld e_y+1(ix), l             ;;
                                    183     ;; check if screen coord has changed to update moved.
      001A2D BC               [ 4]  184     cp h                        ;; if h has changed (high value)moved = true
      001A2E 28 04            [12]  185     jr z, spuoe_exit            ;; screen coord has not changed->check the ground
      001A30 DD 36 19 01      [19]  186     ld e_moved(ix), #1          ;; flag the entity as moved
...
Hexadecimal [24-Bits]
                                    ...
                                    187 
      001A34                        188 spuoe_exit:
                                    189     ;; Friction & Gravity
      001A34 CD A2 19         [17]  190     call sys_physics_apply_friction_vx  
      001A37 CD C9 19         [17]  191     call sys_physics_apply_friction_vy  
      001A3A C9               [10]  192     ret
                                    193 
                                    194 ;;-----------------------------------------------------------------
                                    195 ;;
                                    196 ;; sys_render_update
                                    197 ;;
                                    198 ;;  Initilizes render system
                                    199 ;;  Input: 
                                    200 ;;  Output: 
                                    201 ;;  Modified: AF, BC, DE, HL
                                    202 ;;
                                    203 
      001A3B                        204 sys_physics_update::
                                    205 
                           0000B5   206 _ent_array_ptr = . + 1
      001A3B 21 00 00         [10]  207     ld  hl, #0x0000
                                    208 
      001A3E                        209     _loop:
                                    210     ;;  Select the pointer to the entity with AI and prepare the next position for the next iteration.
      001A3E 5E               [ 7]  211     ld e, (hl)
      001A3F 23               [ 6]  212     inc hl
      001A40 56               [ 7]  213     ld d, (hl)
      001A41 23               [ 6]  214     inc hl
                                    215 
                                    216     ;;  The entities are finished traversing when find a pointer to null.
      001A42 7B               [ 4]  217     ld a, e
      001A43 B2               [ 4]  218     or d
      001A44 C8               [11]  219     ret z
                                    220 
      001A45 E5               [11]  221     push hl
                                    222 
      0000BF                        223     ld__ixl_e
      001A46 DD 6B                    1    .dw #0x6BDD  ;; Opcode for ld ixl, e
      0000C1                        224     ld__ixh_d
      001A48 DD 62                    1    .dw #0x62DD  ;; Opcode for ld ixh, d
                                    225 
      001A4A CD F0 19         [17]  226     call sys_physics_update_one_entity
                                    227 
      001A4D E1               [10]  228 	pop hl
                                    229 
      001A4E 18 EE            [12]  230     jr _loop
                                    231 
      001A50 C9               [10]  232     ret
                                    233     
