...
Hexadecimal [16-Bits]
                             ...
                             32 .area _DATA
                             33 
   2436 00 00                34 FONT_NUMBERS: .dw #0000
                             35 
   2438 C0                   36 sys_render_front_buffer: .db 0xc0
   2439 80                   37 sys_render_back_buffer: .db 0x80
   243A 00                   38 sys_render_touched_zones: .db 0x00
                             39 
                             40 .area _ABS   (ABS)
   0100                      41 .org 0x100
...
Hexadecimal [16-Bits]
   ...
   0BD8 3A 39 24      [13]  110     ld a, (sys_render_back_buffer)
   ...
   0BE2 3A 38 24      [13]  126     ld a, (sys_render_front_buffer)
   ...
   0BEC 2A 38 24      [16]  145     ld hl, (sys_render_front_buffer)    ;; Inicialmente (80C0)
   0BEF 7D            [ 4]  146     ld a, l                             ;; Carga el front buffer en el back buffer
   0BF0 32 39 24      [13]  147     ld (sys_render_back_buffer) , a
   0BF3 7C            [ 4]  148     ld a, h                             ;; Carga el back buffer en el front buffer
   0BF4 32 38 24      [13]  149     ld (sys_render_front_buffer), a
   0BF7 CB 3F         [ 8]  150     srl a
   0BF9 CB 3F         [ 8]  151     srl a
   0BFB 6F            [ 4]  152     ld l, a
   0BFC CD AB 21      [17]  153     call cpct_waitVSYNC_asm
   0BFF C3 B5 20      [10]  154     jp cpct_setVideoMemoryPage_asm
                            155 
                            156 
...
Hexadecimal [16-Bits]
   ...
   0C04 CD 9E 21      [17]  169     call cpct_setVideoMode_asm              ;;
                            170     
   0C07 21 B2 05      [10]  171     ld hl, #_g_palette                      ;; Set palette
   0C0A 11 10 00      [10]  172     ld de, #16                              ;;
   0C0D CD 85 1E      [17]  173     call cpct_setPalette_asm                ;;
                            174 
   ...
   0C13 CD A4 1E      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
...
Hexadecimal [16-Bits]
   ...
   0C33 CD E5 21      [17]  210     call cpct_drawSolidBox_asm
   0C36 C9            [10]  211     ret
                            212 
                            213 ;;-----------------------------------------------------------------
                            214 ;;
   ...
   0C3D CD BB 21      [17]  225     call cpct_px2byteM0_asm
   ...
   0C4C CD E5 21      [17]  230     call cpct_drawSolidBox_asm
   0C4F C9            [10]  231     ret
                            232 
                            233 ;;-----------------------------------------------------------------
                            234 ;;
   ...
   0C62 CD AE 1E      [17]  249     call cpct_drawSprite_asm
   0C65 C9            [10]  250     ret
                            251 
                            252 ;;-----------------------------------------------------------------
                            253 ;;
...
Hexadecimal [16-Bits]
   ...
   0C7A 3A 38 24      [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
   0C7D 57            [ 4]    2    ld   d, a
   ...
   0C86 CD F6 22      [17]  278     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
                            279     
...
Hexadecimal [16-Bits]
   ...
   0CC8 CD E5 21      [17]    6    call cpct_drawSolidBox_asm
   0CCB E1            [10]    7    pop hl
   0CCC D1            [10]    8    pop de
...
Hexadecimal [16-Bits]
   ...
   0CE2 CD E5 21      [17]    6    call cpct_drawSolidBox_asm
   0CE5 E1            [10]    7    pop hl
   0CE6 D1            [10]    8    pop de
   ...
   0CFC CD E5 21      [17]    6    call cpct_drawSolidBox_asm
   0CFF E1            [10]    7    pop hl
   0D00 D1            [10]    8    pop de
   ...
   0D16 CD E5 21      [17]    6    call cpct_drawSolidBox_asm
   0D19 E1            [10]    7    pop hl
   0D1A D1            [10]    8    pop de
