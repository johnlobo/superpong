...
Hexadecimal [16-Bits]
   ...
   2471 00                   32 nInterrupt:: .db 0
                             ...
                             46 ;;
   1C5B                      47 set_int_handler:
   1C5B 21 38 00      [10]   48 	ld hl, #0x38
   1C5E 36 C3         [10]   49 	ld (hl), #0xc3
   1C60 23            [ 6]   50 	inc hl
   1C61 36 6E         [10]   51 	ld (hl), #<int_handler1
   1C63 23            [ 6]   52 	inc hl
   1C64 36 1C         [10]   53 	ld (hl), #>int_handler1
   1C66 23            [ 6]   54 	inc hl
   1C67 36 C9         [10]   55 	ld (hl), #0xc9
   000E                      56    m_reset_nInterrupt                           ;; reset number of interruption
   1C69 AF            [ 4]    1     xor a
   1C6A 32 71 24      [13]    2     ld (nInterrupt), a 
   1C6D C9            [10]   57 	ret
                             58 
                             59 
                             60 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             ...
                             65 ;;
   1C6E                      66 int_handler1:
                             67    ;;cpctm_setBorder_asm HW_WHITE
   0013                      68    m_inc_nInterrupt                                ;;increment the number of interruption
   1C6E 3A 71 24      [13]    1     ld a, (nInterrupt)
   1C71 3C            [ 4]    2     inc a
   1C72 32 71 24      [13]    3     ld (nInterrupt), a 
   1C75 21 7C 1C      [10]   69 	ld hl, #int_handler2
   1C78 CD 3C 1E      [17]   70  	call cpct_setInterruptHandler_asm	
   1C7B C9            [10]   71 	ret
                             72 
                             73 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             74 ;;DESCRIPTION
...
Hexadecimal [16-Bits]
                             ...
                             78 ;;
   1C7C                      79 int_handler2:
                             80    ;;cpctm_setBorder_asm HW_RED
                             81 
   0021                      82    m_inc_nInterrupt                                ;;increment the number of interruption
   1C7C 3A 71 24      [13]    1     ld a, (nInterrupt)
   1C7F 3C            [ 4]    2     inc a
   1C80 32 71 24      [13]    3     ld (nInterrupt), a 
                             83 
   1C83 CD 36 21      [17]   84 	call cpct_scanKeyboard_if_asm
                             85 
                             86 
   1C86 21 8D 1C      [10]   87 	ld hl, #int_handler3
   1C89 CD 3C 1E      [17]   88    call cpct_setInterruptHandler_asm
   1C8C C9            [10]   89 	ret
                             90 
                             91 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             92 ;;DESCRIPTION
                             ...
                             96 ;;
   1C8D                      97 int_handler3:
                             98    ;;cpctm_setBorder_asm HW_GREEN
                             99 
   0032                     100    m_inc_nInterrupt                                ;;increment the number of interruption
   1C8D 3A 71 24      [13]    1     ld a, (nInterrupt)
   1C90 3C            [ 4]    2     inc a
   1C91 32 71 24      [13]    3     ld (nInterrupt), a 
                            101 
   1C94 21 9B 1C      [10]  102 	ld hl, #int_handler4
   1C97 CD 3C 1E      [17]  103    call cpct_setInterruptHandler_asm
   1C9A C9            [10]  104 	ret
                            105 
                            106 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            107 ;;DESCRIPTION
                            ...
                            111 ;;
   1C9B                     112 int_handler4:
                            113    ;;cpctm_setBorder_asm HW_BLUE
                            114 
   0040                     115    m_inc_nInterrupt                                ;;increment the number of interruption
   1C9B 3A 71 24      [13]    1     ld a, (nInterrupt)
   1C9E 3C            [ 4]    2     inc a
   1C9F 32 71 24      [13]    3     ld (nInterrupt), a 
                            116 
   1CA2 21 A9 1C      [10]  117 	ld hl, #int_handler5
   1CA5 CD 3C 1E      [17]  118    call cpct_setInterruptHandler_asm
   1CA8 C9            [10]  119 	ret
                            120 
                            121 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
                            ...
                            126 ;;
   1CA9                     127 int_handler5:
                            128    ;;cpctm_setBorder_asm HW_ORANGE
                            129 
   004E                     130    m_inc_nInterrupt
   1CA9 3A 71 24      [13]    1     ld a, (nInterrupt)
   1CAC 3C            [ 4]    2     inc a
   1CAD 32 71 24      [13]    3     ld (nInterrupt), a 
                            131 
                            ...
                            146 ;;  ex af', af  
                            147 ;;  exx
   1CB0                     148 int_handler5_exit:
   1CB0 21 B7 1C      [10]  149 	ld hl, #int_handler6
   1CB3 CD 3C 1E      [17]  150    call cpct_setInterruptHandler_asm
   1CB6 C9            [10]  151 	ret
                            152 
                            153 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            154 ;;DESCRIPTION
                            ...
                            158 ;;
   1CB7                     159 int_handler6:
                            160    ;;cpctm_setBorder_asm HW_PURPLE
                            161 
   005C                     162    m_reset_nInterrupt
   1CB7 AF            [ 4]    1     xor a
   1CB8 32 71 24      [13]    2     ld (nInterrupt), a 
                            163 
   1CBB 21 6E 1C      [10]  164 	ld hl, #int_handler1
   1CBE CD 3C 1E      [17]  165    call cpct_setInterruptHandler_asm
   1CC1 C9            [10]  166 	ret
                            167 
                            168 
                            169 
...
Hexadecimal [16-Bits]
                            ...
                            177 ;;
   1CC2                     178 sys_system_disable_firmware::
   1CC2 CD D5 21      [17]  179    call cpct_disableFirmware_asm
   1CC5 21 6E 1C      [10]  180    ld hl, #int_handler1
   1CC8 CD AB 21      [17]  181    call cpct_waitVSYNC_asm
   1CCB 76            [ 4]  182    halt
   1CCC 76            [ 4]  183    halt
   1CCD CD AB 21      [17]  184    call cpct_waitVSYNC_asm
   1CD0 CD 3C 1E      [17]  185    call cpct_setInterruptHandler_asm
                            186    
   1CD3 C9            [10]  187    ret
                            188 
                            189 
