...
Hexadecimal [24-Bits]
      ...
      00242A 00                      32 nInterrupt:: .db 0
                                     ...
                                     46 ;;
      001BAC                         47 set_int_handler:
      001BAC 21 38 00         [10]   48 	ld hl, #0x38
      001BAF 36 C3            [10]   49 	ld (hl), #0xc3
      001BB1 23               [ 6]   50 	inc hl
      001BB2 36 BF            [10]   51 	ld (hl), #<int_handler1
      001BB4 23               [ 6]   52 	inc hl
      001BB5 36 1B            [10]   53 	ld (hl), #>int_handler1
      001BB7 23               [ 6]   54 	inc hl
      001BB8 36 C9            [10]   55 	ld (hl), #0xc9
      00000E                         56    m_reset_nInterrupt                           ;; reset number of interruption
      001BBA AF               [ 4]    1     xor a
      001BBB 32 2A 24         [13]    2     ld (nInterrupt), a 
      001BBE C9               [10]   57 	ret
                                     58 
                                     59 
                                     60 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                     ...
                                     65 ;;
      001BBF                         66 int_handler1:
                                     67    ;;cpctm_setBorder_asm HW_WHITE
      000013                         68    m_inc_nInterrupt                                ;;increment the number of interruption
      001BBF 3A 2A 24         [13]    1     ld a, (nInterrupt)
      001BC2 3C               [ 4]    2     inc a
      001BC3 32 2A 24         [13]    3     ld (nInterrupt), a 
      001BC6 21 CD 1B         [10]   69 	ld hl, #int_handler2
      001BC9 CD 1C 1E         [17]   70  	call cpct_setInterruptHandler_asm	
      001BCC C9               [10]   71 	ret
                                     72 
                                     73 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                     74 ;;DESCRIPTION
...
Hexadecimal [24-Bits]
                                     ...
                                     78 ;;
      001BCD                         79 int_handler2:
                                     80    ;;cpctm_setBorder_asm HW_RED
                                     81 
      000021                         82    m_inc_nInterrupt                                ;;increment the number of interruption
      001BCD 3A 2A 24         [13]    1     ld a, (nInterrupt)
      001BD0 3C               [ 4]    2     inc a
      001BD1 32 2A 24         [13]    3     ld (nInterrupt), a 
                                     83 
      001BD4 CD 16 21         [17]   84 	call cpct_scanKeyboard_if_asm
                                     85 
                                     86 
      001BD7 21 DE 1B         [10]   87 	ld hl, #int_handler3
      001BDA CD 1C 1E         [17]   88    call cpct_setInterruptHandler_asm
      001BDD C9               [10]   89 	ret
                                     90 
                                     91 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                     92 ;;DESCRIPTION
                                     ...
                                     96 ;;
      001BDE                         97 int_handler3:
                                     98    ;;cpctm_setBorder_asm HW_GREEN
                                     99 
      000032                        100    m_inc_nInterrupt                                ;;increment the number of interruption
      001BDE 3A 2A 24         [13]    1     ld a, (nInterrupt)
      001BE1 3C               [ 4]    2     inc a
      001BE2 32 2A 24         [13]    3     ld (nInterrupt), a 
                                    101 
      001BE5 21 EC 1B         [10]  102 	ld hl, #int_handler4
      001BE8 CD 1C 1E         [17]  103    call cpct_setInterruptHandler_asm
      001BEB C9               [10]  104 	ret
                                    105 
                                    106 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    107 ;;DESCRIPTION
                                    ...
                                    111 ;;
      001BEC                        112 int_handler4:
                                    113    ;;cpctm_setBorder_asm HW_BLUE
                                    114 
      000040                        115    m_inc_nInterrupt                                ;;increment the number of interruption
      001BEC 3A 2A 24         [13]    1     ld a, (nInterrupt)
      001BEF 3C               [ 4]    2     inc a
      001BF0 32 2A 24         [13]    3     ld (nInterrupt), a 
                                    116 
      001BF3 21 FA 1B         [10]  117 	ld hl, #int_handler5
      001BF6 CD 1C 1E         [17]  118    call cpct_setInterruptHandler_asm
      001BF9 C9               [10]  119 	ret
                                    120 
                                    121 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [24-Bits]
                                    ...
                                    126 ;;
      001BFA                        127 int_handler5:
                                    128    ;;cpctm_setBorder_asm HW_ORANGE
                                    129 
      00004E                        130    m_inc_nInterrupt
      001BFA 3A 2A 24         [13]    1     ld a, (nInterrupt)
      001BFD 3C               [ 4]    2     inc a
      001BFE 32 2A 24         [13]    3     ld (nInterrupt), a 
                                    131 
                                    ...
                                    146 ;;  ex af', af  
                                    147 ;;  exx
      001C01                        148 int_handler5_exit:
      001C01 21 08 1C         [10]  149 	ld hl, #int_handler6
      001C04 CD 1C 1E         [17]  150    call cpct_setInterruptHandler_asm
      001C07 C9               [10]  151 	ret
                                    152 
                                    153 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    154 ;;DESCRIPTION
                                    ...
                                    158 ;;
      001C08                        159 int_handler6:
                                    160    ;;cpctm_setBorder_asm HW_PURPLE
                                    161 
      00005C                        162    m_reset_nInterrupt
      001C08 AF               [ 4]    1     xor a
      001C09 32 2A 24         [13]    2     ld (nInterrupt), a 
                                    163 
      001C0C 21 BF 1B         [10]  164 	ld hl, #int_handler1
      001C0F CD 1C 1E         [17]  165    call cpct_setInterruptHandler_asm
      001C12 C9               [10]  166 	ret
                                    167 
                                    168 
                                    169 
                                    170 ;;-----------------------------------------------------------------
...
Hexadecimal [24-Bits]
                                    ...
                                    177 ;;
      001C13                        178 sys_system_disable_firmware::
      001C13 CD B5 21         [17]  179    call cpct_disableFirmware_asm
      001C16 21 BF 1B         [10]  180    ld hl, #int_handler1
      001C19 CD 8B 21         [17]  181    call cpct_waitVSYNC_asm
      001C1C 76               [ 4]  182    halt
      001C1D 76               [ 4]  183    halt
      001C1E CD 8B 21         [17]  184    call cpct_waitVSYNC_asm
      001C21 CD 1C 1E         [17]  185    call cpct_setInterruptHandler_asm
                                    186    
      001C24 C9               [10]  187    ret
                                    188 
                                    189 
