...
Hexadecimal [24-Bits]
      ...
      00240E 00 00                   38 _window_address: .dw #00
      002410 00                      39 _window_x: .db #00
      002411 00                      40 _window_y: .db #00
      002412 00                      41 _window_w: .db #00
      002413 00                      42 _window_h: .db #00
      002414 00 00                   43 _window_message: .dw #0000
      002416 01                      44 _window_wait_for_key: .db #01
      002417 50 52 45 53 53 20 41    45 _press_any_key_string: .asciz "PRESS ANY KEY"
             4E 59 20 4B 45 59 00
                           ...
                           000008    54 w_wait_for_key = 8
                                     ...
                                     73 ;;
                                     74 
      000C4B                         75 sys_messages_load_window_data::
      000C4B FD 21 0E 24      [14]   76     ld iy, #_window_data
      000C4F FD 75 06         [19]   77     ld w_message(iy), l
      000C52 FD 74 07         [19]   78     ld w_message+1(iy), h
                                     79     ;;ld w_w(iy), c
...
Hexadecimal [24-Bits]
      ...
      000C55 FD 70 05         [19]   80     ld w_h(iy), b
                                     81     ;;ld w_x(iy), e             
      000C58 FD 72 03         [19]   82     ld w_y(iy), d
      000C5B FD 77 08         [19]   83     ld w_wait_for_key(iy), a  
      000C5E FD 66 07         [19]   84     ld h, w_message+1(iy)           ;; calculate length of the string
      000C61 FD 6E 06         [19]   85     ld l, w_message(iy)             ;;
      000C64 CD 30 1C         [17]   86     call sys_text_str_length        ;;
      000C67 CB 27            [ 8]   87     sla a                           ;; multiply string length by 2 to obtain bytes
      000C69 3C               [ 4]   88     inc a                           ;;
      000C6A 3C               [ 4]   89     inc a                           ;; add three of bytes as padding
                                     90 
      000C6B FE 1E            [ 7]   91     cp #MINIMUM_WINDOW_WIDTH        ;; compare calculated width with minimun width
      000C6D F2 72 0C         [10]   92     jp p, width_ok                  ;;
      000C70 3E 1E            [ 7]   93     ld a, #MINIMUM_WINDOW_WIDTH     ;;
                                     94     
      000C72                         95 width_ok:
      000C72 FD 77 04         [19]   96     ld w_w(iy), a                   ;; store this information as total width
      000C75 FD 34 04         [23]   97     inc w_w(iy)                     ;;
      000C78 FD 34 04         [23]   98     inc w_w(iy)                     ;;
      000C7B FD 34 04         [23]   99     inc w_w(iy)                     ;; width a little bit wider
                                    100     
      000C7E 47               [ 4]  101     ld b, a                         ;; move string bytes to b
      000C7F 3E 50            [ 7]  102     ld a, #80                       ;; move screen width to a
      000C81 90               [ 4]  103     sub b                           ;; substract string length
      000C82 CB 2F            [ 8]  104     sra a                           ;; divide a to obtain x
      000C84 FD 77 02         [19]  105     ld w_x(iy), a
      000C87 FD 35 02         [23]  106     dec w_x(iy)                     ;; x adjust
                                    107     
      000C8A FD 4E 02         [19]  108     ld c, w_x(iy)                   ;; c = x
      000C8D FD 46 03         [19]  109     ld b, w_y(iy)                   ;; b = y
                                    110     
      ...
      000C90 3A 27 24         [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
      000C93 57               [ 4]    2    ld   d, a
      000C94 1E 00            [ 7]    3    ld   e, #00
      000C96 CD D6 22         [17]  115     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
                                    116     
      000C99 FD 75 00         [19]  117     ld w_address(iy), l             ;; keep address in memory
      000C9C FD 74 01         [19]  118     ld w_address+1(iy), h           ;;
      000C9F C9               [10]  119     ret
                                    120 
                                    121 ;;-----------------------------------------------------------------
                                    122 ;;
                                    ...
                                    129 ;;
                                    130 
      000CA0                        131 sys_messages_draw_window::
...
Hexadecimal [24-Bits]
      ...
      000CA0 FD 5E 00         [19]  134     ld e, w_address(iy)                 ;; keep background information in message_buffer
      000CA3 FD 56 01         [19]  135     ld d, w_address+1(iy)               ;; 
      000CA6 FD 4E 04         [19]  136     ld c, w_w(iy)
      000CA9 FD 46 05         [19]  137     ld b, w_h(iy)
                                    138     
      000CAC 3E FF            [ 7]  139     ld a,#0xff                          ;; Patern of solid box
      000CAE CD C5 21         [17]  140     call cpct_drawSolidBox_asm
                                    141 
      ...
      000CB1 3A 27 24         [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
      000CB4 57               [ 4]    2    ld   d, a
      000CB5 1E 00            [ 7]    3    ld   e, #00
                                    147     
      000CB7 FD 4E 02         [19]  148     ld c, w_x(iy)                   ;;
      000CBA 0C               [ 4]  149     inc c                           ;; C = x coordinate + 1
      000CBB FD 46 03         [19]  150     ld b, w_y(iy)                   ;;
      000CBE 04               [ 4]  151     inc b                           ;; B = y coordinate + 2
      000CBF 04               [ 4]  152     inc b                           ;;
      000CC0 CD D6 22         [17]  153     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
      000CC3 EB               [ 4]  154     ex de, hl                       ;; move screen address to de
                                    155     
      000CC4 FD 4E 04         [19]  156     ld c, w_w(iy)                   ;;
      000CC7 0D               [ 4]  157     dec c                           ;; C = w - 2
      000CC8 0D               [ 4]  158     dec c                           ;;   
                                    159     
      000CC9 FD 46 05         [19]  160     ld b, w_h(iy)                   ;;
      000CCC 05               [ 4]  161     dec b                           ;; B = h - 4
      000CCD 05               [ 4]  162     dec b                           ;;
      000CCE 05               [ 4]  163     dec b                           ;;
      000CCF 05               [ 4]  164     dec b                           ;;
                                    165     
      000CD0 3E 00            [ 7]  166     ld a, #0x00                     ;; Patern of solid box
      000CD2 CD C5 21         [17]  167     call cpct_drawSolidBox_asm
                                    168 
      000CD5 C9               [10]  169     ret
                                    170 
                                    171 
                                    172 
                                    173 ;;-----------------------------------------------------------------
...
Hexadecimal [24-Bits]
                                    ...
                                    184 ;;
      000CD6                        185 sys_messages_restore_message_background::
      000CD6 FD 5E 00         [19]  186     ld e, w_address(iy)                 ;; keep background information in message_buffer
      000CD9 FD 56 01         [19]  187     ld d, w_address+1(iy)               ;;
      000CDC 21 CF 0D         [10]  188     ld hl, #message_buffer              ;;
      000CDF FD 4E 04         [19]  189     ld c, w_w(iy)                       ;;
      000CE2 FD 46 05         [19]  190     ld b, w_h(iy)                       ;;
      000CE5 CD 8E 1E         [17]  191     call cpct_drawSprite_asm            ;;
      000CE8 C9               [10]  192     ret
                                    193 
                                    194 
                                    195 ;;-----------------------------------------------------------------
                                    196 ;;
                                    ...
                                    206 ;;
                                    207 
      000CE9                        208 sys_messages_show::
                                    209 
      000CE9 CD 4B 0C         [17]  210     call sys_messages_load_window_data
                                    211 
      000CEC FD 6E 00         [19]  212     ld l, w_address(iy)                 ;; restore background information from message_buffer
      000CEF FD 66 01         [19]  213     ld h, w_address+1(iy)               ;;
      000CF2 11 CF 0D         [10]  214     ld de, #message_buffer              ;;
      000CF5 FD 4E 04         [19]  215     ld c, w_w(iy)                       ;;
      000CF8 FD 46 05         [19]  216     ld b, w_h(iy)                       ;;
      000CFB CD 43 1E         [17]  217     call cpct_getScreenToSprite_asm     ;;
                                    218 
                                    219 
      000CFE CD A0 0C         [17]  220     call sys_messages_draw_window
                                    221 
                                    222     ;; Draw message
                                    223     
      ...
      000D01 3A 27 24         [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
      000D04 57               [ 4]    2    ld   d, a
      000D05 1E 00            [ 7]    3    ld   e, #00
                                    227     
      000D07 FD 4E 02         [19]  228     ld c, w_x(iy)                   ;;
      000D0A 0C               [ 4]  229     inc c                           ;; 
      000D0B 0C               [ 4]  230     inc c                           ;; C = x + 1
      000D0C 0C               [ 4]  231     inc c                           ;; 
                                    232     
      000D0D FD 46 03         [19]  233     ld b, w_y(iy)                   ;;
                                    234 
      000D10 FD 7E 08         [19]  235     ld a, w_wait_for_key(iy)        ;; check if we have to show the message press any key
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 114.
Hexadecimal [24-Bits]



      000D13 FE 01            [ 7]  236     cp #1                           ;;
      000D15 20 04            [12]  237     jr nz, no_wait4key               ;; 
      000D17 3E 0A            [ 7]  238     ld a, #10                       ;; B = y + 10
      000D19 18 02            [12]  239     jr y_coord
      000D1B                        240 no_wait4key:
      000D1B 3E 0F            [ 7]  241     ld a, #15                       ;; B = y + 15
      000D1D                        242 y_coord:
      000D1D 80               [ 4]  243     add b                           ;;
      000D1E 47               [ 4]  244     ld b, a                         ;;
                                    245     
      000D1F CD D6 22         [17]  246     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
      000D22 EB               [ 4]  247     ex de, hl                       ;; move screen address to de
                                    248 
      000D23 0E 00            [ 7]  249     ld c, #0
      000D25 FD 66 07         [19]  250     ld h, w_message+1(iy)
      000D28 FD 6E 06         [19]  251     ld l, w_message(iy)
      000D2B CD F5 1C         [17]  252     call sys_text_draw_string
                                    253 
                                    254     ;; Draw Press Any Key
      000D2E FD 7E 08         [19]  255     ld a, w_wait_for_key(iy)        ;; check if we have to wait for a key
      000D31 FE 01            [ 7]  256     cp #1                           ;;
      000D33 28 10            [12]  257     jr  z, wait_for_key             ;;
                                    258 
                                    259     ;;call sys_render_switch_buffers
                                    260 
      000D35 FD 7E 08         [19]  261     ld a, w_wait_for_key(iy)        ;; check if we have to wait for a key
      000D38 FE 02            [ 7]  262     cp #2                           ;;
      000D3A 20 08            [12]  263     jr  nz, _sms_exit               ;;
                                    264 
      000D3C                        265 _sms_wait_delay:
      000D3C 06 32            [ 7]  266     ld b, #50
      000D3E CD 14 1E         [17]  267     call sys_util_delay
      000D41 CD D6 0C         [17]  268     call sys_messages_restore_message_background
                                    269 
      000D44                        270 _sms_exit:
      000D44 C9               [10]  271     ret
                                    272 
      000D45                        273 wait_for_key:
      ...
      000D45 3A 27 24         [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
      000D48 57               [ 4]    2    ld   d, a
      000D49 1E 00            [ 7]    3    ld   e, #00
                                    278     
                                    279     
      000D4B FD 7E 04         [19]  280     ld a, w_w(iy)                   ;;
      000D4E 0E 1A            [ 7]  281     ld c, #26                       ;;
      000D50 91               [ 4]  282     sub c                           ;;
      000D51 CB 2F            [ 8]  283     sra a                           ;; c = x + ((w- length(str))/2)
      000D53 FD 4E 02         [19]  284     ld c, w_x(iy)                   ;;
      000D56 81               [ 4]  285     add c                           ;;
      000D57 4F               [ 4]  286     ld c, a                         ;;
                                    287 
...
Hexadecimal [24-Bits]
      ...
      000D58 FD 46 03         [19]  288     ld b, w_y(iy)                   ;;
      000D5B 3E 1A            [ 7]  289     ld a, #26                       ;; B = y + 10
      000D5D 80               [ 4]  290     add b                           ;;
      000D5E 47               [ 4]  291     ld b, a                         ;;
                                    292     
      000D5F CD D6 22         [17]  293     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
      000D62 EB               [ 4]  294     ex de, hl                       ;; move screen address to de
      000D63 0E 00            [ 7]  295     ld c, #0
      000D65 21 17 24         [10]  296     ld hl, #_press_any_key_string
      000D68 CD F5 1C         [17]  297     call sys_text_draw_string
                                    298 
                                    299     ;;call sys_render_switch_buffers
                                    300 
      000D6B CD 09 0B         [17]  301     call sys_input_wait4anykey
      000D6E E5               [11]  302     push hl                         ;; store number of loops waited
                                    303 
      000D6F CD D6 0C         [17]  304     call sys_messages_restore_message_background
                                    305 
                                    306     ;;call sys_render_switch_buffers
                                    307 
      000D72 E1               [10]  308     pop hl                          ;; return number of loops waited
                                    309 
      000D73 C9               [10]  310     ret
                                    311 
                                    312 ;;-----------------------------------------------------------------
                                    313 ;;
                                    ...
                                    326 ;;
      000D74                        327 sys_messages_draw_box::
      000D74 F5               [11]  328     push af
      000D75 7D               [ 4]  329     ld a, l                             ;;
      000D76 B7               [ 4]  330     or a                                ;; Check if box is empty
      000D77 28 09            [12]  331     jr z, smdb_empty                    ;;
                                    332 
                                    333     ;; Draw Back window
      00012E                        334     cpctm_push de, bc
                           000002     1    .narg v
                           000001     2    .if v
      000D79 D5               [11]    3    push de
                           000001     4    .if v-1
      000D7A C5               [11]    5    push bc
                           000000     6    .if v-2
                                      7    push 
                                      8    .if v-3
...
Hexadecimal [24-Bits]
                           ...
                           000001    23    .else
                                     24    .mexit
      000D7B 3E 00            [ 7]  335     ld a,#0x00                          ;; Patern of solid box
      000D7D CD C5 21         [17]  336     call cpct_drawSolidBox_asm          ;;
      000135                        337     cpctm_pop bc, de
                           000002     1    .narg v
                           000001     2    .if v
      000D80 C1               [10]    3    pop bc
                           000001     4    .if v-1
      000D81 D1               [10]    5    pop de
                           000000     6    .if v-2
                                      7    pop 
                                      8    .if v-3
                                      9    pop 
                           ...
                           000001    23    .else
                                     24    .mexit
                                    338 
      000D82                        339 smdb_empty:
      000D82 F1               [10]  340     pop af
      000D83 32 A4 0D         [13]  341     ld (#draw_border+1), a
      000D86 32 AD 0D         [13]  342     ld (#draw_border2+1), a
      000D89 32 B1 0D         [13]  343     ld (#draw_line+1), a
      000D8C 79               [ 4]  344     ld a, c
      000D8D 32 CD 0D         [13]  345     ld (width), a
      000D90 62               [ 4]  346  	ld h, d
      000D91 6B               [ 4]  347 	ld l, e	
      000D92 04               [ 4]  348     inc b                   ;; increment height in one 
      000D93 18 1B            [12]  349 	jr draw_line
...
Hexadecimal [24-Bits]
                                    ...
                                    350 
      000D95                        351 next_line:
      000D95 78               [ 4]  352 	ld a, b
      000D96 3D               [ 4]  353 	dec a
      000D97 B7               [ 4]  354 	or a
      000D98 C8               [11]  355 	ret z
                                    356 
      000D99 47               [ 4]  357 	ld b, a
      000D9A 3A CD 0D         [13]  358 	ld a, (width)
      000D9D 4F               [ 4]  359 	ld c,a
                                    360 
      000D9E 78               [ 4]  361 	ld a, b
      000D9F FE 01            [ 7]  362 	cp #1
      000DA1 28 0D            [12]  363 	jr z, draw_line		;; Si estoy en la ultima linea salto a line
      000DA3                        364 draw_border:
      000DA3 36 FF            [10]  365 	ld (hl), #0xff
      000DA5 79               [ 4]  366     ld a, c
      000DA6 3D               [ 4]  367     dec a
      00015C                        368     add_hl_a
      00015C                          1    add_REGPAIR_a  h, l
                                      1    ;; First Perform RH = E + A
      000DA7 85               [ 4]    2    add l    ;; [1] A' = RL + A 
      000DA8 6F               [ 4]    3    ld  l, a ;; [1] RL' = A' = RL + A. It might generate Carry that must be added to RH
                                      4    
                                      5    ;; Then Perform RH = RH + Carry 
      000DA9 8C               [ 4]    6    adc h    ;; [1] A'' = A' + RH + Carry = RL + A + RH + Carry
      000DAA 95               [ 4]    7    sub l    ;; [1] Remove RL'. A''' = A'' - RL' = RL + A + RH + Carry - (RL + A) = RH + Carry
      000DAB 67               [ 4]    8    ld  h, a ;; [1] Save into RH (RH' = A''' = RH + Carry)
      000DAC                        369 draw_border2:
      000DAC 36 FF            [10]  370 	ld (hl), #0xff
      000DAE 18 08            [12]  371 	jr down_line
                                    372 
      000DB0                        373 draw_line:
      000DB0 36 FF            [10]  374 	ld (hl), #0xff
      000DB2 23               [ 6]  375 	inc hl
                                    376 	;;djnz draw_line
      000DB3 0D               [ 4]  377     dec c
      000DB4 79               [ 4]  378     ld a, c
      000DB5 B7               [ 4]  379     or a
      000DB6 20 F8            [12]  380     jr nz, draw_line
                                    381 
      000DB8                        382 down_line:
      000DB8 3E 08            [ 7]  383 	ld a, #8          	    ;; [2] / HL = DE = DE + 0x800
      000DBA 82               [ 4]  384 	add d
      000DBB 67               [ 4]  385     ld h, a           	    ;; [1] | Adding 0x800 makes HL point to the start of
      000DBC 57               [ 4]  386 	ld d, a
      000DBD 6B               [ 4]  387 	ld l, e
                                    388 	
      000DBE E6 38            [ 7]  389 	and   #0x38        	    ;; [2] leave out only bits 13,12 and 11 from new memory address (00xxx000 00000000)
      000DC0 C2 95 0D         [10]  390     jp    nz, next_line    	;; [3] If any bit from {13,12,11} is not 0, we are still inside 
...
Hexadecimal [24-Bits]
      ...
      000DC3 21 50 C0         [10]  396     ld    hl, #0xC050       ;; [3] We advance destination pointer to next line
      000DC6 19               [11]  397     add   hl, de            ;; [3] HL = DE + 0xC050
      000DC7 54               [ 4]  398     ld     d, h             ;; [1] / DE = HL
      000DC8 5D               [ 4]  399     ld     e, l             ;; [1] \
      000DC9 C3 95 0D         [10]  400     jp   next_line         	;; [3] Continue copying
                                    401 
      000DCC C9               [10]  402     ret
      000DCD 00                     403 width: .db #0
      000DCE 00                     404 height: .db #0
      000DCF                        405 message_buffer: .ds 3000
